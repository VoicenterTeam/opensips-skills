...
<!-- generated-from: data/3.6/modules/mathops.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 mathops module. Read this file when configuring or debugging the mathops module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
The function evaluates a given expression and writes the result in the output pseudo-variable.
...
Truncation of a number towards zero.
...
Truncates a number, always towards -infinity.
...
The round function returns the nearest integer, and tie-breaking is done away from zero.
...
Rounding to N significant figures is done by first obtaining the number resulted from keeping N significant figures.
