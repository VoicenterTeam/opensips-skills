...
<!-- generated-from: data/3.6/modules/launch_darkly.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 launch_darkly module. Read this file when configuring or debugging the launch_darkly module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Demonstrates setting the `log_level` parameter.
