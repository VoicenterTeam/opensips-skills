...
<!-- generated-from: data/3.6/modules/presence_callinfo.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 presence_callinfo module. Read this file when configuring or debugging the presence_callinfo module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Notes:** The value must be a power of 2. You may consider increasing the value if using a large set of lines (>1000).
...
- `line` *(string, optional)* — The name of the line as a SIP URI. If no parameter is provided, the name of the line is taken from the SIP RURI of the INVITE. Variables are accepted.
  - `SIP URI`
...
- `line` *(string, optional)* — The name of the line as a SIP URI. If no parameter is provided, the name of the line is taken from the SIP FROM header of the INVITE.
  - `SIP URI`
