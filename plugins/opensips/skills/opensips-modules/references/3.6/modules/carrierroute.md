...
<!-- generated-from: data/3.6/modules/carrierroute.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 carrierroute module. Read this file when configuring or debugging the carrierroute module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Notes:** Consists of ids and corresponding names.
...
**Notes:** The comment is also displayed by the fifo cmd "cr_dump_routes".
...
*Default value is scan\_prefix.*

**Example.** scan\_prefix.
...
**Notes:** Defines a rewrite prefix for the localpart of the SIP URI.
...
**Notes:** Defines a rewrite suffix for the localpart of the SIP URI.
...
**Notes:** The number of digits is stripped before prepending rewrite_prefix.
