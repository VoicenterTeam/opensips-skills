...
<!-- generated-from: data/3.6/modules/qos.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 qos module. Read this file when configuring or debugging the qos module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Demonstrates how to configure the qos_flag parameter and use it within the route block to enable QoS tracking for INVITE messages.
