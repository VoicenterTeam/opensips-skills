...
<!-- generated-from: data/3.6/modules/snmpstats.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 snmpstats module. Read this file when configuring or debugging the snmpstats module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
If the number of bytes to be consumed passes a minor or major threshold, then a openserMsgQueueDepthMinorEvent or a openserMsgQueueDepthMajorEvent trap will be sent out, respectively.
