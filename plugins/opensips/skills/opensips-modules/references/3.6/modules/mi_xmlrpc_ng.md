# mi_xmlrpc_ng Module Reference
<!-- generated-from: data/3.6/modules/mi_xmlrpc_ng.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 mi_xmlrpc_ng module. Read this file when configuring or debugging the mi_xmlrpc_ng module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
This is an example showing the xmlrpc format for the “get_statistics net: shmem:” MI commad: response.
