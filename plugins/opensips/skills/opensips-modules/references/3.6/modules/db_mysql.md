...
<!-- generated-from: data/3.6/modules/db_mysql.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 db_mysql module. Read this file when configuring or debugging the db_mysql module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
