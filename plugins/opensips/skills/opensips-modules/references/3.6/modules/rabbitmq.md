...
<!-- generated-from: data/3.6/modules/rabbitmq.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 rabbitmq module. Read this file when configuring or debugging the rabbitmq module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Notes:** This parameter can be set multiple times, for each RabbitMQ server.
...
modparam("rabbitmq", "server_id","[ID2] uri = amqp://127.0.0.1; heartbeat = 5")
...
# TLS connection
...
**Notes:** Available only starting with RabbitMQ library version 0.9.0
...
- `server_id` *(string, required)* — the id of the RabbitMQ server. Must be one of the parameters defined in the server_id modparam.
