...
<!-- generated-from: data/3.6/modules/cachedb_sql.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 cachedb_sql module. Read this file when configuring or debugging the cachedb_sql module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
