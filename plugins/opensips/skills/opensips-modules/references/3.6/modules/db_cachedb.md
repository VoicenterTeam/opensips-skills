...
<!-- generated-from: data/3.6/modules/db_cachedb.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 db_cachedb module. Read this file when configuring or debugging the db_cachedb module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Sets the `cachedb_url` parameter to a MongoDB connection string.
...
Configuration snippet for using DB_CACHEDB with the auth_db module for a distributed subscriber base.
