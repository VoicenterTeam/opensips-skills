...
<!-- generated-from: data/3.6/modules/cachedb_dynamodb.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 cachedb_dynamodb module. Read this file when configuring or debugging the cachedb_dynamodb module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
* _set_ - sets a key in DynamoDB using the _cachedb_store_ function
* _get_ - queries a key from DynamoDB using the _cachedb_fetch_ function
* _remove_ - removes a key from DynamoDB using the _cachedb_remove_ function
* _get_counter_ - queries a key with a numerical value from DynamoDB using the _cachedb_counter_fetch_ function
* _add_ - increments the value of a specific item with a given value using the _cachedb_add_ function
* _sub_ - decrements the value of a specific item with a given value using the _cachedb_sub_ function
...
- `DynamoDB Local (for testing purposes)`
...
Demonstrates setting single-instance and multi-instance URLs for the cachedb_url parameter.
...
Demonstrates using cachedb operations such as store, fetch, remove, add, and sub with DynamoDB.
