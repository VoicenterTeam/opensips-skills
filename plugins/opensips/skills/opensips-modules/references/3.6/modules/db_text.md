...
<!-- generated-from: data/3.6/modules/db_text.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 db_text module. Read this file when configuring or debugging the db_text module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Shows the column definition for a minimal location table.
...
Shows the column definition and a sample row for a subscriber table.
...
Demonstrates how to set the db_mode parameter.
...
Demonstrates how to set the buffer_size parameter.
...
Shows how to load the module and configure the database URL.
...
Defines the columns for the subscriber table used in the basic configuration.
...
Defines the columns for the location and aliases tables.
...
Defines the version table structure and provides sample data.
...
A complete sample OpenSIPS configuration script using db_text for authentication and user location.
