...
<!-- generated-from: data/3.6/modules/msrp_ua.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 msrp_ua module. Read this file when configuring or debugging the msrp_ua module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
```opensips
...
if (!has\_totag() && is_method("INVITE")) {
