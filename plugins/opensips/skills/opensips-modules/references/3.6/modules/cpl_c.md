...
<!-- generated-from: data/3.6/modules/cpl_c.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 cpl_c module. Read this file when configuring or debugging the cpl_c module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `true` — REGISTER is not related to CPL
- `false` — REGISTER is related to CPL (function handles replies)
...
- `1` — SIP server should continue with the normal behavior as if no script existed
- `2` — no script was found, so nothing was done
- `false` — error reported (function itself haven't sent any SIP error reply)
...
**Returns:** returns the CPL script in XML format
