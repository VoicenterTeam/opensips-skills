...
<!-- generated-from: data/3.6/modules/textops.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 textops module. Read this file when configuring or debugging the textops module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** replace the uri in to: with the message uri.
...
**Example.** replace the uri in to: with the value of avp sip_address.
...
**Example.** adds 3463 prefix to uris ending with 3642 (just an example).
