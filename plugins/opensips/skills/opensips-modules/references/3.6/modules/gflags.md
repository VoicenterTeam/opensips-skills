...
<!-- generated-from: data/3.6/modules/gflags.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 gflags module. Read this file when configuring or debugging the gflags module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Returns true if the all the flags from the bitmask are set. The parameter value must be a bitmask in decimal or hexa format. The bitmaks has a 32 bit size.

**Parameters:**

- `bitmask` *(integer, required)* — The bitmask specifying the corresponding flags (decimal or hexa format, 32 bit size).
...
Reset the value of some flags to 0. The parameter value must be a bitmask in decimal or hexa format. The bitmaks has a 32 bit size.
...
Set the value of some flags (specified by bitmask) to 1. The parameter value must be a bitmask in decimal or hexa format. The bitmaks has a 32 bit size.
