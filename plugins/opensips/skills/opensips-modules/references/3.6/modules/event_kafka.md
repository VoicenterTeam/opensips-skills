...
<!-- generated-from: data/3.6/modules/event_kafka.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 event_kafka module. Read this file when configuring or debugging the event_kafka module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Demonstrates usage of the `kafka_publish()` function.
...
Example of a Kafka socket string.
