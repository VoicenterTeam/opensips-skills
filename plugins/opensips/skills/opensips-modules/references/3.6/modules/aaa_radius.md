...
<!-- generated-from: data/3.6/modules/aaa_radius.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 aaa_radius module. Read this file when configuring or debugging the aaa_radius module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `radcli` — One of the three radius libraries the module will try to find if RADIUSCLIENT env not set
