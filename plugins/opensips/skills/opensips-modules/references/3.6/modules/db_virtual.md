...
<!-- generated-from: data/3.6/modules/db_virtual.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 db_virtual module. Read this file when configuring or debugging the db_virtual module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** Set the `db_max_consec_retrys` parameter.
...
**Example.** Set the `db_probe_time` parameter.
...
**Example.** Set the `db_urls` parameter.
...
- `ignore_retries` *(boolean, optional)* — reset and suppress db_max_consec_retrys
