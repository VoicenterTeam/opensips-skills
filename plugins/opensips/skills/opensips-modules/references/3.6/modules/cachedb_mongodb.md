...
<!-- generated-from: data/3.6/modules/cachedb_mongodb.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 cachedb_mongodb module. Read this file when configuring or debugging the cachedb_mongodb module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `libbson-dev` — Compilation requirement (e.g., libbson-dev on Debian/Ubuntu)
- `libjson-c` — Runtime requirement (e.g., libjson-c2 on Debian/Ubuntu, json-c on Red Hat/CentOS)
- `libjson-c-dev` — Compilation requirement (e.g., libjson-c-dev on Debian/Ubuntu, json-c-devel on Red Hat/CentOS)
- `libmongoc` — Runtime requirement (e.g., libmongoc-1.0 on Debian/Ubuntu, mongo-c-driver on Red Hat/CentOS)
- `libmongoc-dev` — Compilation requirement (e.g., libmongoc-dev on Debian/Ubuntu, mongo-c-driver-devel on Red Hat/CentOS)
