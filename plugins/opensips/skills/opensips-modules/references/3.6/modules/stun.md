...
<!-- generated-from: data/3.6/modules/stun.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 stun module. Read this file when configuring or debugging the stun module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
The port configured (together with the primary_ip) as an UDP SIP listener in OpenSIPS.
...
**Notes:** Default value is 0 (disabled).
