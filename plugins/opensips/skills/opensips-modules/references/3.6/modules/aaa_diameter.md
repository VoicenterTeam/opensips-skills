...
<!-- generated-from: data/3.6/modules/aaa_diameter.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 aaa_diameter module. Read this file when configuring or debugging the aaa_diameter module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `libfdcore` — All Diameter message building and parsing, as well as the peer state machine and Diameter-related network communication are all powered by the freeDiameter project and C libraries, dynamically linking with the "aaa_diameter" module.
- `libfdproto` — All Diameter message building and parsing, as well as the peer state machine and Diameter-related network communication are all powered by the freeDiameter project and C libraries, dynamically linking with the "aaa_diameter" module.
...
Example of defining custom Diameter AVPs, Application IDs, Requests and Replies in the "dictionary.opensips" file
...
Building an sending an My-Custom-Request (92001) for the My Diameter Application (42)
...
Usage of `dm_send_answer()` inside an event route
