...
<!-- generated-from: data/3.6/modules/b2b_logic.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 b2b_logic module. Read this file when configuring or debugging the b2b_logic module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** Example 1.25. b2b_bridge usage.
...
This function will bridge an initial INVITE with one of the particapants from an existing b2b session.
...
- `flags` *(string, optional)* — Flags that can modify the behavior of the function.
  - `late_bye`
...
**Example.** Example 1.26. b2b_bridge usage.
...
**Example.** Example 1.24. b2b_client_new usage.
...
**Example.** Example 1.22. b2b_init_request usage.
...
**Example.** Example 1.23. b2b_server_new usage.
...
- **Scope:** request route, local_route, b2b_entities routes, b2b_logic routes
...
*   the From-Tag of the dialog, accessible by using the fromtag subname.
    
*   the To-Tag of the dialog, accessible by using the totag subname.
...
**Example.** opensips-cli Command Format
