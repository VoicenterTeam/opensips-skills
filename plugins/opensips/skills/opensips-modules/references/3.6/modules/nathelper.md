...
<!-- generated-from: data/3.6/modules/nathelper.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 nathelper module. Read this file when configuring or debugging the nathelper module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Notes:** Maximum allowed value is 8.
