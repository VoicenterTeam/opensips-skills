...
<!-- generated-from: data/3.5/modules/auth_aaa.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 auth_aaa module. Read this file when configuring or debugging the auth_aaa module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `sip_uri` *(string, optional)* — user stored in 'sip_uri'
...
- `-3` — stale nonce
- `1` — credentials are verified successfully
...
The function verifies credentials according to RFC2617. If the credentials are verified successfully then the function will succeed and mark the credentials as authorized.
