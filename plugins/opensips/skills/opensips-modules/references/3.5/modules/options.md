...
<!-- generated-from: data/3.5/modules/options.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 options module. Read this file when configuring or debugging the options module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** Set the `accept` parameter.
...
**Example.** Set the `accept_encoding` parameter.
...
**Example.** Set the `accept_language` parameter.
...
**Example.** Set the `support` parameter.
