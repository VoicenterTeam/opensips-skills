...
<!-- generated-from: data/3.5/modules/uac_registrant.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 uac_registrant module. Read this file when configuring or debugging the uac_registrant module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
