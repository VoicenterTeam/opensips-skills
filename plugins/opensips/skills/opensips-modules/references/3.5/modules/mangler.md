...
<!-- generated-from: data/3.5/modules/mangler.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 mangler module. Read this file when configuring or debugging the mangler module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Set the `contact_flds_separator` parameter used as separator for encoding/decoding Contact header.
...
Changes IP addresses inside SDP package in lines describing connections like c=IN IP4.
...
Encode uri-s inside Contact header.
...
Decode the URI in first line in packets which come with encoded URI.
...
Decode URIs inside Contact header.
