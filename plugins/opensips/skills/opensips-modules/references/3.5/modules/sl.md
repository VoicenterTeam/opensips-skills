# sl Module Reference
<!-- generated-from: data/3.5/modules/sl.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 sl module. Read this file when configuring or debugging the sl module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Sends a stateless reply with a given code and reason, using pseudo-variables.
...
Sends an error reply describing the nature of the last internal error.
