...
<!-- generated-from: data/3.5/modules/cachedb_local.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 cachedb_local module. Read this file when configuring or debugging the cachedb_local module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Returns:** A JSON object containing a list of keys and their values matching the glob pattern. (structured response — see schema)
