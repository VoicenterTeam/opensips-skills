...
<!-- generated-from: data/3.5/modules/xml-module.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 XML Module module. Read this file when configuring or debugging the XML Module module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
The sequence of nodes in the path can be followed by _.val_ in order to access the last node's text content or by _.attr/attr_name_ in order to access it's attribute named _attr_name_. Otherwise the entire element (start-tag, end-tag, children elements and content) is accessed.
