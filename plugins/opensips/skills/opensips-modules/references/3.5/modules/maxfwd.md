...
<!-- generated-from: data/3.5/modules/maxfwd.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 maxfwd module. Read this file when configuring or debugging the maxfwd module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Check if the Max-Forward header value is less than a specific value before forwarding to a gateway.
