...
<!-- generated-from: data/3.5/modules/mmgeoip.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 mmgeoip module. Read this file when configuring or debugging the mmgeoip module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Notes:** Default value for this parameter is MMAP_CACHE.
...
Looks up information specified by `field` associated with the IP address `src`.
