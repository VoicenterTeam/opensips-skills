...
<!-- generated-from: data/3.5/modules/peering.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 peering module. Read this file when configuring or debugging the peering module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Function verify\_destination() queries from broker's AAA server if domain (host part) of Request URI is served by a trusted peer.
...
Function verify\_source() queries from broker's AAA server if SIP request was received from a trusted peer.
