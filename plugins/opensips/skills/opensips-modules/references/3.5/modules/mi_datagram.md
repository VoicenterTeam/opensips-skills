...
<!-- generated-from: data/3.5/modules/mi_datagram.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 mi_datagram module. Read this file when configuring or debugging the mi_datagram module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
