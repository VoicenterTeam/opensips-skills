...
<!-- generated-from: data/3.5/modules/call_control.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 call_control module. Read this file when configuring or debugging the call_control module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
