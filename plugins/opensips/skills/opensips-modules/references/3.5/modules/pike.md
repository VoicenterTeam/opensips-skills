...
<!-- generated-from: data/3.5/modules/pike.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 pike module. Read this file when configuring or debugging the pike module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Notes:** Note: If the _remove\_latency_ value is lower than _sampling\_time\_unit_ value, nodes might expire before being unblocked, therefore losing some UNBLOCK events. In order to prevent this, if the _remove\_latency_ is lower, OpenSIPS internally forces its value to _sampling\_time\_unit + 1_.
...
**Notes:** IMPORTANT: a too small value may lead to performance penalties due timer process overloading.
