...
<!-- generated-from: data/3.5/modules/db_text.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 db_text module. Read this file when configuring or debugging the db_text module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Demonstrates the internal format of a db_text table.
...
Shows the definition and a sample row for a subscriber table.
...
Sets the caching mode (0) or non-caching mode (1).
...
Sets the size of the buffer used to read the text file.
...
Shows how to load the module and set the database URL.
...
Defines the columns for the subscriber table.
...
Defines the columns for location and aliases tables.
...
Defines the version table structure and sample records.
...
A basic configuration file to use db_text with OpenSIPS.
