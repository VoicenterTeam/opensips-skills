...
<!-- generated-from: data/3.5/modules/pua_reginfo.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 pua_reginfo module. Read this file when configuring or debugging the pua_reginfo module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
This function processes received "NOTIFY"-requests and updates the local registry accordingly. This method does not create any SIP-Response, this has to be done by the script-writer. The parameter has to correspond to user location table (domain) where to store the record.

**Parameters:**

- `uldomain` *(string, required)* — user location table (domain) where to store the record
...
- `expires` *(integer, optional)* — Expiration date for this subscription, in seconds
