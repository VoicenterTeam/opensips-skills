...
<!-- generated-from: data/3.5/modules/json.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 json module. Read this file when configuring or debugging the json module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `dest_id` *(json, required)* — The destination JSON object/field where the reference will be created.
...
In order to explicitly iterate over a JSON object keys or values, you can use the _.keys_ or _.values_ suffix for the path specified in the id.
...
This will cause the value to be taken as is and be added to the json object ( e.g. string value or integer value ). Setting a value to NULL will cause it to be deleted.
