...
<!-- generated-from: data/3.5/modules/mi_fifo.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 mi_fifo module. Read this file when configuring or debugging the mi_fifo module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** Set the `fifo_group` parameter.
...
**Example.** Set the `fifo_mode` parameter.
...
**Example.** Set the `fifo_name` parameter.
...
**Example.** Set the `fifo_user` parameter.
...
**Example.** Set the `reply_dir` parameter.
