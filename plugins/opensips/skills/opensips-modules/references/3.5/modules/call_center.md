...
<!-- generated-from: data/3.5/modules/call_center.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 call_center module. Read this file when configuring or debugging the call_center module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Returns:** No return value specified in documentation.
...
**Returns:** List of agents with their attributes.
...
**Returns:** List of ongoing calls with their attributes.
...
**Returns:** List of flows with their attributes.
...
**Returns:** List of calls in queuing with their attributes.
