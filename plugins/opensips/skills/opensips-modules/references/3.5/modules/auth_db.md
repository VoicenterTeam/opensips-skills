...
<!-- generated-from: data/3.5/modules/auth_db.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 auth_db module. Read this file when configuring or debugging the auth_db module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
