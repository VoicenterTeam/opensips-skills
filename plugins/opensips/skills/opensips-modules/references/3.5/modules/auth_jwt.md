...
<!-- generated-from: data/3.5/modules/auth_jwt.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 auth_jwt module. Read this file when configuring or debugging the auth_jwt module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `database` — Any database module (currently mysql, postgres, dbtext), required if db_url parameter is set.

### External Libraries

- `libjwt-dev` — Required library for JWT functionality.
- `libssl-dev` — Required library for SSL/TLS operations.
- `openssl-dev` — Required library for SSL/TLS operations.
...
- `-1` — JWT authentication failed (error)
- `1` — Success
...
Sets the secret_tag_column parameter.
...
Sets the secret_column parameter.
...
Uses the jwt_db_authorize function.
...
Uses the jwt_script_authorize function.
...
Uses the extract_pub_key_from_cert function.
