...
<!-- generated-from: data/3.5/modules/lua.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 lua module. Read this file when configuring or debugging the lua module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Sets the luafilename parameter to the script file path.
...
Demonstrates calling a Lua function from the OpenSIPS configuration script.
