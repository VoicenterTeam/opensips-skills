...
<!-- generated-from: data/3.5/modules/fraud_detection.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 fraud_detection module. Read this file when configuring or debugging the fraud_detection module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** Set the `cpm_thresh_warn_col` parameter.
...
**Example.** Set the `days_col` parameter.
...
**Example.** Set the `end_h` parameter.
...
The column's name in the database storing the fraud profile's id. Please keep in mind that a profile is merely a set of rules.
...
**Example.** Set the `prefix_col` parameter.
...
**Example.** Set the `start_h` parameter.
