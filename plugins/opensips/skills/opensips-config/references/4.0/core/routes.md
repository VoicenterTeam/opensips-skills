...
<!-- generated-from: data/4.0/core/routes.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: route_type -->

Reference for OpenSIPs 4.0 route block types. Read this file when deciding which route block (request_route, branch_route, failure_route, onreply_route, etc.) should host a given piece of script logic.
...
**Example.** Example of passing values.
