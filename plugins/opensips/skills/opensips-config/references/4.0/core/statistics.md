...
<!-- generated-from: data/4.0/core/statistics.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: statistic -->

Reference for OpenSIPs 4.0 core statistics. Read this file when looking up the canonical name, type, or reset semantics of a runtime counter or gauge exposed by the SIP processor itself.
