...
Generated reference for OpenSIPs 4.0. This file is the module catalog for the `opensips-config` skill. It maps every module in the active reference set to its per-module reference file and provides the lookup-discipline guidance that governs how Claude uses the reference set.
## Module index
| Module | Purpose | Reference file |
|---|---|---|
| `Event (based) Routing Module` | The Event (based) Routing module, or shortly the EBR module, provides a mechani… | `references/{version}/modules/Event (based) Routing Module.md` |
| `Options Module` | This module provides a function to answer OPTIONS requests which are directed t… | `references/{version}/modules/Options Module.md` |
| `SST Module (SIP Session Timer)` | The sst module provides a way to update the dialog expire timer based on the SI… | `references/{version}/modules/SST Module (SIP Session Timer).md` |
...
| `auth_web3` | The auth_web3 module provides Web3-based authentication for OpenSIPS, enabling… | `references/{version}/modules/auth_web3.md` |
...
| `cgrates` | _CGRateS_ is an open-source rating engine used for carrier-grade, multi-tenant,… | `references/{version}/modules/cgrates.md` |
...
| `event_kafka` | This module is an implementation of an Apache Kafka producer | `references/{version}/modules/event_kafka.md` |
...
| `launch_darkly` | This module implements support for the Launch Darkly feature management cloud | `references/{version}/modules/launch_darkly.md` |
...
| `mi_xmlrpc` | This module implements a xmlrpc server that handles xmlrpc requests and generat… | `references/{version}/modules/mi_xmlrpc.md` |
...
| `opentelemetry` | The _opentelemetry_ module provides OpenTelemetry tracing for OpenSIPS route ex… | `references/{version}/modules/opentelemetry.md` |
...
| `rest_client` | The rest_client module provides a means of interacting with an HTTP server by d… | `references/{version}/modules/rest_client.md` |
...
| `tls_openssl` | This module implements TLS operations using the [_openSSL_](https://www.openssl… | `references/{version}/modules/tls_openssl.md` |
