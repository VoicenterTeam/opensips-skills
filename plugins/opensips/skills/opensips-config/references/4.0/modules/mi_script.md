...
<!-- generated-from: data/4.0/modules/mi_script.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 mi_script module. Read this file when configuring or debugging the mi_script module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
