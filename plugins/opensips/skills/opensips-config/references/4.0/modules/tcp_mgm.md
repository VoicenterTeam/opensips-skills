...
<!-- generated-from: data/4.0/modules/tcp_mgm.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 tcp_mgm module. Read this file when configuring or debugging the tcp_mgm module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Replaces obsolete MI command: _tcp_reload_. Reload all TCP paths from the _tcp_mgm_ table without disrupting ongoing traffic. Note that the reloaded rules will NOT immediately apply to existing TCP connections, rather only to newly established ones.
