...
<!-- generated-from: data/4.0/modules/event_virtual.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 event_virtual module. Read this file when configuring or debugging the event_virtual module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
