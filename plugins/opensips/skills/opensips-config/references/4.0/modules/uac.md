...
<!-- generated-from: data/4.0/modules/uac.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 uac module. Read this file when configuring or debugging the uac module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `Dialog` — if “force_dialog” module parameter is enabled, or a dialog is created from the configuration script
...
- `false` — Authentication failed (e.g., no credentials)
...
**Example.** uac_auth usage in failure_route.
...
- `display` *(string, optional)* — The display name part.
- `uri` *(string, required)* — The URI part.

**Usable from:** REQUEST_ROUTE, BRANCH_ROUTE, FAILURE_ROUTE

**Example.** uac_replace_from usage.
...
**Example.** uac_restore_from usage.
