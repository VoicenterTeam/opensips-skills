...
<!-- generated-from: data/4.0/modules/alias_db.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 alias_db module. Read this file when configuring or debugging the alias_db module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
