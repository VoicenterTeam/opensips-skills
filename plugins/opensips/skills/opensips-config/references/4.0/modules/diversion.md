...
<!-- generated-from: data/4.0/modules/diversion.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 diversion module. Read this file when configuring or debugging the diversion module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
You can use the parameter to specify additional parameters to be added to the header field, see the example.
