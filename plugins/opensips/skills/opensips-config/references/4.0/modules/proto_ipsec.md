...
<!-- generated-from: data/4.0/modules/proto_ipsec.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 proto_ipsec module. Read this file when configuring or debugging the proto_ipsec module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
This parameter represents the minimum value for the Security Association's (SA) SPI parameter.
...
This parameter represents the maximum value for the Security Association's (SA) SPI parameter.
...
Indicates whether we should ignore deprecated algorithms, as defined in TS 33.203 (3G Security: Access Security for IP-based Services).
