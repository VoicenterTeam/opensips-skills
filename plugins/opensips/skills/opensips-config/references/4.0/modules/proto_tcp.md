...
<!-- generated-from: data/4.0/modules/proto_tcp.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 proto_tcp module. Read this file when configuring or debugging the proto_tcp module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**WARNING:** IF [Section1.3.10, “`trace_on` (int)”](#trace-on "1.3.10.trace_on (int)") is set to 0 or tracing is deactived via the mi command [Section1.4.1, “ `tcp_trace` ”](#tcp-trace "1.4.1. tcp_trace") this route won't be called.
...
This controls whether tracing for tcp is on or not. You still need to define Section 1.3.9, “trace_destination (string)” in order to work, but this value will be controlled using mi function Section 1.4.1, “ tcp_trace ”.
