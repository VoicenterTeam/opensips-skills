...
<!-- generated-from: data/4.0/modules/rest_client.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 rest_client module. Read this file when configuring or debugging the rest_client module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Notes:** A value of 0 will disable the check.
...
**Example.** Usage of rest_init_client_tls.
