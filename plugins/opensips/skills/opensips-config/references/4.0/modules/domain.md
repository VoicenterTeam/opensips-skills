...
<!-- generated-from: data/4.0/modules/domain.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 domain module. Read this file when configuring or debugging the domain module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** Set the `subdomain_col` parameter.
...
- `domain` *(string, required)* — The domain contained in the first parameter
...
Replaces obsolete MI command: _domain_dump_. Causes domain module to dump hash indexes and domain names in its cache memory.
...
Replaces obsolete MI command: _domain_reload_. Causes domain module to re-read the contents of domain table into cache memory.
...
Sets the database mode to 1 (caching).
...
Sets the name of the table containing names of local domains.
...
Sets the name of the column containing domains in domain table.
...
Sets the name of the column containing attributes in domain table.
...
Sets the name of the 'accept_subdomain' column in the domain table.
...
Checks based on domain table if host part of From header uri is one of the local domains.
...
Checks based on domain table if host part of Request-URI is one of the local domains.
...
Checks if the domain contained in the first parameter is local.
