...
<!-- generated-from: data/4.0/modules/script-helper-module.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 Script Helper Module module. Read this file when configuring or debugging the Script Helper Module module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** options-ping-caller,options-ping-callee,bye-on-timeout.
