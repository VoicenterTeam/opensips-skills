...
<!-- generated-from: data/4.0/modules/cachedb_mongodb.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 cachedb_mongodb module. Read this file when configuring or debugging the cachedb_mongodb module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `json-c` — Required for running and compiling the module
- `libbson` — Required for compiling the module
- `mongo-c-driver` — Required for running and compiling the module
