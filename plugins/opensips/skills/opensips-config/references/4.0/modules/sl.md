# sl Module Reference
<!-- generated-from: data/4.0/modules/sl.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 sl module. Read this file when configuring or debugging the sl module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Sends a stateless reply with a specific code and reason, using both static values and pseudo-variables.
