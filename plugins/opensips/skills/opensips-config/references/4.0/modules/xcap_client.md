...
<!-- generated-from: data/4.0/modules/xcap_client.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 xcap_client module. Read this file when configuring or debugging the xcap_client module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** Refreshes an XCAP document using the command line interface.
