...
<!-- generated-from: data/4.0/modules/benchmark.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 benchmark module. Read this file when configuring or debugging the benchmark module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `benchmark:granularity` *(integer, required)* — See discription of "granularity" parameter.
...
**Returns:** Returns the current and global results for each timer. Each timer will have 2 nodes - the local and the global values. Format of the values is the same as the one normally used in logfile. (structured response — see schema)
