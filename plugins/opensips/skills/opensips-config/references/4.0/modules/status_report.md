...
<!-- generated-from: data/4.0/modules/status_report.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 status_report module. Read this file when configuring or debugging the status_report module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `group` *(string, required)* — the name of the SR group; you can change the status only for the groups defined via this module (as parameter).
- `status` *(integer, required)* — the new status value ( strict positive meaning OK, strict negative meaning NOT OK, 0 is not accepts, it is converted to 1 automatically).
