...
<!-- generated-from: data/4.0/modules/msrp_gateway.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 msrp_gateway module. Read this file when configuring or debugging the msrp_gateway module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Replaces obsolete MI command: _msrp_gw_end_session_.
...
Replaces obsolete MI command: _msrp_gw_list_sessions_.
