...
<!-- generated-from: data/4.0/modules/gflags.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 gflags module. Read this file when configuring or debugging the gflags module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `flag` *(int, required)* — The bit position to check.
  - `0..31`
...
- `flag` *(int, required)* — The bit position to reset.
  - `0..31`
...
- `flag` *(int, required)* — The bit position to set.
  - `0..31`
...
**Returns:** The function gets no parameters and returns the bitmap in hexa and decimal format.
...
The initial value of global flags bitmap. Default value is “0”.
