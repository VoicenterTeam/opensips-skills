...
<!-- generated-from: data/4.0/modules/b2b_sdp_demux.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 b2b_sdp_demux module. Read this file when configuring or debugging the b2b_sdp_demux module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Sets the `client_bye_mode` parameter.
...
Uses `b2b_sdp_demux()` to handle an audio SIPREC call.
