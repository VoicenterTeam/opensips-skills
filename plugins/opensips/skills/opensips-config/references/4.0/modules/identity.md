...
<!-- generated-from: data/4.0/modules/identity.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 identity module. Read this file when configuring or debugging the identity module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Demonstrates the usage of the authservice() function
...
Demonstrates the usage of the verifier() function
