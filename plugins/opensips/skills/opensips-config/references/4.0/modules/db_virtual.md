...
<!-- generated-from: data/4.0/modules/db_virtual.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 db_virtual module. Read this file when configuring or debugging the db_virtual module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Replaces obsolete MI command: _db_get_. Return information about global state of the real dbs.

**Returns:** Return information about global state of the real dbs.
...
Replaces obsolete MI command: _db_set_. Sets the permissions for real dbs access per set per db. Sets the reconnect reset flag.
...
**Example.** db_virtual:set 3 2 0 1 means: 3 - the fourth set (must exist), 2 - the third URL in the fourth set(must exist), 0 - processes are not allowed to use that URL, 1 - reset and suppress db_max_consec_trys
