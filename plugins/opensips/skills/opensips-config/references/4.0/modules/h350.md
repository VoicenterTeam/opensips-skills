...
<!-- generated-from: data/4.0/modules/h350.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 h350 module. Read this file when configuring or debugging the h350 module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `libldap header files (libldap-dev)`
...
This function parses the callPreferenceURI attribute of an H.350 commObject, which must have been fetched through _h350_*_lookup_ or _ldap_search_. callPreferenceURI is a multi-valued attribute that stores call preference rules like e.g. forward-on-busy or forward-unconditionally. _Directory services architecture for call forwarding and preferences_ [[H.350.6]](#H350-6 "Directory services architecture for call forwarding and preferences") defines a format for simple call forwarding rules:
...
_h350_result_call_preferences_ stores these call forwarding rules as AVPs according to the following rules:
...
**Example.** Store H.350 call preferences in AVP and handle forward-unconditionally.
...
**Example.** Store caller's service level as AVP and make routing decision.
...
h350_sipuri_lookup function usage
...
h350_auth_lookup function usage
...
h350_result_call_preferences function usage
...
h350_result_service_level function usage
