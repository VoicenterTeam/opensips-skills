...
<!-- generated-from: data/4.0/modules/auth_db.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 auth_db module. Read this file when configuring or debugging the auth_db module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** Set the `uri_domain_column` parameter.
...
**Example.** Set the `uri_uriuser_column` parameter.
...
**Example.** Set the `uri_user_column` parameter.
...
If true (not 0), domain will be also used when looking up in the subscriber table. If you have a multi-domain setup, it is strongly recommended to keep this parameter enabled, to avoid username overlapping between domains.
...
```opensips
# load rpid column into $avp(13) and email_address_column
