...
<!-- generated-from: data/4.0/modules/presence_callinfo.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 presence_callinfo module. Read this file when configuring or debugging the presence_callinfo module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Allows you to controll the size of the internal hash table used for storing the information about the lines and indexes.
...
Sets for the current new call (initinal INVITE) the outbound line - the line used for calling out.
...
Sets for the current new call (initinal INVITE) the inbound line - the line the call was received on.
