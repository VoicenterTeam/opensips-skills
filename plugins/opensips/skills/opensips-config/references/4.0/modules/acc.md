...
<!-- generated-from: data/4.0/modules/acc.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 acc module. Read this file when configuring or debugging the acc module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** acc_unload_ctx_from_dlg usage (see acc_load_ctx_from_dlg example).
...
The ACC module is used to account transaction information to different backends such as syslog, SQL, AAA. To account a transaction and to choose which set of backends to be used, the script writer only has to mark the transaction for accounting by using the do_accounting() script function.
