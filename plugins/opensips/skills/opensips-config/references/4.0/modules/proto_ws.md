...
<!-- generated-from: data/4.0/modules/proto_ws.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 proto_ws module. Read this file when configuring or debugging the proto_ws module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**WARNING:** IF [trace_on](#param_trace_on "1.3.5.trace_on (int)") is set to 0 or tracing is deactived via the mi command [ws:trace](#mi_trace "1.4.1. ws:trace") this route won't be called.
...
This controls whether tracing for ws is on or not. You still need to define [trace_destination](#param_trace_destination "1.3.4.trace_destination (string)")in order to work, but this value will be controlled using mi function [ws:trace](#mi_trace "1.4.1. ws:trace").
...
Replaces obsolete MI command: _ws_trace_.
