...
<!-- generated-from: data/4.0/modules/mmgeoip.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 mmgeoip module. Read this file when configuring or debugging the mmgeoip module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Demonstrates looking up IP address information including longitude, latitude, and GeoIP2 specific fields.
