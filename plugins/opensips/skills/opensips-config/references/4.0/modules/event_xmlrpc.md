...
<!-- generated-from: data/4.0/modules/event_xmlrpc.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 event_xmlrpc module. Read this file when configuring or debugging the event_xmlrpc module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
In order to be notified, an XMLRPC server has to subscribe for a certain event provided by OpenSIPS. This can be done using the generic MI Interface (_event_subscribe_ function) or from OpenSIPS script (_subscribe_event_ core function).
