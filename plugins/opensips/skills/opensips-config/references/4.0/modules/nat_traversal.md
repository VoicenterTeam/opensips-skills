...
<!-- generated-from: data/4.0/modules/nat_traversal.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 nat_traversal module. Read this file when configuring or debugging the nat_traversal module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `true` — if at least one test succeeds
- `false` — otherwise
