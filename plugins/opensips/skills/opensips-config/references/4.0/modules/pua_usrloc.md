...
<!-- generated-from: data/4.0/modules/pua_usrloc.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 pua_usrloc module. Read this file when configuring or debugging the pua_usrloc module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `usrloc` — The following modules must be loaded before this module
