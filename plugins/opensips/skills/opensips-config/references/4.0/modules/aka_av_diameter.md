...
<!-- generated-from: data/4.0/modules/aka_av_diameter.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 aka_av_diameter module. Read this file when configuring or debugging the aka_av_diameter module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** Set the `server_uri` parameter.
...
This is the url representing the connection to the AAA server. Note: Currently the module only supports connections to a Diameter server. The path to the AVPs configuration file is also required, otherwise the module will not start, or not work properly.
...
The Realm used in the Origin Diameter commands. Default value is “diameter.test”.
...
The Server-URI used in the Diameter commands. If it is left empty, the Server-Name will be created by adding "sip:" in front of the realm parameter value (e.g. “sip:scscf.ims.mnc001.mcc001.3gppnetwork.org”).
