...
<!-- generated-from: data/4.0/modules/stir_shaken.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 stir_shaken module. Read this file when configuring or debugging the stir_shaken module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
* dest - the value of the 'tn' member of the 'dest' PASSporT claim;
* iat - the value of the 'iat' PASSporT claim;
* orig - the value of the 'tn' member of the 'orig' PASSporT claim;
...
Replaces obsolete MI command: _stir_shaken_ca_reload_.
...
Replaces obsolete MI command: _stir_shaken_crl_reload_.
