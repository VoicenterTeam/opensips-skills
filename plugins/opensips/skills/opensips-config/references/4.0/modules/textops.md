...
<!-- generated-from: data/4.0/modules/textops.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 textops module. Read this file when configuring or debugging the textops module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** successfully prepared an "o" line update!.
...
**Example.** adds 3463 prefix to numeric uris, and save the original uri (\\0 match) as a parameter: orig_uri (just an example) / adds the avp 'uri_prefix' as prefix to numeric uris, and save the original uri (\\0 match) as a parameter: orig_uri (just an example).
...
**Example.** adds 3463 prefix to uris ending with 3642 (just an example) / adds avp 'user_prefix' as prefix to username in r-uri ending with 3642.
