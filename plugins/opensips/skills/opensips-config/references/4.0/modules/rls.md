...
<!-- generated-from: data/4.0/modules/rls.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 rls module. Read this file when configuring or debugging the rls module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** Example 1.13. rls_handle_notify usage.
...
**Example.** Example 1.12. rls_handle_subscribe usage.
...
Replaces obsolete MI command: _rls_update_subscriptions_.
