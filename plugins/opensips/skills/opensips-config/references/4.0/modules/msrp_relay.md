...
<!-- generated-from: data/4.0/modules/msrp_relay.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 msrp_relay module. Read this file when configuring or debugging the msrp_relay module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
*Default value is No default value; this parameter is mandatory..*
