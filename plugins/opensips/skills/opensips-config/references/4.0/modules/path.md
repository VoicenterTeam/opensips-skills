...
<!-- generated-from: data/4.0/modules/path.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 path module. Read this file when configuring or debugging the path module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Sets the `use_received` module parameter to 1.
...
Sets the `enable_double_path` module parameter to 0.
...
Demonstrates the usage of the `add_path(user)` function.
...
Demonstrates the usage of the `add_path_received(user)` function.
