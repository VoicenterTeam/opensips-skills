...
<!-- generated-from: data/4.0/modules/mi_html.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 mi_html module. Read this file when configuring or debugging the mi_html module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Demonstrates setting the root parameter.
...
Demonstrates setting the http_method parameter.
...
Demonstrates setting the trace_destination parameter.
...
Demonstrates setting the trace_bwlist parameter.
