...
<!-- generated-from: data/4.0/modules/lua.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 lua module. Read this file when configuring or debugging the lua module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `Lua 5.1.x or later` — Required for the module to compile and run
- `memcached` — Required to run OpenSIPS with this module
...
**Example.** /etc/opensips/opensips.lua.
...
Demonstrates setting the luafilename parameter to specify the Lua script file.
...
Demonstrates how to use the lua_exec function to call a Lua function from the OpenSIPS configuration.
