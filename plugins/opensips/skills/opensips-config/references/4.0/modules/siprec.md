...
<!-- generated-from: data/4.0/modules/siprec.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 siprec module. Read this file when configuring or debugging the siprec module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
A regular expression used to specify the codes that should prevent the module from failing over to a new SRS server. By default any negative reply generates a failover.
