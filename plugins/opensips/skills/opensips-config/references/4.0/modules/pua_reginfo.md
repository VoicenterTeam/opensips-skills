...
<!-- generated-from: data/4.0/modules/pua_reginfo.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 pua_reginfo module. Read this file when configuring or debugging the pua_reginfo module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** Set the `default_domain` parameter.
...
**Example.** Set the `publish_reginfo` parameter.
...
**Example.** Set the `ul_domain` parameter.
...
**Example.** Set the `ul_identities_key` parameter.
