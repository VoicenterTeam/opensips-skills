...
<!-- generated-from: data/4.0/modules/group.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 group module. Read this file when configuring or debugging the group module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `AAA module` — Required for AAA support
- `database module` — Required for strict membership checking
...
If enabled, the domain part of the URI will also be used in the lookup, for a stricter group matching. Otherwise, only the username part will be used.
...
Set the `domain_column` parameter
...
Set the `group_column` parameter
...
Set the `re_exp_column` parameter
...
Set the `re_gid_column` parameter
...
Set the `multiple_gid` parameter
...
Usage of the `db_is_user_in` function
...
Usage of the `db_get_user_group` function
...
Usage of the `aaa_is_user_in` function
