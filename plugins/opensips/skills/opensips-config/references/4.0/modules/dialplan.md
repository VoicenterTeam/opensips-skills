...
<!-- generated-from: data/4.0/modules/dialplan.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 dialplan module. Read this file when configuring or debugging the dialplan module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** mysql://user:passwd@localhost/db.
...
Replaces obsolete MI command: _dp_reload_. It will update the translation rules, loading the database info.
...
Replaces obsolete MI command: _dp_show_partition_. Display partition(s) details.
...
Replaces obsolete MI command: _dp_translate_. It will apply a translation rule identified by a dialplan id on an input string.
