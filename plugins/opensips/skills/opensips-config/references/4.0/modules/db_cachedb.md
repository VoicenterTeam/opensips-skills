...
<!-- generated-from: data/4.0/modules/db_cachedb.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 db_cachedb module. Read this file when configuring or debugging the db_cachedb module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
