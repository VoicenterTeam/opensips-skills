...
<!-- generated-from: data/4.0/modules/domainpolicy.json
     generator-version: 0.1.0
     opensips-version: 4.0
     doc-type: module -->

Reference for the OpenSIPs 4.0 domainpolicy module. Read this file when configuring or debugging the domainpolicy module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
