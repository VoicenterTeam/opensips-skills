# rr Module Reference
<!-- generated-from: data/3.5/modules/rr.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 rr module. Read this file when configuring or debugging the rr module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `FALSE` — If there is no Route header, if there is only one Route header indicating the local proxy for requests with preload Route headers, or if other parsing errors occur.
- `TRUE` — If a Route header is found.
