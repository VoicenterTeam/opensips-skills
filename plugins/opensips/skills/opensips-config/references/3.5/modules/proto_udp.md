...
<!-- generated-from: data/3.5/modules/proto_udp.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 proto_udp module. Read this file when configuring or debugging the proto_udp module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
