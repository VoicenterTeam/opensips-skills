...
<!-- generated-from: data/3.5/modules/benchmark.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 benchmark module. Read this file when configuring or debugging the benchmark module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Returns:** Returns the current and global results for each timer. Each timer will have 2 nodes - the local and the global values.
