...
<!-- generated-from: data/3.5/modules/presence_dfks.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 presence_dfks module. Read this file when configuring or debugging the presence_dfks module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `values` *(string, optional)* — an array of extra values that can be updated for a feature. The format of an array element is: field/value. Supported fields are: forwardTo - for all forwarding types, ringCount - for CallForwardingNoAnswer
