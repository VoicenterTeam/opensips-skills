...
<!-- generated-from: data/3.5/modules/pua.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 pua module. Read this file when configuring or debugging the pua module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Sets the size of the hash table used for storing Subscribe and Publish information.
...
Sets the inferior expires limit for both Publish and Subscribe.
...
Sets the default expires value used in case this information is not provisioned.
...
Sets the interval at which the information in database and hash table should be updated.
...
Sets the cluster ID where the PUA data should be replicated/shared.
...
Sets the clustering share-tag to be used by the PUA module when creating any new presentity record.
...
Updates the stored remote target when receiving a NOTIFY message.
