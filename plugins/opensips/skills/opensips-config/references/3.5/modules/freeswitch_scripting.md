...
<!-- generated-from: data/3.5/modules/freeswitch_scripting.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 freeswitch_scripting module. Read this file when configuring or debugging the freeswitch_scripting module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
