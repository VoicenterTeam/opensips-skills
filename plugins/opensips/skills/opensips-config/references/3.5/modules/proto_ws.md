...
<!-- generated-from: data/3.5/modules/proto_ws.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 proto_ws module. Read this file when configuring or debugging the proto_ws module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
This controls whether tracing for ws is on or not. You still need to define trace_destination in order to work, but this value will be controlled using mi function ws_trace.
...
set ws tracing on and off. This parameter can be missing and the command will show the current tracing status for this module( on or off ).
