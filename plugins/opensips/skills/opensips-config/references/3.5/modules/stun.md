...
<!-- generated-from: data/3.5/modules/stun.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 stun module. Read this file when configuring or debugging the stun module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Sets the primary IP address, including an example for a server behind NAT advertising a different IP.
...
Sets the primary port, including an example of listening on one port but advertising another.
...
Sets the alternate IP address, including an example for a server behind NAT advertising a different IP.
...
Sets the alternate port, including an example of listening on one port but advertising another.
...
Enables the use of configured UDP SIP listeners as primary STUN sockets.
