...
<!-- generated-from: data/3.5/modules/sip_i.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 sip_i module. Read this file when configuring or debugging the sip_i module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Sets the character to be used as separator in the subname of the $isup_param and $isup_param_str pseudovariables.
...
Sets the string to be used for the Content-Type header field of the ISUP MIME body when creating a new ISUP part.
...
Sets the default set of headers to be pushed into the ISUP part together with the Content-Type header.
...
Sets the Country Code used when testing the first part of the number from P-Asserted-Identity for mapping the Calling Party Number ISUP parameter.
...
Demonstrates adding a new ISUP part to the SIP message body.
...
Demonstrates accessing and modifying ISUP parameters via the $isup_param pseudovariable.
...
Demonstrates reading ISUP parameters as string aliases using the $isup_param_str pseudovariable.
...
Demonstrates reading the ISUP message type as a string.
...
Demonstrates using the {isup.param} transformation to access ISUP parameters from a script variable.
...
Demonstrates using the {isup.param.str} transformation to access ISUP parameters as string aliases from a script variable.
