...
<!-- generated-from: data/3.5/modules/identity.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 identity module. Read this file when configuring or debugging the identity module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Switch to decide whether to use revocation lists (“1”) or not (“0”). Default value is “0”.
...
This function performs the steps of an verifier. The returned code tells you the result of the verification: -438: Signature does not correspond to the message. 438-response should be send. -437: Certificate cannot be validated. 437-response should be send. -436: Certificate is not available. 436-response should be send. -428: Message does not have an Identity header. 428-response should be send. -3: Error verifying Date header field. -2: Authentication service is not authoritative. -1: An unknown error occurred. 1: verification OK This function can be used from REQUEST_ROUTE.
