...
<!-- generated-from: data/3.5/modules/h350.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 h350 module. Read this file when configuring or debugging the h350 module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `OpenLDAP library (libldap), libldap header files (libldap-dev)`
...
**Example.** Full example of H.350 based SIP digest authentication..
...
**Example.** Stores call preferences in AVPs and handles unconditional forwarding..
...
**Example.** Stores service levels and makes a routing decision based on international access..
...
**Example.** Performs a lookup for the callee and handles return codes..
