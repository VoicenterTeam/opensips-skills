...
<!-- generated-from: data/3.5/modules/prometheus.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 prometheus module. Read this file when configuring or debugging the prometheus module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
*Default value is 0 (do not specify the group)..*
...
*Default value is empty: statistic name is provided..*
...
*Default value is "" - no custom route called..*
...
Specifies the AVP spec name to be used to for returning custom prometheus information. The AVP is expected to contain a JSON format, containing an array of arrays of custom statistics to export to prometheus. See section for the format itself.

*Default value is "" - no custom route called..*

**Example.** $avp(prometheus_out_json).
...
*Default value is empty: no metric is exported..*
