...
<!-- generated-from: data/3.5/modules/proto_tls.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 proto_tls module. Read this file when configuring or debugging the proto_tls module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Notes:** WARNING: IF [trace_on](#param_trace_on "1.5.8.trace_on (int)") is set to 0 or tracing is deactived via the mi command [tls_trace](#mi_tls_trace "1.6.1. tls_trace") this route won't be called.
...
This controls whether tracing for tls is on or not. You still need to define [trace_destination](#param_tls_trace_destination "1.5.7.trace_destination (string)")in order to work, but this value will be controlled using mi function [tls_trace](#mi_tls_trace "1.6.1. tls_trace").
