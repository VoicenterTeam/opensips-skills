...
<!-- generated-from: data/3.5/modules/xmpp.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 xmpp module. Read this file when configuring or debugging the xmpp module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** Example 1.8. xmpp_send_message() usage.
