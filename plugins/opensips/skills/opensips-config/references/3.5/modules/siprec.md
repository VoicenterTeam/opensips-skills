...
<!-- generated-from: data/3.5/modules/siprec.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 siprec module. Read this file when configuring or debugging the siprec module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
* media - the IP that RTPProxy will be streaming media from. If absent 127.0.0.1 will be used. NOTE: deprecated media_ip is an alias for this param.
