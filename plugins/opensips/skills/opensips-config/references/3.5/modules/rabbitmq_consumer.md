...
<!-- generated-from: data/3.5/modules/rabbitmq_consumer.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 rabbitmq_consumer module. Read this file when configuring or debugging the rabbitmq_consumer module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `tls_mgm` — Required if use_tls is enabled (optional)
...
An event with a custom name, as set in the _event_ field of the connection_id parameter, will be raised for each AMQP message received.
