...
<!-- generated-from: data/3.5/modules/sst.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 sst module. Read this file when configuring or debugging the sst module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `send_reply_flag` *(int, optional)* — If the fuction is called with the send_reply_flag set to true (1) and the requested Session-Expires / MIN-SE values are too small, a 422 reply will be sent for you.
  - `0`
  - `1`
