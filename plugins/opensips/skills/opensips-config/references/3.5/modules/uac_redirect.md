...
<!-- generated-from: data/3.5/modules/uac_redirect.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: module -->

Reference for the OpenSIPs 3.5 uac_redirect module. Read this file when configuring or debugging the uac_redirect module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
How many contacts (in total and per branch) are selected depends on the _max_total_ and _max_branch_ parameters:
...
Example showing how to set the default_filter module parameter to define the default behavior in filtering contacts.
...
Example showing how to set the deny_filter module parameter with a regular expression.
...
All contacts matching the deny_filter will be rejected; the rest of them will be accepted for redirection.
### Set accept_filter module parameter

Example showing how to set the accept_filter module parameter with a regular expression.
...
All contacts matching the accept_filter will be accepted; the rest of them will be rejected for redirection.
### set_deny_filter usage

Example showing how to use the set_deny_filter function to set additional deny filters for the current message.
...
Example showing how to use the set_accept_filter function to set additional accept filters for the current message.
...
Example showing how to use the get_redirects function with different parameters to extract contacts from 3xx branches.
...
A complete script example demonstrating UAC redirection.
