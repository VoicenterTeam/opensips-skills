...
Generated reference for OpenSIPs 3.6. This file is the module catalog for the `opensips-modules` skill. It maps every module in the active reference set to its per-module reference file and provides the lookup-discipline guidance that governs how Claude uses the reference set.
## Module index
