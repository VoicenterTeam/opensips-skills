...
<!-- generated-from: data/3.6/modules/perl.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 perl module. Read this file when configuring or debugging the perl module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `param` *(string, optional)* — An arbitrary string may be passed as a parameter.

**Return codes:**

- `value returned by the perl function` — general return
- `0` — if this value is 0 the script execution will be stoped
...
- `func` *(string, required)* — The function to be called.
- `param` *(string, optional)* — An arbitrary string may optionally be passed as a parameter.

**Return codes:**

- `1` — if the perl function was successfully called
...
This is the file name of your script. This may be set once only, but it may include an arbitary number of functions and “use” as many Perl module as necessary. May not be empty!
