...
<!-- generated-from: data/3.6/modules/path.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 path module. Read this file when configuring or debugging the path module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Demonstrates the usage of the `add_path` function with a username argument.
...
Demonstrates the usage of the `add_path_received` function with a username argument.
