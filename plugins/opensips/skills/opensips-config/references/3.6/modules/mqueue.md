...
<!-- generated-from: data/3.6/modules/mqueue.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 mqueue module. Read this file when configuring or debugging the mqueue module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
