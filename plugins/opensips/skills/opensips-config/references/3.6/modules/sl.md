# sl Module Reference
<!-- generated-from: data/3.6/modules/sl.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 sl module. Read this file when configuring or debugging the sl module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Sets the enable_stats parameter to 0 to disable statistics generation.
...
Demonstrates sending a stateless reply with a static code and reason, and another using pseudo-variables.
...
Demonstrates sending an error reply describing the last internal error.
