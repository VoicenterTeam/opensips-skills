...
<!-- generated-from: data/3.6/modules/signaling.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 signaling module. Read this file when configuring or debugging the signaling module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `sl` — At least one of sl or tm must be loaded
- `tm` — At least one of sl or tm must be loaded
