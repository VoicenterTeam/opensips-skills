# event_routing Module Reference
<!-- generated-from: data/3.6/modules/event_routing.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 event_routing module. Read this file when configuring or debugging the event_routing module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
The Event attributes will be exposed in the notification route via AVP variables as _$avp(attr_name) = attr_value_.
