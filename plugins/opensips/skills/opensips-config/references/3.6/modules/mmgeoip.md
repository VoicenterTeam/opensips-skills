...
<!-- generated-from: data/3.6/modules/mmgeoip.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: module -->

Reference for the OpenSIPs 3.6 mmgeoip module. Read this file when configuring or debugging the mmgeoip module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Demonstrates usage of the mmg_lookup function to retrieve latitude, longitude, and other GeoIP data.
