...
<!-- generated-from: data/3.6/core/statistics.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: statistic -->

Reference for OpenSIPs 3.6 core statistics. Read this file when looking up the canonical name, type, or reset semantics of a runtime counter or gauge exposed by the SIP processor itself.
