...
<!-- generated-from: data/3.6/core/statements.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: statement -->

Reference for OpenSIPs 3.6 script statements. Read this file when assembling control-flow constructs (if, switch, while, return, etc.) or confirming where a given statement is usable.
...
- `array` *(variable, required)* — Indexed variable or pseudo-variable to iterate over.
- `iterator` *(variable, required)* — Variable to hold the current iteration value.
...
IF-ELSE statement. The 'expr' should be a valid logical expression. Supported logical operators include ==, !=, =~, !~, >, >=, <, <=, &&, ||, !, and [ ... ].
...
- `expr` *(expression, required)* — Loop condition.
