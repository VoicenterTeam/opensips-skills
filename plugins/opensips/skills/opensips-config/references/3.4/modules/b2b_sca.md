...
<!-- generated-from: data/3.4/modules/b2b_sca.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 b2b_sca module. Read this file when configuring or debugging the b2b_sca module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `false` — if the bridging operation fails
...
**Example.** sca_bridge_request() usage.
...
- `false` — if the SCA call cannot be instantiated
