...
<!-- generated-from: data/3.4/modules/textops.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 textops module. Read this file when configuring or debugging the textops module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `'/re/repl/flags'` *(string, required)* — sed like regular expression. flags can be a combination of i (case insensitive), g (global) or s (match newline don't treat it as end of line).
  - `i`
  - `g`
  - `s`
...
**Example.** adds 3463 prefix to numeric uris, and save the original uri (\0 match) as a parameter: orig_uri.
...
**Example.** adds 3463 prefix to uris ending with 3642.
