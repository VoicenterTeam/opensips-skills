...
<!-- generated-from: data/3.4/modules/statistics.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 statistics module. Read this file when configuring or debugging the statistics module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Demonstrates setting the 'variable' parameter to define new statistic variables.
...
Demonstrates setting the 'stat_groups' parameter to define statistic groups.
...
Demonstrates setting the 'stat_series_profile' parameter to define statistic series profiles.
...
Demonstrates using the 'update_stat' function to update statistic variables.
...
Demonstrates using the 'reset_stat' function to reset statistic variables.
...
Demonstrates using the 'stat_iter_init' function to initialize an iterator.
...
Demonstrates using the 'stat_iter_next' function to iterate through statistics.
...
Demonstrates using the 'update_stat_series' function to update series statistics.
...
Demonstrates using the '$stat' pseudo-variable to get and reset statistics.
