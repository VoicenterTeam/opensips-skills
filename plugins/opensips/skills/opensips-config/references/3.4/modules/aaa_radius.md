...
<!-- generated-from: data/3.4/modules/aaa_radius.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 aaa_radius module. Read this file when configuring or debugging the aaa_radius module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `radiusclient-ng` — 0.5.0 or higher. One of the following libraries must be installed before running OpenSIPS with this module loaded.
...
For the output sets, this parameter controls if all the values (for the same RADIUS AVP) should be returned (otherwise only the first value will be returned).
