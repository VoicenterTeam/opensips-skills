...
<!-- generated-from: data/3.4/modules/pua_mi.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 pua_mi module. Read this file when configuring or debugging the pua_mi module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
