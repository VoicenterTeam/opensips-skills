...
<!-- generated-from: data/3.4/modules/msrp_gateway.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 msrp_gateway module. Read this file when configuring or debugging the msrp_gateway module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
