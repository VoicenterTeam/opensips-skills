...
<!-- generated-from: data/3.4/modules/cachedb_redis.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 cachedb_redis module. Read this file when configuring or debugging the cachedb_redis module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `hiredis` — Client library to connect to Redis
...
**Example.** Set the `query_timeout` parameter.
...
The cachedb_redis module allows to run RAW queries, thus taking full advantage of the capabilities of the back-end. The query syntax is the typical REDIS one. Here are a couple examples of running some Redis queries :
