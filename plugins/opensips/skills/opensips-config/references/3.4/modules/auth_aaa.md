...
<!-- generated-from: data/3.4/modules/auth_aaa.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 auth_aaa module. Read this file when configuring or debugging the auth_aaa module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `sip_uri` *(string, optional)* — SIP URI to check. If not given, the user@host part of the Request-URI is used.
...
- `sip_uri` *(string, optional)* — User to check. If not given, the Request-URI user part is used.
