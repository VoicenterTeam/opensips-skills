...
<!-- generated-from: data/3.4/modules/b2b_logic.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 b2b_logic module. Read this file when configuring or debugging the b2b_logic module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
### `b2b_bridge_request(b2bl_key,entity_no, [adv_contact])`
...
- `entity_no` *(integer, required)* — an integer that holds the entity of the entity/participant to bridge.
...
- `params` *(string, optional)* — Parameters to be used in this scenario (optionally as CSV). Flags: n (Enable rfc3515 NOTIFY), session key (Internal session key), party of remote session (0 = A-Party, 1 = B-Party).
- `peer1` *(string, required)* — Parameters to define the A-Party of the triggered scenario (entity_name, RURI, Proxy, Display-Name).
...
- `context` *(string, optional)* — array of B2B context values, in the format: key=value
