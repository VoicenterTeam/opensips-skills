...
<!-- generated-from: data/3.4/modules/tcp_mgm.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 tcp_mgm module. Read this file when configuring or debugging the tcp_mgm module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `SQL database module` — At least one SQL database module must be loaded
