...
<!-- generated-from: data/3.4/modules/acc.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 acc module. Read this file when configuring or debugging the acc module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `a database module` — If SQL support is used (optional)
- `an aaa module` (optional)
...
- `dictionary.rfc2866 (If radius accounting is used)`
- `radius client library (If radius accounting is used)`
...
Defines the tag-log_value set to be used in extra fields accounting. See Section 1.2, “Extra accounting” for a detailed description of the Extra accounting. If empty, extra accounting support will be disabled.
...
Defines the tag-log_value set to be used in multi-leg accounting. See Section 1.3, “Multi Call-Legs accounting” for a detailed description of the Multi Call-Legs accounting. If empty, multi-leg accounting support will be disabled.
...
**Notes:** Default value of service type for SIP is 15
...
modparam("acc", "detect_direction", 1)
```
### Setting _extra_fields_ example:
