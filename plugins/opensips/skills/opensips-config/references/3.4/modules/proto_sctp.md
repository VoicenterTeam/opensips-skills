...
<!-- generated-from: data/3.4/modules/proto_sctp.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 proto_sctp module. Read this file when configuring or debugging the proto_sctp module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Sets the default port to be used for all SCTP related operation.
