...
<!-- generated-from: data/3.4/modules/cachedb_mongodb.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 cachedb_mongodb module. Read this file when configuring or debugging the cachedb_mongodb module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `libbson` — Required for compilation
- `libjson-c` — Required for runtime and compilation
- `libmongoc` — Required for runtime and compilation
