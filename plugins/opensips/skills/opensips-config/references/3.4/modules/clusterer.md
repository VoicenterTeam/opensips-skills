...
<!-- generated-from: data/3.4/modules/clusterer.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 clusterer module. Read this file when configuring or debugging the clusterer module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Notes:** This parameter must be explicitly set to a value greater than zero.
...
**Notes:** Multiple definitions of this parameter are allowed. The format for this value is “tag_name / cluster_id = active/backup”.
...
**Returns:** Standard MI response indicating success or failure.
...
**Returns:** JSON object containing cluster and node information including node id, URL, and link state.
...
**Returns:** JSON object containing registered capabilities and their states.
...
**Returns:** Standard MI response containing the list of sharing tags.
...
**Returns:** JSON object containing each cluster's topology as an adjacency list.
