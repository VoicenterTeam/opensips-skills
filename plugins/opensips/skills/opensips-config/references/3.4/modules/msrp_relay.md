...
<!-- generated-from: data/3.4/modules/msrp_relay.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 msrp_relay module. Read this file when configuring or debugging the msrp_relay module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
