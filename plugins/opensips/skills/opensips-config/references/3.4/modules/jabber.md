...
<!-- generated-from: data/3.4/modules/jabber.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 jabber module. Read this file when configuring or debugging the jabber module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `Expat` — Must be installed before running OpenSIPS with this module loaded
...
_Default value is “mysql://root@127.0.0.1/sip_jab”._
...
_Default value is “jabber_gateway@127.0.0.1”._
