...
<!-- generated-from: data/3.4/modules/nathelper.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 nathelper module. Read this file when configuring or debugging the nathelper module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `flags` *(string, required)* — denotes a comma-separated list of checks to be performed
  - `private-contact`
  - `diff-ip-src-via`
  - `private-via`
  - `private-sdp`
...
The parameter sets the SDP attribute used by nathelper to mark the packet SDP informations have already been mangled. If empty string, no marker will be added or checked.
