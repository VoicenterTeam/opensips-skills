...
<!-- generated-from: data/3.4/modules/presence_xml.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 presence_xml module. Read this file when configuring or debugging the presence_xml module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `signaling`
- `xcap`
- `xcap_client` — Only compulsory if not using an integrated xcap server
...
**Example.** Set the `generate_offline_body` parameter.
...
**Example.** Set the `pres_rules_auid` parameter.
...
**Example.** Set the `pres_rules_filename` parameter.
...
**Example.** Set the `xcap_server` parameter.
