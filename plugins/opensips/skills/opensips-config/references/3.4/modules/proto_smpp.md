...
<!-- generated-from: data/3.4/modules/proto_smpp.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 proto_smpp module. Read this file when configuring or debugging the proto_smpp module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** Set the `outbound_uri` parameter.
...
**Example.** Set the `smpp_max_msg_chunks` parameter.
...
**Example.** Set the `smpp_port` parameter.
...
**Example.** Set the `smpp_send_timeout` parameter.
...
- `-2` — if the SMSc the message should be sent does not exist in the database
