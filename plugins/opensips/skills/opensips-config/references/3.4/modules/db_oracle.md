...
<!-- generated-from: data/3.4/modules/db_oracle.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 db_oracle module. Read this file when configuring or debugging the db_oracle module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Set the `timeout` parameter to 1.5 seconds.
...
Disable asynchronous mode by setting the `timeout` parameter to 0.
...
Set the `reconnect` parameter to 0.5 seconds.
