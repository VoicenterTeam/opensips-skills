...
<!-- generated-from: data/3.4/modules/stir_shaken.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 stir_shaken module. Read this file when configuring or debugging the stir_shaken module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
