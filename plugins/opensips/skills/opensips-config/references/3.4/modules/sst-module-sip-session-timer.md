...
<!-- generated-from: data/3.4/modules/sst-module-sip-session-timer.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 SST Module (SIP Session Timer) module. Read this file when configuring or debugging the SST Module (SIP Session Timer) module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Demonstrates setting the enable_stats parameter.
...
Demonstrates setting the min_se parameter.
...
Demonstrates setting the sst_interval parameter.
...
Demonstrates setting the reject_to_small parameter.
...
Demonstrates setting the sst_flag parameter and using it in a route block.
