...
<!-- generated-from: data/3.4/modules/db_http.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 db_http module. Read this file when configuring or debugging the db_http module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Demonstrates how to set the db_url for a module to use the db_http interface.
...
Demonstrates setting the SSL parameter to 1 to enable HTTPS.
...
Demonstrates setting the cap_raw_query parameter to 1 to enable raw query support.
...
Demonstrates setting the cap_replace parameter to 1 to enable replace capabilities.
...
Demonstrates setting the cap_insert_update parameter to 1 to enable insert_update capabilities.
...
Demonstrates setting the cap_last_inserted_id parameter to 1 to enable last_inserted_id capabilities.
...
Demonstrates setting the disable_expect parameter to 1.
