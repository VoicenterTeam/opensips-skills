...
<!-- generated-from: data/3.4/modules/prometheus.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 prometheus module. Read this file when configuring or debugging the prometheus module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Notes:** This parameter can be defined multiple times, even for a single group.
