...
<!-- generated-from: data/3.4/modules/mangler.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 mangler module. Read this file when configuring or debugging the mangler module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Demonstrates setting the `contact_flds_separator` parameter.
...
Demonstrates usage of the `sdp_mangle_ip` function.
...
Demonstrates usage of the `sdp_mangle_port` function.
...
Demonstrates usage of the `encode_contact` function.
...
Demonstrates usage of the `decode_contact` function.
...
Demonstrates usage of the `decode_contact_header` function.
