...
<!-- generated-from: data/3.4/modules/pua.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 pua module. Read this file when configuring or debugging the pua module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `clusterer` — Required if cluster_id module parameter is set and clustering support activated (optional)
- `database modules` — Required for database operations
- `tm` — Required for transaction management
