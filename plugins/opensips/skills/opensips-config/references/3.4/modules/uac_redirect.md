...
<!-- generated-from: data/3.4/modules/uac_redirect.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 uac_redirect module. Read this file when configuring or debugging the uac_redirect module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Demonstrates a redirection script
