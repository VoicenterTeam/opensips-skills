...
<!-- generated-from: data/3.4/modules/perl.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 perl module. Read this file when configuring or debugging the perl module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `IPC::Shareable (for sample scripts)`
- `Net::LDAP (for OpenSIPS::LDAPUtils)`
...
- `value returned by the perl function` — default
- `0` — script execution will be stoped, similarly to calling exit
...
Sets the file name of the Perl script.
...
Sets the path to the Perl modules included (OpenSIPS.pm et.al).
...
Demonstrates calling a perl function without passing the current SIP message.
...
Demonstrates calling a perl function with passing the current SIP message.
