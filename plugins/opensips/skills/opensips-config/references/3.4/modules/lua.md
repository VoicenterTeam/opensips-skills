...
<!-- generated-from: data/3.4/modules/lua.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 lua module. Read this file when configuring or debugging the lua module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `Lua 5.1.x or later` — Required for the module to compile and run. Tested with 5.1.
- `memcached` — Must be installed before running OpenSIPS with this module loaded.
...
- `extension` *(string, optional)* — required if _action_ is provided
...
Sets the luafilename parameter to the script path.
...
Demonstrates how to call a Lua function using lua_exec().
