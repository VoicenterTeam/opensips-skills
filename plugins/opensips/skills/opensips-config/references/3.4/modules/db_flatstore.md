...
<!-- generated-from: data/3.4/modules/db_flatstore.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 db_flatstore module. Read this file when configuring or debugging the db_flatstore module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
