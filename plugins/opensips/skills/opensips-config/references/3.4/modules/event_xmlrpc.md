...
<!-- generated-from: data/3.4/modules/event_xmlrpc.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 event_xmlrpc module. Read this file when configuring or debugging the event_xmlrpc module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
