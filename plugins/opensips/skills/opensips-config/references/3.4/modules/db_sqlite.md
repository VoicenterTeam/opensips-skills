...
<!-- generated-from: data/3.4/modules/db_sqlite.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 db_sqlite module. Read this file when configuring or debugging the db_sqlite module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Demonstrates setting the `alloc_limit` parameter to 25.
...
...
```
### Set `db_sqlite_alloc_limit` parameter

Demonstrates setting the `load_extension` parameter to load a SQLite extension.
