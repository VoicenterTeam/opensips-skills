...
<!-- generated-from: data/3.4/modules/regex.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 regex module. Read this file when configuring or debugging the regex module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
An example of the file format containing regular expressions categorized in groups.
...
Demonstrates an incorrect file format where group numbers do not start at 0.
