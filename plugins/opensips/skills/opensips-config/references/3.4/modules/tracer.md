...
<!-- generated-from: data/3.4/modules/tracer.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 tracer module. Read this file when configuring or debugging the tracer module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `database module` — only if you are using a database type trace id
...
**Example.** Set the `file_mode` parameter.
...
**Example.** Set the `syslog_default_facility` parameter.
...
**Example.** Set the `syslog_default_level` parameter.
...
*Default value is No default value. If not set the module will be useless..*

**Example.** Set the `trace_id` parameter.
...
**Example.** Set the `trace_local_ip` parameter.
...
**Returns:** Confirmation of dynamic tracing destination creation.
