...
<!-- generated-from: data/3.4/modules/freeswitch.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 freeswitch module. Read this file when configuring or debugging the freeswitch module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
This driver can be seen as a centralized FreeSWITCH ESL connection manager. OpenSIPS modules may use its API in order to easily establish, reference and reuse ESL connections. A FreeSWITCH ESL URL is of the form: fs://[username]:password@host[:port]. The default ESL port is 8021.
