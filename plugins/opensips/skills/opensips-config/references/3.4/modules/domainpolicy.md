...
<!-- generated-from: data/3.4/modules/domainpolicy.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 domainpolicy module. Read this file when configuring or debugging the domainpolicy module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** Set the `domain_suffix_avp` parameter.
...
```opensips
modparam("domainpolicy", "dp_col_rule", "type")
```
### `dp_col_val` (string)
...
**Example.** Set the `send_socket_avp` parameter.
...
Sets the dp_col_rule parameter.
...
Sets the dp_col_type parameter.
...
Sets the port_override_avp parameter.
...
Sets the transport_override_avp parameter.
...
Sets the domain_replacement_avp parameter.
...
Sets the domain_prefix_avp parameter.
...
Sets the domain_suffix_avp parameter.
...
Sets the send_socket_avp parameter.
...
Demonstrates the usage of the dp_can_connect function.
...
Demonstrates the usage of the dp_apply_policy function.
