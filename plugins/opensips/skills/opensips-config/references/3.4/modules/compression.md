...
<!-- generated-from: data/3.4/modules/compression.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 compression module. Read this file when configuring or debugging the compression module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `flags` *(string, required)* — Controls the behavior of the function. Possible flags are: “n” - Do not use short form of headers.
  - `n`
...
Sets the mc_level parameter to 3.
...
Compresses the message using deflate algorithm, flags 'bhs', and a specific whitelist.
...
Compresses the message using variables for algorithm, flags, and whitelist.
...
Compacts the message with a specific whitelist.
