...
<!-- generated-from: data/3.4/modules/json.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 json module. Read this file when configuring or debugging the json module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
**Example.** Set the `enable_long_quoting` parameter.
...
- `dest_id` *(json, required)* — The destination JSON object where the reference will be stored.
- `source_id` *(json, required)* — The source JSON object to be referenced.
...
Demonstrates setting the `enable_long_quoting` parameter.
...
Demonstrates accessing the $json variable.
...
Demonstrates iterating through an array using variables.
...
Demonstrates iteration over $json object keys.
...
Demonstrates iteration over $json object values.
...
Demonstrates iteration over $json array values.
...
Demonstrates appending integers to arrays.
...
Demonstrates deleting the last element in an array.
...
Demonstrates adding a string value to a json object.
...
Demonstrates initializing an array.
...
Demonstrates setting a boolean or null value.
...
Demonstrates adding a json to another json.
...
Demonstrates creating a reference.
...
Demonstrates creating a circular reference.
