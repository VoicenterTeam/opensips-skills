...
<!-- generated-from: data/3.4/modules/msilo.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 msilo module. Read this file when configuring or debugging the msilo module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `TM` — used to send SIP requests
- `database module` — implements the “db” interface and provides support for storing/receiving data to/from a database system
