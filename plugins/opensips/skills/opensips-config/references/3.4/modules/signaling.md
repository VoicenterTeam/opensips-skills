...
<!-- generated-from: data/3.4/modules/signaling.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 signaling module. Read this file when configuring or debugging the signaling module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Demonstrates sending a reply with a specific code and reason, or using error variables.
...
Demonstrates retrieving the local To-tag in both stateful and stateless handling contexts.
