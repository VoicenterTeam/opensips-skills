...
<!-- generated-from: data/3.4/modules/status_report.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 status_report module. Read this file when configuring or debugging the status_report module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Demonstrates how to define multiple Status/Report groups ('security' and 'alarms') using the script_sr_group parameter.
...
Demonstrates setting a new status and details for the 'script_caching' Status/Report group.
...
Demonstrates adding a new report/log to the 'security' Status/Report group.
