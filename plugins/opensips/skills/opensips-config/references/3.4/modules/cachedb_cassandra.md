...
<!-- generated-from: data/3.4/modules/cachedb_cassandra.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 cachedb_cassandra module. Read this file when configuring or debugging the cachedb_cassandra module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
Sets the cachedb_url parameter to define Cassandra server groups, contact points, and the keyspace/table structure.
...
Demonstrates script usage of the Cassandra cache functions (cache_store, cache_fetch, cache_remove) using the defined groups.
...
Sets the connect_timeout parameter to 1000ms.
...
Sets the query_timeout parameter to 1000ms.
...
Sets the wr_consistency_level parameter to 'each_quorum'.
...
Sets the rd_consistency_level parameter to 'quorum'.
...
Sets the exec_threshold parameter to 100000.
