...
<!-- generated-from: data/3.4/modules/xcap.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 xcap module. Read this file when configuring or debugging the xcap module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `libxml-dev` — must be installed before running OpenSIPS with this module loaded
