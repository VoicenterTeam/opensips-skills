...
<!-- generated-from: data/3.4/modules/presence_mwi.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 presence_mwi module. Read this file when configuring or debugging the presence_mwi module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
