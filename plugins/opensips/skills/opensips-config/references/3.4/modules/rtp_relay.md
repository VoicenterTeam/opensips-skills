...
<!-- generated-from: data/3.4/modules/rtp_relay.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: module -->

Reference for the OpenSIPs 3.4 rtp_relay module. Read this file when configuring or debugging the rtp_relay module: signature, parameters, return codes, exported MI commands, statistics, events, and configuration examples.
...
- `engine` *(string, required)* — the RTP relay engine to be used for the call (i.e. _rtpproxy_.
...
- **Type:** string
- **Read/write:** read-write
- **Scope:** request, reply, transaction, dialog
### `$rtp_relay_peer`
...
Updates/Re-engages the RTP relays for a specific callid.
