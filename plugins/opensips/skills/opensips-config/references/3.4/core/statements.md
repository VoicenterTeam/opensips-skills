...
<!-- generated-from: data/3.4/core/statements.json
     generator-version: 0.1.0
     opensips-version: 3.4
     doc-type: statement -->

Reference for OpenSIPs 3.4 script statements. Read this file when assembling control-flow constructs (if, switch, while, return, etc.) or confirming where a given statement is usable.
...
- `$(var[*])` *(array, required)* — Indexed variable or pseudo-variable to iterate over.
- `$var(it)` *(variable, required)* — Iterator variable.
...
IF-ELSE statement. The 'expr' should be a valid logical expression. The logical operators that can be used in the logical expressions: ==, !=, =~, !~, >, >=, <, <=, &&, ||, !, [ ... ].
