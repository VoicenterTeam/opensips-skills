...
<!-- generated-from: data/3.6/core/events.json
     generator-version: 0.1.0
     opensips-version: 3.6
     doc-type: event -->

Reference for OpenSIPs 3.6 core events. Read this file when subscribing to or raising runtime events through event_route blocks or the event-handling MI commands.
