...
<!-- generated-from: data/3.5/core/events.json
     generator-version: 0.1.0
     opensips-version: 3.5
     doc-type: event -->

Reference for OpenSIPs 3.5 core events. Read this file when subscribing to or raising runtime events through event_route blocks or the event-handling MI commands.
...
This event is triggered whenever a log message is produced by OpenSIPS.
...
This event is triggered whenever a new process is created (forked) or a process is terminated due the auto-scaling logic.
...
- `group_load` *(string)* — the load over the scaling group.
