...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6219264)

3.2. [Most recently active contributors(1) to this module](#idp6318832)

**List of Examples**

1.1. [Set `server_hsize` parameter](#idp100672)

1.2. [Set `script_req_route` parameter](#idp104752)

1.3. [Set `script_repl_route` parameter](#idp183760)

1.4. [Set `cleanup_period` parameter](#idp189168)

1.5. [Set parameter](#idp5540592)

1.6. [Set parameter](#idp5549456)

1.7. [Set `db_url` parameter](#idp5552992)

1.8. [Set `cachedb_url` parameter](#idp5556768)

1.9. [Set `cachedb_key_prefix` parameter](#idp5561584)

1.10. [Set `update_period` parameter](#idp5566480)

1.11. [Set `max_duration` parameter](#idp5571680)

1.12. [Set `contact_user` parameter](#idp5576576)

1.13. [Set `b2bl_from_spec_param` parameter](#idp5582240)

1.14. [Set `server_address` parameter](#idp5586672)

1.15. [Set `server_address` parameter using Pseudo-Variables](#idp5588544)

1.16. [Set `init_callid_hdr` parameter](#idp5592576)

1.17. [Set `db_mode` parameter](#idp5599632)

1.18. [Set `db_table` parameter](#idp5604448)

1.19. [Set `b2bl_th_init_timeout` parameter](#idp5609344)

1.20. [Set `b2bl_early_update` parameter](#idp5615952)

1.21. [Set `old_entity_term_delay` parameter](#idp5621872)

1.22. [`b2b_init_request` usage](#idp5639888)

1.23. [`b2b_server_new` usage](#idp5651008)

1.24. [`b2b_client_new` usage](#idp5665216)

1.25. [`b2b_bridge` usage](#idp5682288)

1.26. [`b2b_bridge` usage](#idp5689392)

1.27. [`b2b_pass_request` usage](#idp5694944)

1.28. [`b2b_handle_reply` usage](#idp5703328)

1.29. [`b2b_send_reply` usage](#idp5712528)

1.30. [`b2b_delete_entity` usage](#idp5717344)

1.31. [`b2b_end_dlg_leg` usage](#idp5722768)

1.32. [`b2b_bridge_request` usage](#idp5733808)

1.33. [`b2b_trigger_scenario` usage](#idp5757152)

1.34. [`$b2b_logic.key` usage](#idp5802240)

1.35. [`$b2b_logic.entity` usage](#idp5816624)

1.36. [`$b2b_logic.ctx` usage](#idp5823440)

1.37. [`$b2b_logic.scenario` usage](#idp5828800)

2.1. [`b2bl_api_t` structure](#idp6134752)
...
*   _flags (string, optional)_ - CSV list of the following flags:
    ...
    *   _no-late-sdp_ - Do not attempt late SDP negotiation with the new entity. Start the bridging by first contacting the new entity using the initial SDP received from the old entity. After the new entity answers, send a reINVITE without body to the old entity. Use the current SDP received in this new answer from the old entity to trigger a renegotiation with the new entity.
...
*   _flags (string, optional)_ - a list of comma separated flags that changes the behavior of the reply processing. Supported values are:
    
    *   _pass-3xx-contact_ - When a redirect reply (3xx) message is received, pass the contact to the other peer just as it is, without modifying it.
...
### 1.5.11.� `b2b_bridge_request(b2bl_key,entity_no, [adv_contact], [flags])`
...
*   _flags (string, optional)_ - Flags that can modify the behavior of the function. Available flags are:
    
    *   _late\_bye_ - instead of terminating the replaced entity on the stop, leave it pending until the new enity fully establishes.
...
**All remaining contributors**: andingv, Aron Podrigal ([@ar45](https://github.com/ar45)), Rick Barenthin, Shanee Vanstone, Zero King ([@l2dy](https://github.com/l2dy)).
...
**All remaining contributors**: truong.hua, Nick Altmann ([@nikbyte](https://github.com/nikbyte)), Carsten Bock, Aron Podrigal ([@ar45](https://github.com/ar45)), Zero King ([@l2dy](https://github.com/l2dy)).
