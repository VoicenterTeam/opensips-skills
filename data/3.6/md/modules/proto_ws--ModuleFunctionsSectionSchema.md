...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp4693152)

3.2. [Most recently active contributors(1) to this module](#idp5737648)

**List of Examples**

1.1. [Set `ws_port` parameter](#idp4433744)

1.2. [Set `ws_send_timeout` parameter](#idp4976192)

1.3. [Set `ws_max_msg_chunks` parameter](#idp2684160)

1.4. [Set `trace_destination` parameter](#idp2604928)

1.5. [Set `trace_on` parameter](#idp5419072)

1.6. [Set `trace_filter_route` parameter](#idp5383264)

1.7. [Set `require_origin` parameter](#idp4374208)
...
The **proto\_ws** module is transport module that provides communication over the WebSocket protocol. This module is fully compliant with the [RFC 7118](http://tools.ietf.org/html/rfc7118), thus allowing browsers to act as SIP clients for the OpenSIPS proxy.
...
*   trace\_mode(optional): set ws tracing on and off. This parameter can be missing and the command will show the current tracing status for this module( on or off ); Possible values:
...
**All remaining contributors**: James Stanley, Juli�n Moreno Pati�o.
...
**All remaining contributors**: Ionut Ionita ([@ionutrazvanionita](https://github.com/ionutrazvanionita)), Juli�n Moreno Pati�o.
