...
4.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp7101152)

4.2. [Most recently active contributors(1) to this module](#idp7235856)

**List of Examples**

1.1. [Set `enable_stats` parameter](#idp5547456)

1.2. [Set `hash_size` parameter](#idp5553152)

1.3. [Set `hash_size` parameter](#idp5558272)

1.4. [Set `rr_param` parameter](#idp5563248)

1.5. [Set `default_timeout` parameter](#idp5568144)

1.6. [Set `dlf_extra_hdrs` parameter](#idp5573104)

1.7. [Set `dlg_match_mode` parameter](#idp5582752)

1.8. [Set `delete_delay` parameter](#idp5589200)

1.9. [Set `db_url` parameter](#idp5594048)

1.10. [Set `db_mode` parameter](#idp5604864)

1.11. [Set `db_update_period` parameter](#idp5610176)

1.12. [Set `options_ping_interval` parameter](#idp5615136)

1.13. [Set `reinvite_ping_interval` parameter](#idp5622304)

1.14. [Set `table_name` parameter](#idp5627248)

1.15. [Set `call_id_column` parameter](#idp5632144)

1.16. [Set `from_uri_column` parameter](#idp5637136)

1.17. [Set `from_tag_column` parameter](#idp5642144)

1.18. [Set `to_uri_column` parameter](#idp5647136)

1.19. [Set `to_tag_column` parameter](#idp5652176)

1.20. [Set `from_cseq_column` parameter](#idp5657168)

1.21. [Set `to_cseq_column` parameter](#idp5662160)

1.22. [Set `from_route_column` parameter](#idp5667184)

1.23. [Set `to_route_column` parameter](#idp5672208)

1.24. [Set `from_contact_column` parameter](#idp5677200)

1.25. [Set `to_contact_column` parameter](#idp5682208)

1.26. [Set `from_sock_column` parameter](#idp5687248)

1.27. [Set `to_sock_column` parameter](#idp5692288)

1.28. [Set `dlg_id_column` parameter](#idp5697280)

1.29. [Set `state_column` parameter](#idp5702272)

1.30. [Set `start_time_column` parameter](#idp5707280)

1.31. [Set `timeout_column` parameter](#idp5712256)

1.32. [Set `profiles_column` parameter](#idp5717248)

1.33. [Set `vars_column` parameter](#idp5722224)

1.34. [Set `sflags_column` parameter](#idp5727216)

1.35. [Set `mflags_column` parameter](#idp5732208)

1.36. [Set `flags_column` parameter](#idp5737184)

1.37. [Set `profiles_with_value` parameter](#idp5743088)

1.38. [Set `profiles_no_value` parameter](#idp5749040)

1.39. [Set `db_flush_vals_profiles` parameter](#idp5754112)

1.40. [Set `timer_bulk_del_no` parameter](#idp5759152)

1.41. [Set `race_condition_timeout` parameter](#idp5764240)

1.42. [Set `cachedb_url` parameter](#idp5769264)

1.43. [Set `profile_value_prefix` parameter](#idp5774352)

1.44. [Set `profile_no_value_prefix` parameter](#idp5779440)

1.45. [Set `profile_size_prefix` parameter](#idp5784528)

1.46. [Set `profile_timeout` parameter](#idp5789600)

1.47. [Set `dialog_replication_cluster` parameter](#idp5801744)

1.48. [Set `profile_replication_cluster` parameter](#idp5807696)

1.49. [Set `replicate_profiles_buffer` parameter](#idp5812976)

1.50. [Set `replicate_profiles_check` parameter](#idp5818176)

1.51. [Set `replicate_profiles_timer` parameter](#idp5823296)

1.52. [Set `replicate_profiles_expire` parameter](#idp5828528)

1.53. [Set `cluster_auto_sync` parameter](#idp5834144)

1.54. [`create_dialog()` usage](#idp5849488)

1.55. [`match_dialog()` usage](#idp5858336)

1.56. [`validate_dialog()` usage](#idp5870528)

1.57. [`fix_route_dialog()` usage](#idp5876032)

1.58. [`get_dialog_info` usage](#idp5888192)

1.59. [`get_dialog_vals` usage](#idp5899008)

1.60. [`get_dialog_vals` usage](#idp5909856)

1.61. [`get_dialog_vals` usage](#idp5920880)

1.62. [`load_dialog_ctx` usage](#idp5930480)

1.63. [`set_dlg_profile` usage](#idp5945184)

1.64. [`unset_dlg_profile` usage](#idp5954064)

1.65. [`is_in_profile` usage](#idp5962608)

1.66. [`get_profile_size` usage](#idp5971808)

1.67. [`set_dlg_flag` usage](#idp5979504)

1.68. [`test_and_set_dlg_flag` usage](#idp5987712)

1.69. [`reset_dlg_flag` usage](#idp5995072)

1.70. [`is_dlg_flag_set` usage](#idp6002432)

1.71. [`store_dlg_value` usage](#idp6012048)

1.72. [`fetch_dlg_value` usage](#idp6021376)

1.73. [`set_dlg_sharing_tag` usage](#idp6029808)

1.74. [`dlg_on_answer` usage](#idp6037376)

1.75. [`dlg_on_timeout` usage](#idp6045760)

1.76. [`dlg_on_hangup` usage](#idp6053696)

1.77. [`dlg_send_sequential` usage to convert DTMF codes](#idp6065088)

1.78. [`dlg_inc_cseq` usage](#idp6073712)
...
Name: _set\_dlg\_profile_

Parameters: _It takes 2-4 parameters_

*   _dlg\_id_ - dialog ID or Call-ID for the respective dialog
    
*   _profile_ - profile name to be set
    
*   _value_ - optional, the profile value to be set
    
*   _clear\_values_ - optional, clear previous values in the profile before setting the new one
    

MI FIFO Command Format:

		opensips-cli -x mi set\_dlg\_profile DID my\_profile my\_value 1
		

### 1.9.15.�`unset_dlg_profile`
...
Parameters: _It takes 2-3 parameters_

*   _dlg\_id_ - dialog ID or Call-ID for the respective dialog
    
*   _profile_ - profile name to be unset
    
*   _value_ - optional, the profile value to be unset. for profiles with value, by omitting this parameter you can now clear all values of the given profile.
    

MI FIFO Command Format:

		opensips-cli -x mi unset\_dlg\_profile DID my\_profile my\_value
...
**All remaining contributors**: Anca Vamanu, Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Ionut Ionita ([@ionutrazvanionita](https://github.com/ionutrazvanionita)), Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Ionel Cerghit ([@ionel-cerghit](https://github.com/ionel-cerghit)), Andrei Dragus, Alexandra Titoc, John Riordan, Hugues Mitonneau, Carsten Bock, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Jerome Martin, Klaus Darilion, Jarrod Baumann ([@jarrodb](https://github.com/jarrodb)), Nick Altmann ([@nikbyte](https://github.com/nikbyte)), Zero King ([@l2dy](https://github.com/l2dy)), Michel Bensoussan, Richard Revels, Tavis Paquette, Elena-Ramona Modroiu, Ryan Bullock, Andrei Datcu ([@andrei-datcu](https://github.com/andrei-datcu)), Jeffrey Magder, Stefan-Cristian Mititelu, Ron Winacott, Andy Pyles, Juli�n Moreno Pati�o, Konstantin Bokarius, sergei lavrov, Alex Massover, Damien Sandras ([@dsandras](https://github.com/dsandras)), Alex Hermann, Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), Norman Brandinger ([@NormB](https://github.com/NormB)), UnixDev, Eliot Gable, Ryan Bullock ([@rrb3942](https://github.com/rrb3942)), Edson Gellert Schubert.
