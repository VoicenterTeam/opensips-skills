...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5536512)

2.2. [Most recently active contributors(1) to this module](#idp5629840)

**List of Examples**

1.1. [Set `bin_port` parameter](#idp258336)

1.2. [Set `bin_send_timeout` parameter](#idp248144)

1.3. [Set `bin_max_msg_chunks` parameter](#idp165104)

1.4. [Set `bin_async` parameter](#idp170176)

1.5. [Set `bin_async_max_postponed_chunks` parameter](#idp5510560)

1.6. [Set `bin_async_local_connect_timeout` parameter](#idp5515648)

1.7. [Set `bin_async_local_write_timeout` parameter](#idp5520736)
