...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5586848)

2.2. [Most recently active contributors(1) to this module](#idp5689712)

**List of Examples**

1.1. [Set `fifo_name` parameter](#idp163600)

1.2. [Set `fifo_mode` parameter](#idp168480)

1.3. [Set `fifo_group` parameter](#idp173648)

1.4. [Set `fifo_user` parameter](#idp5518640)

1.5. [Set `reply_dir` parameter](#idp5523456)

1.6. [Set `pretty_printing` parameter](#idp5528384)

1.7. [Set `trace_destination` parameter](#idp5535296)

1.8. [Set `trace_destination` parameter](#idp5543920)

1.9. [FIFO request](#idp5549280)
