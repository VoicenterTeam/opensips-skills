...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5568688)

2.2. [Most recently active contributors(1) to this module](#idp5663488)

**List of Examples**

1.1. [Set `call_info_timeout_notification` parameter](#idp5515328)

1.2. [Set `line_seize_timeout_notification` parameter](#idp5519888)

1.3. [Set `disable_dialog_support_for_sca` parameter](#idp5524800)

1.4. [Set `line_hash_size` parameter](#idp5530144)

1.5. [`sca_set_calling_line()` usage](#idp5536720)

1.6. [`sca_set_called_line()` usage](#idp5542192)
