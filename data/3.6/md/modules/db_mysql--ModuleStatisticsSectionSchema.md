...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp30764048)

2.2. [Most recently active contributors(1) to this module](#idp30869840)

**List of Examples**

1.1. [Set `exec_query_threshold` parameter](#idp25489856)

1.2. [Set `timeout_interval` parameter](#idp30696608)

1.3. [Set `max_db_queries` parameter](#idp30701232)

1.4. [Set `max_db_retries` parameter](#idp30705824)

1.5. [Set `ps_max_col_size` parameter](#idp30711360)

1.6. [Set the `use_tls` parameter](#idp30721888)
...
**All remaining contributors**: Nils Ohlmeier, Norman Brandinger ([@NormB](https://github.com/NormB)), Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Eseanu Marius Cristian ([@eseanucristian](https://github.com/eseanucristian)), Dan Pascu ([@danpascu](https://github.com/danpascu)), Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Ionut Ionita ([@ionutrazvanionita](https://github.com/ionutrazvanionita)), Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)), Konstantin Bokarius, Andreas Heise, Razvan Pistolea, Ken Rice, Sa�l Ibarra Corretg� ([@saghul](https://github.com/saghul)), Sergio Gutierrez, Edson Gellert Schubert, Augusto Caringi.
