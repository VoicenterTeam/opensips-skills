...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5787824)

2.2. [Most recently active contributors(1) to this module](#idp5885216)

**List of Examples**

1.1. [Set the “db\_url” parameter](#idp169376)

1.2. [Set the “use\_utc\_time” parameter](#idp5515760)

1.3. [Set the “table\_name” parameter](#idp5520704)

1.4. [Set “rid\_col” parameter](#idp5525520)

1.5. [Set “pid\_col” parameter](#idp5530816)

1.6. [Set “prefix\_col” parameter](#idp5535744)

1.7. [Set “start\_h” parameter](#idp5541536)

1.8. [Set “end\_h” parameter](#idp5547408)

1.9. [Set “days\_col” parameter](#idp5553056)

1.10. [Set “cpm\_thresh\_warn\_col” parameter](#idp5558064)

1.11. [Set “cpm\_thresh\_crit\_col” parameter](#idp5563088)

1.12. [Set “calldur\_thresh\_warn\_col” parameter](#idp5568112)

1.13. [Set “calldur\_thresh\_crit\_col” parameter](#idp5573136)

1.14. [Set “totalc\_thresh\_warn\_col” parameter](#idp5578176)

1.15. [Set “totalc\_thresh\_crit\_col” parameter](#idp5583216)

1.16. [Set “concalls\_thresh\_warn\_col” parameter](#idp5588256)

1.17. [Set “concalls\_thresh\_crit\_col” parameter](#idp5593312)

1.18. [Set “seqcalls\_thresh\_warn\_col” parameter](#idp5598368)

1.19. [Set “seqcalls\_thresh\_crit\_col” parameter](#idp5603424)
