...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5886864)

2.2. [Most recently active contributors(1) to this module](#idp5991136)

**List of Examples**

1.1. [Set `default_allow_file` parameter](#idp5536480)

1.2. [Set `default_deny_file` parameter](#idp5541520)

1.3. [Set `check_all_branches` parameter](#idp5547088)

1.4. [Set `allow_suffix` parameter](#idp5554144)

1.5. [Set `deny_suffix` parameter](#idp5561184)

1.6. [Set `db_url` parameter](#idp5568400)

1.7. [Set `address_table` parameter](#idp5574448)

1.8. [Set `partition` parameter](#idp5581040)

1.9. [Set `grp_col` parameter](#idp5586320)

1.10. [Set `ip_col` parameter](#idp5591136)

1.11. [Set `mask_col` parameter](#idp5596144)

1.12. [Set `port_col` parameter](#idp5601136)

1.13. [Set `proto_col` parameter](#idp5609232)

1.14. [Set `pattern_col` parameter](#idp5615568)

1.15. [Set `info_col` parameter](#idp5621840)

1.16. [`check_address()` usage](#idp5637104)

1.17. [`check_source_address()` usage](#idp5643408)

1.18. [`get_source_group()` usage](#idp5651600)

1.19. [`allow_routing` usage](#idp5657840)

1.20. [`allow_routing(basename)` usage](#idp5666400)

1.21. [`allow_register(basename)` usage](#idp5675040)

1.22. [`allow_uri(basename, uri)` usage](#idp5684784)
...
**All remaining contributors**: Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)), Andrei Pelinescu-Onciul, Dan Pascu ([@danpascu](https://github.com/danpascu)), Miklos Tirpak, Ancuta Onofrei, Sa�l Ibarra Corretg� ([@saghul](https://github.com/saghul)), Jiri Kuthan ([@jiriatipteldotorg](https://github.com/jiriatipteldotorg)), Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Elena-Ramona Modroiu, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), Anca Vamanu, wuhanck, Konstantin Bokarius, Norman Brandinger ([@NormB](https://github.com/NormB)), UnixDev, Andreas Granig, Baptiste Cholley, Juli�n Moreno Pati�o, Edson Gellert Schubert.
