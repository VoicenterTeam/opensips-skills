...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp4746240)

2.2. [Most recently active contributors(1) to this module](#idp5754560)

**List of Examples**

1.1. [Set `default_filter` module parameter](#idp1913552)

1.2. [Set `deny_filter` module parameter](#idp4641824)

1.3. [Set `accept_filter` module parameter](#idp5123200)

1.4. [`set_deny_filter` usage](#idp3068560)

1.5. [`set_accept_filter` usage](#idp4043840)

1.6. [`get_redirects` usage](#idp5051664)

1.7. [Redirection script example](#idp5198320)
