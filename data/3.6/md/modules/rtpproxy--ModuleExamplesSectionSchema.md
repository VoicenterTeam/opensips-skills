...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp31199696)

3.2. [Most recently active contributors(1) to this module](#idp31325040)

**List of Examples**

1.1. [Set `rtpproxy_sock` parameter](#idp30695504)

1.2. [Set `rtpproxy_disable_tout` parameter](#idp30701824)

1.3. [Set `rtpproxy_timeout` parameter to 200ms](#idp30706640)

1.4. [Enable auto-bridging feature](#idp30711568)

1.5. [Set `rtpproxy_retr` parameter](#idp30716112)

1.6. [Set `default_set` parameter](#idp30721504)

1.7. [Set `nortpproxy_str` parameter](#idp30727520)

1.8. [Set `db_url` parameter](#idp30732800)

1.9. [Set `db_table` parameter](#idp30737856)

1.10. [Set `rtpp_socket_col` parameter](#idp30742832)

1.11. [Set `set_id` parameter](#idp30747728)

1.12. [Set `rtpp_notify_socket` parameter](#idp30752768)

1.13. [Set `generated_sdp_port_min` parameter](#idp30757968)

1.14. [Set `generated_sdp_port_max` parameter](#idp30762992)

1.15. [Set `generated_sdp_media_ip` parameter](#idp30768768)

1.16. [`rtpproxy_engage` usage](#idp30803824)

1.17. [`rtpproxy_offer` usage](#idp30812432)

1.18. [`rtpproxy_answer` usage](#idp30820672)

1.19. [`rtpproxy_unforce` usage](#idp30827888)

1.20. [`rtpproxy_stream2xxx` usage](#idp30843888)

1.21. [`rtpproxy_start_recording` usage](#idp30863232)

1.22. [`rtpproxy_stats` usage](#idp30875712)

1.23. [`rtpproxy_all_stats` usage](#idp30897648)

1.24. [`rtpproxy_enable` usage](#idp30907344)

1.25. [`rtpproxy_show` usage](#idp30912128)

1.26. [`rtpproxy_reload` usage](#idp30916768)
...
*   _enable_ - 1 - enable, 0 - disable the RTPproxy node, 2 - put the RTPproxy node in probing mode.
...
**All remaining contributors**: robdyck, Dave Sidwell ([@davesidwell](https://github.com/davesidwell)), Ezequiel Lovelle ([@lovelle](https://github.com/lovelle)), Christophe Sollet ([@csollet](https://github.com/csollet)), Anca Vamanu, Mikko Lehto, Dan Pascu ([@danpascu](https://github.com/danpascu)), Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), Juli�n Moreno Pati�o, Norman Brandinger ([@NormB](https://github.com/NormB)), Zero King ([@l2dy](https://github.com/l2dy)).
