...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6546704)

2.2. [Most recently active contributors(1) to this module](#idp6645824)

**List of Examples**

1.1. [Setting the _mode_ module parameter](#idp5633056)

1.2. [Setting the _contact\_id\_insertion_ module parameter](#idp5641168)

1.3. [Setting the _contact\_id\_param_ module parameter](#idp5646784)

1.4. [Setting the _at\_escape\_str_ module parameter](#idp5653712)

1.5. [Setting the _outgoing\_expires_ module parameter](#idp5658784)

1.6. [Setting the _received\_avp_ module parameter](#idp5664976)

1.7. [Setting the _received\_param_ module parameter](#idp5670768)

1.8. [Setting the _extra\_contact\_params\_avp_ module parameter](#idp5676704)

1.9. [Set `attr_avp` parameter](#idp5684080)

1.10. [Setting the _min\_expires_ module parameter](#idp5689360)

1.11. [Setting the _default\_expires_ module parameter](#idp5694240)

1.12. [Setting the _max\_expires_ module parameter](#idp5699088)

1.13. [Setting the _default\_q_ module parameter](#idp5705360)

1.14. [Setting the _tcp\_persistent\_flag_ module parameter](#idp5711056)

1.15. [Setting the _realm\_prefix_ module parameter](#idp5718496)

1.16. [Setting the _case\_sensitive_ module parameter](#idp5724032)

1.17. [Setting the `expires_max_deviation` parameter](#idp5773568)

1.18. [Set `max_contacts` parameter](#idp5779152)

1.19. [Setting the _max\_username\_len_ module parameter](#idp5784384)

1.20. [Setting the _max\_domain\_len_ module parameter](#idp5789536)

1.21. [Setting the _max\_aor\_len_ module parameter](#idp5794672)

1.22. [Setting the _max\_contact\_len_ module parameter](#idp5799808)

1.23. [Setting the _retry\_after_ module parameter](#idp5802480)

1.24. [Setting the _gruu\_secret_ module parameter](#idp5807152)

1.25. [Setting the _gruu\_secret_ module parameter](#idp5811920)

1.26. [Setting the `pn_enable` parameter](#idp5862352)

1.27. [Setting the `pn_providers` parameter](#idp5868000)

1.28. [Setting the `pn_ct_match_params` parameter](#idp5876048)

1.29. [Setting the `pn_pnsreg_interval` parameter](#idp5882192)

1.30. [Setting the `pn_trigger_interval` parameter](#idp5890608)

1.31. [Setting the `pn_skip_pn_interval` parameter](#idp5896272)

1.32. [Setting the `pn_refresh_timeout` parameter](#idp5905376)

1.33. [Setting the `pn_enable_purr` parameter](#idp5913584)

1.34. [`_mid_registrar_save_` usage](#idp6002000)

1.35. [`_mid_registrar_lookup_` usage](#idp6116896)

1.36. [`async pn_process_purr()` usage](#idp6174736)
...
**All remaining contributors**: Italo Rossi ([@italorossi](https://github.com/italorossi)).
...
**All remaining contributors**: Chad Attermann ([@attermann](https://github.com/attermann)).
