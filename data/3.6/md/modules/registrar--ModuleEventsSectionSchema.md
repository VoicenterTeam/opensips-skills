...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6608640)

3.2. [Most recently active contributors(1) to this module](#idp6714256)

**List of Examples**

1.1. [Set `default_expires` parameter](#idp5591888)

1.2. [Set `min_expires` parameter](#idp5596464)

1.3. [Set `max_expires` parameter](#idp5601072)

1.4. [Set `default_q` parameter](#idp5605776)

1.5. [Set `tcp_persistent_flag` parameter](#idp5611008)

1.6. [Set `realm_prefix` parameter](#idp5615856)

1.7. [Set `case_sensitive` parameter](#idp5621056)

1.8. [Set `received_avp` parameter](#idp5626720)

1.9. [Set `received_param` parameter](#idp5631376)

1.10. [Setting the `allow_dup_cseq` parameter](#idp5637952)

1.11. [Setting the `expires_max_deviation` parameter](#idp5687088)

1.12. [Set `max_contacts` parameter](#idp5692784)

1.13. [Setting the _max\_username\_len_ module parameter](#idp5698016)

1.14. [Setting the _max\_domain\_len_ module parameter](#idp5703168)

1.15. [Setting the _max\_aor\_len_ module parameter](#idp5708304)

1.16. [Setting the _max\_contact\_len_ module parameter](#idp5713440)

1.17. [Set `retry_after` parameter](#idp5721712)

1.18. [Set `sock_hdr_namer` parameter](#idp5726832)

1.19. [Set `mcontact_avp` parameter](#idp5732176)

1.20. [Set `attr_avp` parameter](#idp5738320)

1.21. [Set `gruu_secret` parameter](#idp5744112)

1.22. [Set `gruu_secret` parameter](#idp5748624)

1.23. [Setting the `pn_enable` parameter](#idp5799168)

1.24. [Setting the `pn_providers` parameter](#idp5804816)

1.25. [Setting the `pn_ct_match_params` parameter](#idp5812864)

1.26. [Setting the `pn_pnsreg_interval` parameter](#idp5819008)

1.27. [Setting the `pn_trigger_interval` parameter](#idp5827328)

1.28. [Setting the `pn_skip_pn_interval` parameter](#idp5832992)

1.29. [Setting the `pn_refresh_timeout` parameter](#idp5842096)

1.30. [Setting the `pn_enable_purr` parameter](#idp5850304)

1.31. [`save` usage](#idp5924736)

1.32. [`remove` usage](#idp5962704)

1.33. [`remove_ip_port` usage](#idp5974304)

1.34. [`lookup` usage](#idp6056336)

1.35. [`is_registered` usage](#idp6066128)

1.36. [`is_contact_registered` usage](#idp6077376)

1.37. [`is_ip_registered` usage](#idp6089632)

1.38. [`add_sock_hdr` usage](#idp6097328)

1.39. [`async pn_process_purr()` usage](#idp6154912)
...
_Default value is _true_ (duplicate CSeq is accepted)._
...
AVP to store specific additional information for each registration. This information is read from the AVP and stored (in memory, db or both) at every registrar 'save()'. When a registrar 'lookup()' or 'is\_registered()' function is called, the stored information is pushed into a message branch attribute with the same name as _attr\_avp_ (see $msg.branch.attr() core variable)
