...
1.1. [mc\_compress performance test results](#idp3799152)

2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5790320)

2.2. [Most recently active contributors(1) to this module](#idp5888960)

**List of Examples**

1.1. [Set `mc_level` parameter](#idp2221504)

1.2. [`mc_compress` usage](#idp5292864)

1.3. [`mc_compress` usage](#idp4166880)

1.4. [`mc_compress` usage](#idp4664400)

1.5. [`mc_decompress` usage](#idp4364864)
