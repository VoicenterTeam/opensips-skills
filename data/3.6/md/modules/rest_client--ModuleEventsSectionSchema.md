...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5945488)

2.2. [Most recently active contributors(1) to this module](#idp6047776)

**List of Examples**

1.1. [Setting the `curl_timeout` parameter](#idp160720)

1.2. [Setting the `connection_timeout` parameter](#idp5568112)

1.3. [Setting the `connect_poll_interval` parameter](#idp5573744)

1.4. [Setting the `max_async_transfers` parameter](#idp5579184)

1.5. [Setting the `max_transfer_size` parameter](#idp5584848)

1.6. [Setting the `ssl_verifypeer` parameter](#idp5589856)

1.7. [Setting the `ssl_verifyhost` parameter](#idp5594832)

1.8. [Setting the `ssl_capath` parameter](#idp5598592)

1.9. [Setting the `curl_http_version` parameter](#idp5610240)

1.10. [Setting the `enable_expect_100` parameter](#idp5615424)

1.11. [Setting the `no_concurrent_connects` parameter](#idp5622912)

1.12. [Setting the `curl_conn_lifetime` parameter](#idp162272)

1.13. [`rest_get` usage](#idp5666304)

1.14. [`rest_post` usage](#idp5694272)

1.15. [`rest_put` usage](#idp5729840)

1.16. [`rest_append_hf` usage](#idp5738992)

1.17. [`rest_init_client_tls` usage](#idp5746224)

1.18. [`async rest_get` usage](#idp5752416)

1.19. [`async rest_post` usage](#idp5759072)

1.20. [`async rest_put` usage](#idp5765808)

1.21. [`rest.escape` usage](#idp5773952)

1.22. [`rest.unescape` usage](#idp5779024)
