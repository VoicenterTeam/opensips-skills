...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5594576)

2.2. [Most recently active contributors(1) to this module](#idp5694336)

**List of Examples**

1.1. [Set `db_url` parameter](#idp249584)

1.2. [Set `rooms_table` parameter](#idp166432)

1.3. [Set `members_table` parameter](#idp171424)

1.4. [Set `hash_size` parameter](#idp5516864)

1.5. [Set `imc_cmd_start_char` parameter](#idp5521296)

1.6. [Set `outbound_proxy` parameter](#idp5526016)

1.7. [Usage of `imc_manager()` function](#idp5531872)

1.8. [List of commands](#idp5550016)
