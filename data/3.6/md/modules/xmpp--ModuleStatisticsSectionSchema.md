...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5658016)

2.2. [Most recently active contributors(1) to this module](#idp5759136)

**List of Examples**

1.1. [Set `backend` parameter](#idp3728752)

1.2. [Set `xmpp_domain` parameter](#idp3254208)

1.3. [Set `xmpp_host` parameter](#idp4384032)

1.4. [Set `xmpp_host` parameter](#idp2279264)

1.5. [Set `xmpp_port` parameter](#idp4142400)

1.6. [Set `xmpp_password` parameter](#idp3171984)

1.7. [Set `outbound_proxy` parameter](#idp3962128)

1.8. [`xmpp_send_message()` usage](#idp3884064)
