...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5670784)

3.2. [Most recently active contributors(1) to this module](#idp5778672)

**List of Examples**

1.1. [Set `ip` parameter](#idp166912)

1.2. [Set `port` parameter](#idp171792)

1.3. [Set `conn_timeout` parameter](#idp5569344)

1.4. [Set `buf_size` parameter](#idp5574416)

1.5. [Set `post_buf_size` parameter](#idp5579024)

1.6. [Set `receive_buf_size` parameter](#idp5583632)

1.7. [Set `tls_cert_file` parameter](#idp5588192)

1.8. [Set `tls_key_file` parameter](#idp5592832)

1.9. [Set `tls_key_file` parameter](#idp5599376)
...
_The default timeout is 30 seconds._
