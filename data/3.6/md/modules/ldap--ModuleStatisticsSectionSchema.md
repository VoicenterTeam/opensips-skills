...
1.1. [RFC 4515 Escaping Rules](#idp5586528)

1.2. [ldap\_filter\_url\_encode() escaping rules](#idp5750624)

3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6305552)

3.2. [Most recently active contributors(1) to this module](#idp6433952)

**List of Examples**

1.1. [`ldap_server_url` examples](#idp5614144)

1.2. [`ldap_version` example](#idp5618304)

1.3. [`ldap_bind_dn` example](#idp5622448)

1.4. [`ldap_bind_password` example](#idp5626544)

1.5. [`ldap_network_timeout` example](#idp5630624)

1.6. [`ldap_client_bind_timeout` example](#idp5634272)

1.7. [`ldap_ca_cert_file` example](#idp5637920)

1.8. [`ldap_cert_file` example](#idp5641568)

1.9. [`ldap_key_file` example](#idp5645216)

1.10. [`ldap_require_certificate` example](#idp5648928)

1.11. [Example LDAP Configuration File](#idp5652304)

1.12. [`config_file` parameter usage](#idp5657952)

1.13. [`max_async_connections` parameter usage](#idp5662288)

1.14. [Example Usage of ldap\_url](#idp5671968)

1.15. [Example Usage](#idp5688832)

1.16. [Example Usage](#idp5715264)

1.17. [Example Usage](#idp5736304)

1.18. [Example Usage](#idp5746688)

1.19. [Example Usage](#idp5775024)

1.20. [Example Usage of ldap\_url](#idp5784320)

1.21. [Example Usage](#idp5801264)

2.1. [Example code fragment to load LDAP module API](#idp6032928)

2.2. [Example LDAP module API function call](#idp6078480)
...
**All remaining contributors**: tcresson, Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), Petr P�sař, Henning Westerholt ([@henningw](https://github.com/henningw)), Konstantin Bokarius, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Zero King ([@l2dy](https://github.com/l2dy)), Edson Gellert Schubert, Alexandra Titoc.
