...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6068464)

3.2. [Most recently active contributors(1) to this module](#idp6173040)

**List of Examples**

1.1. [Set `db_url` parameter](#idp5520464)

1.2. [Set `fallback2db` parameter](#idp5524560)

1.3. [Set `cluster_id` parameter](#idp5537712)

1.4. [Set `cluster_federation_mode` parameter](#idp5550976)

1.5. [Set `cluster_pres_events` parameter](#idp5557472)

1.6. [Set `cluster_be_active_shtag` parameter](#idp5565360)

1.7. [Set `expires_offset` parameter](#idp5570576)

1.8. [Set `max_expires_subscribe` parameter](#idp5577136)

1.9. [Set `max_expires_publish` parameter](#idp5581952)

1.10. [Set `contact_user` parameter](#idp310384)

1.11. [Set `enable_sphere_check` parameter](#idp315984)

1.12. [Set `waiting_subs_daysno` parameter](#idp5606688)

1.13. [Set `mix_dialog_presence` parameter](#idp5611920)

1.14. [Set `bla_presentity_spec` parameter](#idp5617792)

1.15. [Set `bla_fix_remote_target` parameter](#idp5623536)

1.16. [Set `notify_offline_body` parameter](#idp5628672)

1.17. [Set `end_sub_on_timeout` parameter](#idp5633728)

1.18. [Set `clean_period` parameter](#idp5638784)

1.19. [Set `db_update_period` parameter](#idp5643776)

1.20. [Set `presentity_table` parameter](#idp5648672)

1.21. [Set `active_watchers_table` parameter](#idp5653664)

1.22. [Set `watchers_table` parameter](#idp5658656)

1.23. [Set `subs_htable_size` parameter](#idp5663712)

1.24. [Set `pres_htable_size` parameter](#idp5668672)

1.25. [`handle_publish` usage](#idp5679344)

1.26. [`handle_subscribe` usage](#idp5693984)

2.1. [`presence_api_t` structure](#idp5949872)
...
**All remaining contributors**: Sa�l Ibarra Corretg� ([@saghul](https://github.com/saghul)), Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)), Juha Heinanen ([@juha-h](https://github.com/juha-h)), Edson Gellert Schubert, Alexandra Titoc, Stanislaw Pitucha, Damien Sandras ([@dsandras](https://github.com/dsandras)), Kobi Eshun ([@ekobi](https://github.com/ekobi)), Carsten Bock, Norman Brandinger ([@NormB](https://github.com/NormB)), Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), Angel Marin, Klaus Darilion, Carlos Oliva, Sergio Gutierrez, Kennard White, Elena-Ramona Modroiu, Jasper Hafkenscheid, Vasil Kolev, Benny Prijono, James Criscuolo, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Vallimamod Abdullah, UnixDev, Denis Bilenko, Juli�n Moreno Pati�o, John Riordan, Julien Blache.
