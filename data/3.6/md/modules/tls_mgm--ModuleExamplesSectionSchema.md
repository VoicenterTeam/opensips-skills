...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6160960)

3.2. [Most recently active contributors(1) to this module](#idp6263200)

**List of Examples**

1.1. [`is_peer_verified` usage](#idp5535840)

1.2. [Set `listen` variable](#idp5547296)

1.3. [Set `tls_library` variable](#idp5560512)

1.4. [Set `tls_method` variable](#idp5572288)

1.5. [Set `tls_method` range variable](#idp5574624)

1.6. [Set `certificate` variable](#idp5579376)

1.7. [Set `private_key` variable](#idp5583840)

1.8. [Set `ca_list` variable](#idp5588320)

1.9. [Set `ca_dir` variable](#idp5594144)

1.10. [Set `crl_dir` variable](#idp5598624)

1.11. [Set `crl_check_all` variable](#idp5603104)

1.12. [Set `ciphers_list` variable](#idp5609376)

1.13. [Set `dh_params` variable](#idp5613888)

1.14. [Set `verify_cert` variable](#idp5623008)

1.15. [Set `require_cert` variable](#idp5629008)

1.16. [Set `client_tls_domain_avp` variable](#idp5635792)

1.17. [Set `client_sip_domain_avp` variable](#idp5643344)

1.18. [Usage of `db_url` block](#idp5647984)

1.19. [Usage of `db_table` block](#idp5651872)

1.20. [Usage of `domain_col` block](#idp5655760)

1.21. [Usage of `match_ip_address_col` block](#idp5659648)

1.22. [Usage of `match_sip_domain_col` block](#idp5663536)

1.23. [Usage of `tls_method_col` block](#idp5667424)

1.24. [Usage of `vertify_cert_col` block](#idp5671312)

1.25. [Usage of `require_cert_col` block](#idp5675200)

1.26. [Usage of `certificate_col` block](#idp5679088)

1.27. [Usage of `private_key_col` block](#idp5682976)

1.28. [Usage of `crl_check_all` block](#idp5686864)

1.29. [Usage of `crl_dir_col` block](#idp5690752)

1.30. [Usage of `ca_list_col` block](#idp5694640)

1.31. [Usage of `ca_dir_col` block](#idp5698528)

1.32. [Usage of `cipher_list_col` block](#idp5702416)

1.33. [Usage of `dh_params_col` block](#idp5706320)

1.34. [Usage of `ec_curve_col` block](#idp5710208)

1.35. [Set `match_ip_address` variable](#idp5715328)

1.36. [Set `match_sip_domain` variable](#idp5723840)

1.37. [Usage of `tls_client_domain` and `tls_server_domain` block](#idp5728032)

1.38. [Example of `$tls_[peer|my]_[subject|issuer]`](#idp5751376)

1.39. [Script with TLS support](#idp5784048)

1.40. [Example of TLS logging](#idp5798320)
