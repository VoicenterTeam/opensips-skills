...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5636832)

3.2. [Most recently active contributors(1) to this module](#idp5743152)

**List of Examples**

1.1. [Setting db\_url parameter](#idp3460256)

1.2. [db\_mode example](#idp1823424)

1.3. [Setting domain\_table parameter](#idp101712)

1.4. [Setting domain\_col parameter](#idp105520)

1.5. [Setting attrs\_col parameter](#idp183376)

1.6. [Setting subdomain\_col parameter](#idp187360)

1.7. [is\_from\_local usage](#idp5571952)

1.8. [is\_uri\_host\_local usage](#idp5576384)

1.9. [is\_domain\_local usage](#idp5585104)
...
Default value is “accept\_subdomain”.

**Example�1.6.�Setting subdomain\_col parameter**
...
**Example�1.7.�is\_from\_local usage**
...
**Example�1.8.�is\_uri\_host\_local usage**
...
**Example�1.9.�is\_domain\_local usage**
...
**All remaining contributors**: Edson Gellert Schubert, David Trihy, Elena-Ramona Modroiu, Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Jiri Kuthan ([@jiriatipteldotorg](https://github.com/jiriatipteldotorg)), [@coxx](https://github.com/coxx), Konstantin Bokarius, Klaus Darilion, Anca Vamanu, Norman Brandinger ([@NormB](https://github.com/NormB)), Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Stefan Darius, UnixDev, Andreas Granig, John Burke ([@john08burke](https://github.com/john08burke)).
