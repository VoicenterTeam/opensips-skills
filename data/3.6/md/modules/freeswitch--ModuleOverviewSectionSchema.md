...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp4401712)

2.2. [Most recently active contributors(1) to this module](#idp5598864)

**List of Examples**

1.1. [Setting the `event_heartbeat_interval` parameter](#idp246128)

1.2. [Setting the `esl_connect_timeout` parameter](#idp163152)

1.3. [Setting the `esl_cmd_timeout` parameter](#idp168496)

1.4. [Setting the `esl_cmd_polling_itv` parameter](#idp5515120)
