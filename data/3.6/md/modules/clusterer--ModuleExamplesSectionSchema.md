...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6380784)

3.2. [Most recently active contributors(1) to this module](#idp6479952)

**List of Examples**

1.1. [Set `my_node_id` parameter](#idp5516144)

1.2. [Set `db_mode` parameter](#idp5523072)

1.3. [Set `db_url` parameter](#idp5527760)

1.4. [Set `db_table` parameter](#idp5532656)

1.5. [Set `sharing_tag` parameter](#idp5538592)

1.6. [Set `my_node_info` parameter](#idp5545952)

1.7. [Set `neighbor_node_info` parameter](#idp5553904)

1.8. [Set `ping_interval` parameter](#idp5558816)

1.9. [Set `ping_timeout` parameter](#idp5563744)

1.10. [Set `node_timeout` parameter](#idp5568528)

1.11. [Set `seed_fallback_interval` parameter](#idp5573472)

1.12. [Set `sync_timeout` parameter](#idp5578400)

1.13. [Set `sync_packet_size` parameter](#idp5583296)

1.14. [Set `dispatch_jobs` parameter](#idp5589408)

1.15. [Set `id_col` parameter](#idp5594192)

1.16. [Set `cluster_id_col` parameter](#idp5598976)

1.17. [Set `node_id_col` parameter](#idp5603792)

1.18. [Set `url_col` parameter](#idp5608608)

1.19. [Set `state_col` parameter](#idp5613408)

1.20. [Set `no_ping_retries_col` parameter](#idp5618272)

1.21. [Set `priority_col` parameter](#idp5623248)

1.22. [Set `sip_addr_col` parameter](#idp5628128)

1.23. [Set `flags_col` parameter](#idp5632992)

1.24. [Set `description_col` parameter](#idp5637776)

1.25. [Set `enable_stats` parameter](#idp5642896)

1.26. [Set `enable_rerouting` parameter](#idp5647952)

1.27. [cluster\_send\_req() usage](#idp5665088)

1.28. [cluster\_send\_rpl() usage](#idp5680224)

1.29. [cluster\_broadcast\_req() usage](#idp5693328)

1.30. [cluster\_check\_addr() usage](#idp5704080)

1.31. [`clusterer_list` usage](#idp5715600)

1.32. [`clusterer_list_topology` usage](#idp5722448)

1.33. [`clusterer_list_cap` usage](#idp5771648)

1.34. [Example database content - clusterer table](#idp5855856)

1.35. [_Node A_ configuration](#idp5871904)

1.36. [_Node B_ configuration](#idp5874560)
...
...
modparam("clusterer", "enable\_rerouting", 0)
...
...
**Example�1.27.�cluster\_send\_req() usage**
...
**Example�1.28.�cluster\_send\_rpl() usage**
...
*   _include\_self_ (bool, optional, default: _false_) - raise the event for current node as well, but without actually sending a packet (both req and rpl).
...
**Example�1.29.�cluster\_broadcast\_req() usage**

...
# also raise the event for current node
cluster\_broadcast\_req($var(cl\_id), $var(share\_data), , true);
...
...
**Example�1.30.�cluster\_check\_addr() usage**
...
**All remaining contributors**: Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Gohar Ahmed ([@goharahmed](https://github.com/goharahmed)), kworm83, Shanee Vanstone.
...
**All remaining contributors**: Fabian Gast ([@fgast](https://github.com/fgast)), Gohar Ahmed ([@goharahmed](https://github.com/goharahmed)), Ionel Cerghit ([@ionel-cerghit](https://github.com/ionel-cerghit)), Eseanu Marius Cristian ([@eseanucristian](https://github.com/eseanucristian)).
