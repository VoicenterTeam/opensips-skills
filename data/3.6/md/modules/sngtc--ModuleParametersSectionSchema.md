...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5548960)

2.2. [Most recently active contributors(1) to this module](#idp5630160)

**List of Examples**

1.1. [`sngtc_offer` usage](#idp169648)

1.2. [`sngtc_callee_answer` usage](#idp5523024)

1.3. [`sngtc_caller_answer` usage](#idp5530208)
