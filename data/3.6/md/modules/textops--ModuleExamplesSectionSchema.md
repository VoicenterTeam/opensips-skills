...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5671808)

2.2. [Most recently active contributors(1) to this module](#idp5775856)

**List of Examples**

1.1. [`search` usage](#idp246832)

1.2. [`search_body` usage](#idp165280)

1.3. [`search_append` usage](#idp173120)

1.4. [`search_append_body` usage](#idp5519920)

1.5. [`replace` usage](#idp5527376)

1.6. [`replace_body` usage](#idp5534832)

1.7. [`replace_all` usage](#idp5542288)

1.8. [`replace_body_all` usage](#idp5549872)

1.9. [`replace_body_atonce` usage](#idp5557456)

1.10. [`subst` usage](#idp5565648)

1.11. [`subst_uri` usage](#idp5573856)

1.12. [`subst` usage](#idp5582592)

1.13. [`subst_body` usage](#idp5590768)
