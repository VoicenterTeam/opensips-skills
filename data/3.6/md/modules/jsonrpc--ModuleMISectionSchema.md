...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5617680)

2.2. [Most recently active contributors(1) to this module](#idp5700288)

**List of Examples**

1.1. [Set `connect_timeout` parameter](#idp214384)

1.2. [Set `write_timeout` parameter](#idp281008)

1.3. [Set `read_timeout` parameter](#idp165984)

1.4. [`jsonrpc_request()` function usage](#idp5577824)

1.5. [`jsonrpc_notification()` function usage](#idp5597248)
