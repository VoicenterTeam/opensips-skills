...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5808032)

2.2. [Most recently active contributors(1) to this module](#idp5889232)

**List of Examples**

1.1. [Setting the `db_url` parameter](#idp171760)

1.2. [Setting the `table_name` parameter](#idp177360)

1.3. [Setting the `algorithm` parameter](#idp5524560)

1.4. [Setting the `connection_timeout` parameter](#idp5529808)

1.5. [Setting the `connect_poll_interval` parameter](#idp5548576)

1.6. [Setting the `extra_stats` parameter](#idp5563328)

1.7. [Setting the `min_samples_asr` parameter](#idp5568752)

1.8. [Setting the `min_samples_ccr` parameter](#idp5574080)

1.9. [Setting the `min_samples_pdd` parameter](#idp5579408)

1.10. [Setting the `min_samples_ast` parameter](#idp5584736)

1.11. [Setting the `min_samples_acd` parameter](#idp5590064)

1.12. [Setting the `event_bad_dst_threshold` parameter](#idp5595872)

1.13. [Setting the `decimal_digits` parameter](#idp5601088)

1.14. [`qr_set_xstat()` usage](#idp5614656)

1.15. [`qr_disable_dst()` usage](#idp5624000)

1.16. [`qr_enable_dst()` usage](#idp5632320)
