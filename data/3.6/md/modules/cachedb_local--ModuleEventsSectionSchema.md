...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5642192)

3.2. [Most recently active contributors(1) to this module](#idp5744192)

**List of Examples**

1.1. [Set `cachedb_url` parameter](#idp5518160)

1.2. [Set `cache_collections` parameter](#idp5524640)

1.3. [Set `cache_clean_period` parameter](#idp5530064)

1.4. [Setting the `cluster_id` parameter](#idp5540608)

1.5. [Set `cluster_persistency` parameter](#idp5549392)

1.6. [Set `enable_restart_persistency` parameter](#idp5555936)

1.7. [`cache_remove_chunk` usage](#idp5565984)
...
**All remaining contributors**: Juli�n Moreno Pati�o, Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), Ryan Bullock ([@rrb3942](https://github.com/rrb3942)), Andrei Dragus, Anca Vamanu.
