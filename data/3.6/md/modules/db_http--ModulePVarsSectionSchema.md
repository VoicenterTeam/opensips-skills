...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5754800)

2.2. [Most recently active contributors(1) to this module](#idp5854624)

**List of Examples**

1.1. [Setting db\_url for a module](#idp1182208)

1.2. [Set `SSL` parameter](#idp258640)

1.3. [Set `cap_raw_query` parameter](#idp161504)

1.4. [Set `cap_replace` parameter](#idp166720)

1.5. [Set `cap_insert_update` parameter](#idp171968)

1.6. [Set `cap_last_inserted_id` parameter](#idp5576800)

1.7. [Set `field_delimiter` parameter](#idp5581616)

1.8. [Set `row_delimiter` parameter](#idp5586528)

1.9. [Set `quote_delimiter` parameter](#idp5591472)

1.10. [Set `value_delimiter` parameter](#idp5609184)

1.11. [Set `timeout` parameter](#idp5614096)

1.12. [Set `disable_expect` parameter](#idp5619184)

1.13. [Example query.](#idp5625264)

1.14. [Example query with variables.](#idp5640768)

1.15. [More query examples.](#idp5653424)

1.16. [NULL query example.](#idp5656416)

1.17. [Example Reply.](#idp5661984)

1.18. [Quoting Example.](#idp5665888)
...
**All remaining contributors**: Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)), Anca Vamanu, Ezequiel Lovelle ([@lovelle](https://github.com/lovelle)), Ken Rice, Stephane Alnet.
...
**All remaining contributors**: Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), Ezequiel Lovelle ([@lovelle](https://github.com/lovelle)), Stephane Alnet, Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)), Anca Vamanu, Andrei Dragus.
