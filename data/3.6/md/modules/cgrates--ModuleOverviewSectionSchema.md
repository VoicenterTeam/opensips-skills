...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5867504)

2.2. [Most recently active contributors(1) to this module](#idp5963296)

**List of Examples**

1.1. [Set `cgrates_engine` parameter](#idp5572272)

1.2. [Set `bind_ip` parameter](#idp5577488)

1.3. [Set `max_async_connections` parameter](#idp5582416)

1.4. [Set `retry_timeout` parameter](#idp5587328)

1.5. [Set `compat_mode` parameter](#idp5592256)

1.6. [cgrates\_acc() usage](#idp5629424)

1.7. [cgrates\_auth() usage](#idp5646496)

1.8. [cgrates\_auth() usage with attributes parsing](#idp5648048)

1.9. [cgrates\_cmd() usage](#idp5662032)

1.10. [$cgr(name) simple usage](#idp5671072)

1.11. [$cgr(name) multiple sessions usage](#idp5672800)

1.12. [$cgr\_opt(name) usage](#idp5684048)

1.13. [$cgr\_ret(name) usage](#idp5687552)

1.14. [`async cgrates_auth` usage](#idp5704416)

1.15. [`async cgrates_cmd compat_mode` usage](#idp5718032)

1.16. [`async cgrates_cmd new` usage](#idp5720464)
