...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6738656)

3.2. [Most recently active contributors(1) to this module](#idp6804496)

**List of Examples**

1.1. [Set `db_url` parameter](#idp5627120)

1.2. [Set `drd_table` parameter](#idp5632048)

1.3. [Set `drr_table` parameter](#idp5636944)

1.4. [Set `drg_table` parameter](#idp5641760)

1.5. [Set `drc_table` parameter](#idp5646704)

1.6. [Set `ruri_avp` parameter](#idp5653008)

1.7. [Set `gw_id_avp` parameter](#idp5659488)

1.8. [Set `gw_priprefix_avp` parameter](#idp5664688)

1.9. [Set `rule_id_avp` parameter](#idp5669728)

1.10. [Set `rule_prefix_avp` parameter](#idp5674800)

1.11. [Set `carrier_id_avp` parameter](#idp5679808)

1.12. [Set `gw_sock_avp` parameter](#idp5686096)

1.13. [Set `define_blacklist` parameter](#idp5692144)

1.14. [Set `default_group` parameter](#idp5697328)

1.15. [Set `force_dns` parameter](#idp5702304)

1.16. [Set the `persistent_state` parameter](#idp5707600)

1.17. [Set `no_concurrent_reload` parameter](#idp5713408)

1.18. [Set `probing_interval` parameter](#idp5718512)

1.19. [Set `probing_method` parameter](#idp5723408)

1.20. [Set `probing_from` parameter](#idp5728384)

1.21. [Set `probing_reply_codes` parameter](#idp5733456)

1.22. [Set `probing_socket` parameter](#idp5739584)

1.23. [Set `gw_socket_filter_mode` parameter](#idp5750384)

1.24. [Set `cluster_id` parameter](#idp5777856)

1.25. [Set `cluster_sharing_tag` parameter](#idp5786064)

1.26. [Set `cluster_probing_mode` parameter](#idp257728)

1.27. [Set `use_domain` parameter](#idp263424)

1.28. [Set `drg_user_col` parameter](#idp5819488)

1.29. [Set `drg_domain_col` parameter](#idp5824400)

1.30. [Set `drg_grpid_col` parameter](#idp5829392)

1.31. [Set `use_partitions` parameter](#idp5835168)

1.32. [Set `db_partitions_url` parameter](#idp5840704)

1.33. [Set `db_partitions_table` parameter](#idp5846512)

1.34. [Set `partition_id_pvar` parameter](#idp5852640)

1.35. [Set `enable_restart_persistency` parameter](#idp5859136)

1.36. [Set `extra_prefix_chars` parameter](#idp5864192)

1.37. [Set `extra_id_chars` parameter](#idp5869248)

1.38. [Set the `rule_tables_query` parameter](#idp5876528)

1.39. [Set the `generate_data_checksum` parameter](#idp5880736)

1.40. [`do_routing` usage](#idp5905280)

1.41. [`route_to_carrier` usage](#idp5921312)

1.42. [`route_to_gw` usage](#idp5934656)

1.43. [`use_next_gw` usage](#idp5948864)

1.44. [`goes_to_gw` usage](#idp5972528)

1.45. [`is_from_gw` usage](#idp5997168)

1.46. [`dr_is_gw` usage](#idp6021904)

1.47. [`dr_disable()` usage](#idp6030432)

1.48. [`dr_match` usage](#idp6047088)

1.49. [`dr_gw_status` usage when `use_partitions` is set to 0](#idp6075568)

1.50. [`dr_gw_status` usage when `use_partitions`is set to 1](#idp6078096)

1.51. [`dr_carrier_status` usage when `use_partitions` is 0](#idp6091024)

1.52. [`dr_carrier_status` usage when `use_partitions` is 1](#idp6093504)

1.53. [`dr_reload_status` usage when `use_partitions` is 0](#idp6101824)

1.54. [`dr_reload_status` usage when `use_partitions` is 1](#idp6104176)

1.55. [`dr_enable_probing` usage](#idp6121440)
