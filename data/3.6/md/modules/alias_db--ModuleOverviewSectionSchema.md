...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5703936)

3.2. [Most recently active contributors(1) to this module](#idp5761488)

**List of Examples**

1.1. [Set `db_url` parameter](#idp259120)

1.2. [Set `user_column` parameter](#idp161504)

1.3. [Set `domain_column` parameter](#idp166672)

1.4. [Set `alias_user_column` parameter](#idp171872)

1.5. [Set `alias_domain_column` parameter](#idp5568688)

1.6. [Set `domain_prefix` parameter](#idp5573616)

1.7. [Set `append_branches` parameter](#idp5578560)

1.8. [`alias_db_lookup()` usage](#idp5591088)

1.9. [`alias_db_find()` usage](#idp5605680)
