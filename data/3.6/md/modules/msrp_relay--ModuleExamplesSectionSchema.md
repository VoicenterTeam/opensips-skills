...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5651952)

2.2. [Most recently active contributors(1) to this module](#idp5721920)

**List of Examples**

1.1. [Set `server_hsize` parameter](#idp261568)

1.2. [Set `cleanup_interval` parameter](#idp163584)

1.3. [Set `auth_route` parameter](#idp169232)

1.4. [`username_var` parameter usage](#idp174064)

1.5. [`realm_var` parameter usage](#idp5530352)

1.6. [`password_var` parameter usage](#idp5535360)

1.7. [`calculate_ha1` parameter usage](#idp5540128)

1.8. [Set `socket_route` parameter](#idp5552304)

1.9. [`auth_realm` parameter usage](#idp5563488)

1.10. [Set `server_hsize` parameter](#idp5568800)

1.11. [Set `auth_min_expires` parameter](#idp5573872)

1.12. [Set `auth_max_expires` parameter](#idp5579024)

1.13. [nonce\_expire parameter example](#idp5584128)

1.14. [`my_uri` parameter usage](#idp5589168)
