...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5574960)

2.2. [Most recently active contributors(1) to this module](#idp5655536)

**List of Examples**

1.1. [Set `connection_id` parameter](#idp5522736)

1.2. [Setting the `connect_timeout` parameter](#idp5528272)

1.3. [Setting the `retry_timeout` parameter](#idp5533232)

1.4. [Set the `use_tls` parameter](#idp5540240)
