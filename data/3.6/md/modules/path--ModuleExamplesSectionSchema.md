...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5593888)

2.2. [Most recently active contributors(1) to this module](#idp5692544)

**List of Examples**

1.1. [Set `use_received` parameter](#idp163872)

1.2. [Set `enable_double_path` parameter](#idp168992)

1.3. [`add_path(user)` usage](#idp5570560)

1.4. [`add_path_received(user)` usage](#idp5577840)
