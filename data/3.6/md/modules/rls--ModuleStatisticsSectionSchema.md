...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp3327616)

3.2. [Most recently active contributors(1) to this module](#idp1814560)

**List of Examples**

1.1. [Set `rlsubs_table` parameter](#idp4775264)

1.2. [Set `rlpres_table` parameter](#idp3949040)

1.3. [Set `clean_period` parameter](#idp3570000)

1.4. [Set `waitn_time` parameter](#idp3237008)

1.5. [Set `max_expires` parameter](#idp4157760)

1.6. [Set `hash_size` parameter](#idp4441584)

1.7. [Set `hash_size` parameter](#idp3169664)

1.8. [Set `to_presence_code` parameter](#idp5012144)

1.9. [Set `rls_event` parameter](#idp5004416)

1.10. [Set `presence_server` parameter](#idp3964592)

1.11. [Set `contact_user` parameter](#idp2644016)

1.12. [`rls_handle_subscribe` usage](#idp3289520)

1.13. [`rls_handle_notify` usage](#idp3837120)
...
**All remaining contributors**: Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Stanislaw Pitucha, Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)), Sergio Gutierrez, Konstantin Bokarius, UnixDev, John Riordan, Juli�n Moreno Pati�o, Ken Rice, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Edson Gellert Schubert.
