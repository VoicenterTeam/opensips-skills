...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5833744)

3.2. [Most recently active contributors(1) to this module](#idp5936352)

**List of Examples**

1.1. [Defining the `'pstn'` partition](#idp5554864)

1.2. [Define the 'pstn' partition and make it the 'default' partition, so we avoid loading the 'dialplan' table](#idp5556800)

1.3. [Set `db_url` parameter](#idp5561440)

1.4. [Set `table_name` parameter](#idp5566448)

1.5. [Set `dpid_col` parameter](#idp5571264)

1.6. [Set `pr_col` parameter](#idp5576240)

1.7. [Set `match_op_col` parameter](#idp5581056)

1.8. [Set `match_exp_col` parameter](#idp5585952)

1.9. [Set `match_flags_col` parameter](#idp5590992)

1.10. [Set `subs_exp_col` parameter](#idp5595968)

1.11. [Set `repl_exp_col` parameter](#idp5600944)

1.12. [Set `timerec_col` parameter](#idp5607184)

1.13. [Set `disabled_col` parameter](#idp5612160)

1.14. [Set `attrs_col` parameter](#idp5617136)

1.15. [`dp_translate` usage](#idp5630496)

1.16. [`dp_translate` usage](#idp5632480)

1.17. [`dp_translate` usage](#idp5634544)

1.18. [`dp_translate` usage](#idp5636624)
