...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5781312)

2.2. [Most recently active contributors(1) to this module](#idp5885568)

**List of Examples**

1.1. [secret parameter example](#idp164272)

1.2. [nonce\_expire parameter example](#idp169152)

1.3. [rpid\_prefix parameter example](#idp173520)

1.4. [rpid\_suffix parameter example](#idp5571456)

1.5. [realm\_prefix parameter example](#idp5575840)

1.6. [rpid\_avp parameter example](#idp5580544)

1.7. [`username_spec` parameter usage](#idp5584592)

1.8. [`password_spec` parameter usage](#idp5588896)

1.9. [`calculate_ha1` parameter usage](#idp5594080)

1.10. [`disable_nonce_check` parameter usage](#idp5598768)

1.11. [www\_challenge usage](#idp5617728)

1.12. [proxy\_challenge usage](#idp5635552)

1.13. [consume\_credentials example](#idp5641520)

1.14. [is\_rpid\_user\_e164 usage](#idp5646016)

1.15. [append\_rpid\_hf usage](#idp5650416)

1.16. [append\_rpid\_hf(prefix, suffix) usage](#idp5658560)

1.17. [`pv_www_authorize` usage](#idp5672560)

1.18. [pv\_proxy\_authorize usage](#idp5681744)
