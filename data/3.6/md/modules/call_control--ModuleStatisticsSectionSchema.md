...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5679696)

2.2. [Most recently active contributors(1) to this module](#idp5780944)

**List of Examples**

1.1. [Setting the `disable` parameter](#idp185184)

1.2. [Setting the `socket_name` parameter](#idp5517280)

1.3. [Setting the `socket_timeout` parameter](#idp5522112)

1.4. [Setting the `signaling_ip_avp` parameter](#idp5528448)

1.5. [Setting the `canonical_uri_avp` parameter](#idp246512)

1.6. [Setting the `diverter_avp` parameter](#idp5549072)

1.7. [Setting the `prepaid_account_flag` parameter](#idp5554352)

1.8. [Setting the `call_limit_avp` parameter](#idp5559552)

1.9. [Setting the `call_token_avp` parameter](#idp5564896)

1.10. [Setting the `init` parameter](#idp5573184)

1.11. [Setting the `start` parameter](#idp5581568)

1.12. [Setting the `stop` parameter](#idp5589952)

1.13. [Using the `call_control` function](#idp5601744)
