...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5806176)

3.2. [Most recently active contributors(1) to this module](#idp5891024)

**List of Examples**

1.1. [Set `hash_size` parameter](#idp5514768)

1.2. [Set `cleanup_interval` parameter](#idp5519712)

1.3. [max\_duration parameter example](#idp5523760)

1.4. [`my_uri` parameter usage](#idp5528416)

1.5. [`advertised_contact` parameter usage](#idp5533056)

1.6. [`relay_uri` parameter usage](#idp5538224)

1.7. [`msrp_ua_answer()` usage](#idp5546272)

2.1. [`struct msrp_ua_handler` structure](#idp5753728)

2.2. [`msrp_ua_notify_cb_f` prototype](#idp5756016)

2.3. [`struct msrp_ua_notify_params` structure](#idp5758016)

2.4. [`enum msrp_ua_event_type`](#idp5760192)

2.5. [`msrp_ua_req_cb_f` prototype](#idp5762240)

2.6. [`msrp_ua_rpl_cb_f` prototype](#idp5764128)

2.7. [`enum msrp_failure_report_type`](#idp5787648)
