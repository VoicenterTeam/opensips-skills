...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6340352)

3.2. [Most recently active contributors(1) to this module](#idp6477152)

**List of Examples**

1.1. [Setting the default database URL for dispatcher](#idp87456)

1.2. [Set the 'default' partition's “attrs\_avp” parameter](#idp93168)

1.3. [Set the 'default' partition's “script\_attrs\_avp” parameter](#idp5534480)

1.4. [Use algo\_route for hashing:](#idp5540064)

1.5. [Use $avp(273) for hashing:](#idp5545712)

1.6. [Use combination of PVs for hashing:](#idp5547184)

1.7. [Set the “setid\_pvar” parameter](#idp5551840)

1.8. [Set the “ds\_ping\_method” parameter](#idp5557440)

1.9. [Set the “ds\_ping\_from” parameter](#idp5563056)

1.10. [Set the “ds\_ping\_interval” parameter](#idp5568528)

1.11. [Set the “ds\_ping\_maxfwd” parameter](#idp5573424)

1.12. [Set the “ds\_probing\_sock” parameter](#idp5578432)

1.13. [Set the “ds\_probing\_threshold” parameter](#idp5583568)

1.14. [Set the “ds\_probing\_mode” parameter](#idp5588752)

1.15. [Set the “ds\_probing\_list” parameter](#idp5593920)

1.16. [Set the 'default' partition's “ds\_define\_blacklist” parameter](#idp5599504)

1.17. [Set the “options\_reply\_codes” parameter](#idp5604688)

1.18. [Set the 'default' partition's “dst\_avp” parameter](#idp5610656)

1.19. [Set the 'default' partition's “grp\_avp” parameter](#idp5616336)

1.20. [Set the 'default' partition's “cnt\_avp” parameter](#idp5622000)

1.21. [Set the 'default' partition's “sock\_avp” parameter](#idp5627680)

1.22. [Set the “pvar\_algo\_pattern” parameter](#idp5634208)

1.23. [Set the `persistent_state` parameter](#idp5640112)

1.24. [Set `cluster_id` parameter](#idp5655024)

1.25. [Set `cluster_sharing_tag` parameter](#idp5663184)

1.26. [Set `cluster_probing_mode` parameter](#idp5676720)

1.27. [Define a new partition called 'voicemail'](#idp5682512)

1.28. [Define the 'trunks' partition and make it the 'default' partition, so we avoid loading the 'dispatcher' table](#idp5684240)

1.29. [Set the default table name](#idp5689616)

1.30. [Set “setid\_col” parameter](#idp5695632)

1.31. [Set “destination\_col” parameter](#idp5700448)

1.32. [Set “state\_col” parameter](#idp5705344)

1.33. [Set “weight\_col” parameter](#idp5710240)

1.34. [Set “priority\_col” parameter](#idp5715232)

1.35. [Set “attrs\_col” parameter](#idp5720240)

1.36. [Set “socket\_col” parameter](#idp5725248)

1.37. [Set “probe\_mode\_col” parameter](#idp5730256)

1.38. [Set the `fetch_freeswitch_load` parameter](#idp5741872)

1.39. [Set the `max_freeswitch_weight` parameter](#idp5749088)

1.40. [`ds_select_dst` usage](#idp5783440)

1.41. [`ds_count` usage](#idp5816560)

1.42. [`ds_is_in_list` usage](#idp5830304)

1.43. [`ds_count` usage](#idp5841712)

1.44. [`ds_count` usage](#idp5851728)

1.45. [OpenSIPS config script - sample dispatcher usage](#idp5920080)
...
**All remaining contributors**: Carsten Bock, Ionel Cerghit ([@ionel-cerghit](https://github.com/ionel-cerghit)), Elena-Ramona Modroiu, Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), John Burke ([@john08burke](https://github.com/john08burke)), Norman Brandinger ([@NormB](https://github.com/NormB)), Klaus Darilion, Anca Vamanu, Jarrod Baumann ([@jarrodb](https://github.com/jarrodb)), wangdd, Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Nick Altmann ([@nikbyte](https://github.com/nikbyte)), Jan Janak ([@janakj](https://github.com/janakj)), Andrei Pelinescu-Onciul, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Stanislaw Pitucha, Babak Yakhchali, Federico Cabiddu, Konstantin Bokarius, Alexandra Titoc, Andreas Granig, John Riordan, Aron Podrigal ([@ar45](https://github.com/ar45)), Juli�n Moreno Pati�o, Kevin McAllister, Roman Sevko, UnixDev, David Sanders, Edson Gellert Schubert.
