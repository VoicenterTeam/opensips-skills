...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5796352)

2.2. [Most recently active contributors(1) to this module](#idp5873312)

**List of Examples**

1.1. [Setting the `vendors_db_url` parameter](#idp3052816)

1.2. [Setting the `vendors_db_table` parameter](#idp5358144)

1.3. [Setting the `vendors_hash_size` parameter](#idp4913344)

1.4. [Setting the `clients_db_url` parameter](#idp3315632)

1.5. [Setting the `clients_db_table` parameter](#idp5429200)

1.6. [Setting the `vendors_hash_size` parameter](#idp260448)

1.7. [Setting the `rates_db_url` parameter](#idp162048)

1.8. [Setting the `rates_db_table` parameter](#idp167296)

1.9. [`get_client_price` usage](#idp5549248)

1.10. [`get_vendor_price` usage](#idp5562240)

1.11. [`cost_based_filtering` usage](#idp5575472)

1.12. [`cost_based_ordering` usage](#idp5588928)
