...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5691104)

3.2. [Most recently active contributors(1) to this module](#idp5792304)

**List of Examples**

1.1. [Set `hash_size` parameter](#idp5515952)

1.2. [Set `db_url` parameter](#idp5520640)

1.3. [Set `db_table` parameter](#idp5526096)

1.4. [Set `min_expires` parameter](#idp5531584)

1.5. [Set `default_expires` parameter](#idp5536720)

1.6. [Set `update_period` parameter](#idp5542240)

1.7. [Set `cluster_id` parameter](#idp5548544)

1.8. [Set `cluster_sharing_tag` parameter](#idp5555008)

1.9. [`pua_update_contact` usage](#idp5564560)

2.1. [`pua_api` structure](#idp5612736)

2.2. [`pua_is_dialog` usage example](#idp5673216)

2.3. [`register_puacb` usage example](#idp5678640)

2.4. [`add_event` usage example](#idp5686224)
...
**All remaining contributors**: Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)), Juha Heinanen ([@juha-h](https://github.com/juha-h)), Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Denis Bilenko, Vallimamod Abdullah, Alex Hermann, Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Damien Sandras ([@dsandras](https://github.com/dsandras)), Sergio Gutierrez, Konstantin Bokarius, Elena-Ramona Modroiu, John Riordan, Ken Rice, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), UnixDev, Zero King ([@l2dy](https://github.com/l2dy)), Carsten Bock, Stanislaw Pitucha, Dan Pascu ([@danpascu](https://github.com/danpascu)), Julien Blache.
