...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5649184)

3.2. [Most recently active contributors(1) to this module](#idp5755936)

**List of Examples**

1.1. [Set `enable` parameter](#idp259696)

1.2. [Set `granularity` parameter](#idp162128)

1.3. [Set `loglevel` parameter](#idp171584)

1.4. [`bm_start_timer` usage](#idp5518624)

1.5. [`bm_log_timer` usage](#idp5537568)

1.6. [Enabling a timer](#idp5554000)

1.7. [Getting the results via FIFO interface](#idp5568448)

1.8. [benchmark usage](#idp5571296)

2.1. [Using the benchmark module's API from another module](#idp5681952)
