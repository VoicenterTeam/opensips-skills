...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5605056)

3.2. [Most recently active contributors(1) to this module](#idp5727248)

**List of Examples**

1.1. [Set `db_url` parameter](#idp221776)

1.2. [Set `xcap_table` parameter](#idp174768)

1.3. [Set `integrated_xcap_server` parameter](#idp164368)

2.1. [`xcap_api` structure](#idp5607520)
