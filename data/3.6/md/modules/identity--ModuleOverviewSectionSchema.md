...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5646304)

2.2. [Most recently active contributors(1) to this module](#idp5745808)

**List of Examples**

1.1. [Set `privKey` parameter](#idp4631552)

1.2. [Set `authCert` parameter](#idp261616)

1.3. [Set `certUri` parameter](#idp250528)

1.4. [Set `verCert` parameter](#idp169312)

1.5. [Set `caList` parameter](#idp173520)

1.6. [Set `crlList` parameter](#idp5570320)

1.7. [Set `privKey` parameter](#idp5575984)

1.8. [`authservice()` usage](#idp5587360)

1.9. [`verifier()` usage](#idp5608224)
...
**All remaining contributors**: Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Sa�l Ibarra Corretg� ([@saghul](https://github.com/saghul)).
