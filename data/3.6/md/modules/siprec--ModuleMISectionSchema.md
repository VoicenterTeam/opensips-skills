...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5742720)

2.2. [Most recently active contributors(1) to this module](#idp5831200)

**List of Examples**

1.1. [Set `skip_failover_codes` parameter](#idp5541152)

1.2. [Use `siprec_start_recording()` function with a single SRS](#idp5567760)

1.3. [Use `siprec_start_recording()` function with multiple SRS servers](#idp5570224)

1.4. [Use `siprec_start_recording()` function with custom XML values for participants](#idp5572816)

1.5. [Use `siprec_start_recording()` function with custom headers](#idp5575168)

1.6. [Use `siprec_start_recording()` function with custom group and session extensions](#idp5577296)

1.7. [Use `siprec_pause_recording()`](#idp5585456)

1.8. [Use `siprec_resume_recording()`](#idp5593024)

1.9. [Use `siprec_stop_recording()`](#idp5600624)

1.10. [Use `siprec_send_indialog()`](#idp5610176)
...
*   _Cannot handle Recording Sessions initiated by SRS_ - we do not support the scenario when an SRS suddenly decides to record a call in the middle of the dialog.
