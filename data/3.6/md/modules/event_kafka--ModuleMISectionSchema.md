...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp30743472)

2.2. [Most recently active contributors(1) to this module](#idp30828624)

**List of Examples**

1.1. [Set `broker_id` parameter](#idp30699776)

1.2. [`kafka_publish()` function usage](#idp30717728)

1.3. [Kafka socket](#idp30720736)
