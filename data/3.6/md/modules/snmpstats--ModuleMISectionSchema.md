...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5756240)

3.2. [Most recently active contributors(1) to this module](#idp5855680)

**List of Examples**

1.1. [Setting the `sipEntityType` parameter](#idp5520832)

1.2. [Setting the `MsgQueueMinorThreshold` parameter](#idp5525600)

1.3. [Setting the `MsgQueueMajorThreshold` parameter](#idp5530032)

1.4. [Setting the `dlg_minor_threshold` parameter](#idp5534416)

1.5. [Setting the `dlg_major_threshold` parameter](#idp5538896)

1.6. [Setting the `snmpgetPath` parameter](#idp5544464)

1.7. [Setting the `snmpCommunity` parameter](#idp5549680)
...
**All remaining contributors**: Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)), Sergio Gutierrez, Henning Westerholt ([@henningw](https://github.com/henningw)), Klaus Darilion, Anca Vamanu, Daniel-Constantin Mierla ([@miconda](https://github.com/miconda)), Konstantin Bokarius, Edson Gellert Schubert, Jesus Rodrigues, Jeffrey Magder.
