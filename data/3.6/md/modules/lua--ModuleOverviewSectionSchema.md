...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5623760)

3.2. [Most recently active contributors(1) to this module](#idp5719616)

**List of Examples**

1.1. [Set luafilename parameter](#idp165328)

1.2. [lua\_exec() usage](#idp5518992)
...
With the Lua module, you can access to lua function on the OpenSIPS side. You need to define a file to load and call a function from it. Write a function "mongo\_alias" and then write in your opensips.cfg
...
*   _action_ (optional) - 'add' or 'delete'
    
*   _extension_ (optional) - required if _action_ is provided
...
Dynamically change the variable warn\_missing\_free\_fixup.
...
Returns "SIP\_REQUEST" or "SIP\_REPLY".
...
Returns the current status if the SIP message is a SIP\_REPLY.
...
### 2.1.21.�AVP\_get(name)

Returns an AVP variable.

### 2.1.22.�AVP\_set(name, value)

Defines an AVP variable.

### 2.1.23.�AVP\_destroy(name)
...
### 2.1.28.�add\_lump\_rpl(msg, header)
