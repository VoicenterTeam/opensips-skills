...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5599776)

2.2. [Most recently active contributors(1) to this module](#idp5680496)

**List of Examples**

1.1. [Set `bins_port` parameter](#idp3887536)

1.2. [Set `bins_handshake_timeout` variable](#idp246672)

1.3. [Set `bins_send_timeout` parameter](#idp163744)

1.4. [Set `bins_max_msg_chunks` parameter](#idp169008)

1.5. [Set `bins_async` parameter](#idp5509344)

1.6. [Set `bins_async_max_postponed_chunks` parameter](#idp5514032)

1.7. [Set `bins_async_local_connect_timeout` parameter](#idp5518752)

1.8. [Set `bins_async_handshake_timeout` parameter](#idp5523856)

1.9. [Set `trace_destination` parameter](#idp5531200)

1.10. [Set `trace_on` parameter](#idp5548896)
