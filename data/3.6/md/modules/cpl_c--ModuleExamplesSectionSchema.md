...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5728688)

2.2. [Most recently active contributors(1) to this module](#idp5833312)

**List of Examples**

1.1. [Set `db_url` parameter](#idp248624)

1.2. [Set `db_table` parameter](#idp166704)

1.3. [Set `username_column` parameter](#idp172240)

1.4. [Set `domain_column` parameter](#idp5517392)

1.5. [Set `cpl_xml_column` parameter](#idp5522320)

1.6. [Set `cpl_bin_column` parameter](#idp5527280)

1.7. [Set `cpl_dtd_file` parameter](#idp5532080)

1.8. [Set `log_dir` parameter](#idp5536736)

1.9. [Set `proxy_recurse` parameter](#idp5541536)

1.10. [Set `proxy_route` parameter](#idp5546144)

1.11. [Set `case_sensitive` parameter](#idp5550752)

1.12. [Set `realm_prefix` parameter](#idp5555312)

1.13. [Set `lookup_domain` parameter](#idp5560448)

1.14. [Set `lookup_append_branches` parameter](#idp5565120)

1.15. [Set `use_domain` parameter](#idp5570096)

1.16. [`cpl_run_script` usage](#idp5587008)

1.17. [`cpl_process_register` usage](#idp5592704)

1.18. [`cpl_process_register_norpl` usage](#idp5598304)
...
**All remaining contributors**: Elena-Ramona Modroiu, Alexandra Titoc, Eric Tamme ([@etamme](https://github.com/etamme)), Dan Pascu ([@danpascu](https://github.com/danpascu)), Nick Altmann ([@nikbyte](https://github.com/nikbyte)), Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)), Konstantin Bokarius, Jesus Rodrigues, Norman Brandinger ([@NormB](https://github.com/NormB)), Andreas Granig, Ionel Cerghit ([@ionel-cerghit](https://github.com/ionel-cerghit)), Juli�n Moreno Pati�o, Ken Rice, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), UnixDev, Edson Gellert Schubert.
