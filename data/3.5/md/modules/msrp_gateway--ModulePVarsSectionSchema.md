...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp4696800)

2.2. [Most recently active contributors(1) to this module](#idp5679216)

**List of Examples**

1.1. [Set `hash_size` parameter](#idp3323504)

1.2. [Set `cleanup_interval` parameter](#idp5180320)

1.3. [Set `session_timeout` parameter](#idp5314528)

1.4. [Set `message_timeout` parameter](#idp4350720)

1.5. [`msrp_gw_answer()` usage](#idp4061824)

1.6. [`msg_to_msrp()` usage](#idp3726208)
