...
4.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5751952)

4.2. [Most recently active contributors(1) to this module](#idp5874704)

**List of Examples**

1.1. [Dialog support in RR module](#idp3644544)

1.2. [Set `append_fromtag` parameter](#idp5514592)

1.3. [Set `enable_double_rr` parameter](#idp5519360)

1.4. [Set `add_username` parameter](#idp5523920)

1.5. [`enable_socket_mismatch_warning` usage](#idp5528752)

1.6. [`loose_route` usage](#idp5539856)

1.7. [`record_route` usage](#idp5546112)

1.8. [`record_route_preset` usage](#idp5554512)

1.9. [`add_rr_param` usage](#idp5562432)

1.10. [`check_route_param` usage](#idp5569680)

1.11. [`is_direction` usage](#idp5580128)

2.1. [Loading RR module's API from another module](#idp5725760)
