...
4.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp31350128)

4.2. [Most recently active contributors(1) to this module](#idp31472752)

**List of Examples**

1.1. [Set `db_url` parameter](#idp30715696)

1.2. [Set `acc_db_url` parameter](#idp30720480)

1.3. [Set `rt_db_url` parameter](#idp30725056)

1.4. [Set `wrapup_time` parameter](#idp30730752)

1.5. [Set `queue_pos_param` parameter](#idp30735824)

1.6. [Set `reject_on_no_agents` parameter](#idp30740912)

1.7. [Set `chat_dispatch_policy` parameter](#idp30750320)

1.8. [Set `internal_call_dispatching` parameter](#idp25352704)

1.9. [Set `cc_agents_table` parameter](#idp30761504)

1.10. [Set `cca_agentid_column` parameter](#idp30766496)

1.11. [Set `cca_location_column` parameter](#idp30771504)

1.12. [Set `cca_msrp_location_column` parameter](#idp30776512)

1.13. [Set `cca_msrp_max_sessions_column` parameter](#idp30781584)

1.14. [Set `cca_skills_column` parameter](#idp30786592)

1.15. [Set `cca_logstate_column` parameter](#idp30791600)

1.16. [Set `cca_wrapuptime_column` parameter](#idp30796608)

1.17. [Set `cca_wrapupend_column` parameter](#idp30801632)

1.18. [Set `cc_flows_table` parameter](#idp30806640)

1.19. [Set `ccf_flowid_column` parameter](#idp30811632)

1.20. [Set `ccf_priority_column` parameter](#idp30816608)

1.21. [Set `ccf_skill_column` parameter](#idp30821584)

1.22. [Set `ccf_cid_column` parameter](#idp30826576)

1.23. [Set `ccf_max_wrapup_column` parameter](#idp30831568)

1.24. [Set `ccf_dissuading_hangup_column` parameter](#idp30836576)

1.25. [Set `ccf_dissuading_onhold_th_column` parameter](#idp30841616)

1.26. [Set `ccf_dissuading_ewt_th_column` parameter](#idp30846624)

1.27. [Set `ccf_dissuading_qsize_th_column` parameter](#idp30851648)

1.28. [Set `ccf_m_welcome_column` parameter](#idp30856656)

1.29. [Set `ccf_m_queue_column` parameter](#idp30861664)

1.30. [Set `ccf_m_dissuading_column` parameter](#idp30866672)

1.31. [Set `ccf_m_flow_id_column` parameter](#idp30871696)

1.32. [Set `b2b_logic_ctx_param` parameter](#idp30878240)

1.33. [`cc_handle_call` usage](#idp30895456)

1.34. [`cc_agent_login` usage](#idp30902896)

1.35. [$rtpquery Usage](#idp31021152)
