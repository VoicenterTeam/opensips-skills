...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5727248)

2.2. [Most recently active contributors(1) to this module](#idp5826448)

**List of Examples**

1.1. [`cache_table` parameter usage](#idp5574064)

1.2. [`spec_delimiter` parameter usage](#idp5578752)

1.3. [`pvar_delimiter` parameter usage](#idp5583584)

1.4. [`columns_delimiter` parameter usage](#idp5588752)

1.5. [`sql_fetch_nr_rows` parameter usage](#idp5593296)

1.6. [`full_caching_expire` parameter usage](#idp5597776)

1.7. [`reload_interval` parameter usage](#idp5602224)

1.8. [`bigint_to_str` parameter usage](#idp5606768)

1.9. [`sql_cacher_reload` usage](#idp5617104)

1.10. [`sql_cached_value(id{sep}col{sep}key) pseudo-variable` usage](#idp5626864)

1.11. [Example database content - carrierfailureroute table](#idp5632528)

1.12. [Setting the `cache_table` parameter](#idp5635392)

1.13. [Accessing cached values](#idp5638208)
