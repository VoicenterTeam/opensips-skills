...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5542640)

3.2. [Most recently active contributors(1) to this module](#idp5643184)

**List of Examples**

1.1. [Set `force_active` parameter](#idp156096)

1.2. [Set `pidf_manipulation` parameter](#idp105536)

1.3. [Set `xcap_server` parameter](#idp190336)

1.4. [Set `pres_rules_auid` parameter](#idp194624)

1.5. [Set `pres_rules_filename` parameter](#idp5515168)

1.6. [Set `generate_offline_body` parameter](#idp5519104)
