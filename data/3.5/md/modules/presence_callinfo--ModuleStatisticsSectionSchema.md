...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5573584)

2.2. [Most recently active contributors(1) to this module](#idp5664864)

**List of Examples**

1.1. [Set `call_info_timeout_notification` parameter](#idp5520032)

1.2. [Set `line_seize_timeout_notification` parameter](#idp5524672)

1.3. [Set `disable_dialog_support_for_sca` parameter](#idp5529584)

1.4. [Set `line_hash_size` parameter](#idp5534928)

1.5. [`sca_set_calling_line()` usage](#idp5541504)

1.6. [`sca_set_called_line()` usage](#idp5546976)
