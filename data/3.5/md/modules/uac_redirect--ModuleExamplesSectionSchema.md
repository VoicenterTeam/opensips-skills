...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5599008)

2.2. [Most recently active contributors(1) to this module](#idp5699376)

**List of Examples**

1.1. [Set `default_filter` module parameter](#idp249328)

1.2. [Set `deny_filter` module parameter](#idp168608)

1.3. [Set `accept_filter` module parameter](#idp5516816)

1.4. [`set_deny_filter` usage](#idp5530416)

1.5. [`set_accept_filter` usage](#idp5543072)

1.6. [`get_redirects` usage](#idp5552896)

1.7. [Redirection script example](#idp5555904)
