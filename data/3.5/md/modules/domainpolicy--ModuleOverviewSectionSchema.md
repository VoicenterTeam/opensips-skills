...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5757248)

2.2. [Most recently active contributors(1) to this module](#idp5856368)

**List of Examples**

1.1. [Setting db\_url parameter](#idp3665856)

1.2. [Setting dp\_table parameter](#idp268352)

1.3. [Setting dp\_col\_rule parameter](#idp1716912)

1.4. [Setting dp\_col\_rule parameter](#idp1721616)

1.5. [Setting dp\_col\_att parameter](#idp170384)

1.6. [Setting dp\_col\_val parameter](#idp5569696)

1.7. [Setting port\_override\_avp parameter](#idp5573872)

1.8. [Setting transport\_override\_avp parameter](#idp5577920)

1.9. [Setting domain\_replacement\_avp parameter](#idp5582080)

1.10. [Setting domain\_prefix\_avp parameter](#idp5586240)

1.11. [Setting domain\_suffix\_avp parameter](#idp5590384)

1.12. [Setting send\_socket\_avp parameter](#idp5594864)

1.13. [dp\_can\_connect usage](#idp5610432)

1.14. [dp\_apply\_policy usage](#idp5632016)
