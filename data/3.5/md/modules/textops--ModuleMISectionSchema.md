...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5673184)

2.2. [Most recently active contributors(1) to this module](#idp5777232)

**List of Examples**

1.1. [`search` usage](#idp160944)

1.2. [`search_body` usage](#idp104240)

1.3. [`search_append` usage](#idp5513296)

1.4. [`search_append_body` usage](#idp5520864)

1.5. [`replace` usage](#idp5528320)

1.6. [`replace_body` usage](#idp5535776)

1.7. [`replace_all` usage](#idp5543232)

1.8. [`replace_body_all` usage](#idp5550816)

1.9. [`replace_body_atonce` usage](#idp5558400)

1.10. [`subst` usage](#idp5566752)

1.11. [`subst_uri` usage](#idp5575120)

1.12. [`subst` usage](#idp5584016)

1.13. [`subst_body` usage](#idp5592192)
