...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp4750048)

2.2. [Most recently active contributors(1) to this module](#idp6010960)

**List of Examples**

1.1. [Creating a document](#idp5924816)

1.2. [Inserting nodes with indentation](#idp5928976)

1.3. [Using script variables in path](#idp5930768)
