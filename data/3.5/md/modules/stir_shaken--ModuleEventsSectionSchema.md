...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6160512)

2.2. [Most recently active contributors(1) to this module](#idp6258160)

**List of Examples**

1.1. [Set `auth_date_freshness` parameter](#idp166496)

1.2. [Set `verify_date_freshness` parameter](#idp5886048)

1.3. [Set `ca_list` parameter](#idp5889872)

1.4. [Set `ca_dir` parameter](#idp5895056)

1.5. [Set `crl_list` parameter](#idp5898912)

1.6. [Set `crl_dir` parameter](#idp5904192)

1.7. [Set `e164_strict_mode` parameter](#idp5910816)

1.8. [Set `e164_max_length` parameter](#idp5915600)

1.9. [Set `require_date_hdr` parameter](#idp5923440)

1.10. [`stir_shaken_auth()` usage](#idp5955136)

1.11. [`stir_shaken_verify()` usage](#idp5975424)

1.12. [`stir_shaken_check()` usage](#idp5985088)

1.13. [`stir_shaken_check_cert()` usage](#idp5992928)

1.14. [`stir_shaken_disengagement()` usage](#idp6001984)

1.15. [`identity` usage](#idp6016288)
