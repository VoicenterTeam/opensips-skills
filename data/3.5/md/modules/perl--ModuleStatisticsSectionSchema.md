...
5.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6161152)

5.2. [Most recently active contributors(1) to this module](#idp6280240)

**List of Examples**

1.1. [Set `filename` parameter](#idp5583952)

1.2. [Set `modpath` parameter](#idp5588640)

1.3. [`perl_exec_simple()` usage](#idp5596832)

1.4. [`perl_exec()` usage](#idp5603968)
