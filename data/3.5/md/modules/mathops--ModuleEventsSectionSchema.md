...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5637904)

2.2. [Most recently active contributors(1) to this module](#idp5734848)

**List of Examples**

1.1. [Setting the decimal\_digits module parameter](#idp3322304)

1.2. [`math_eval` usage](#idp166000)

1.3. [`math_rpn` usage](#idp5518400)

1.4. [`math_trunc` usage](#idp5526464)

1.5. [`math_floor` usage](#idp5534208)

1.6. [`math_ceil` usage](#idp5541968)

1.7. [`math_round` usage](#idp5551584)

1.8. [`math_round_sf` usage](#idp5564592)

1.9. [`math_compare` usage](#idp5573696)
