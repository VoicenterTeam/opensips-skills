...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5538288)

2.2. [Most recently active contributors(1) to this module](#idp5642240)

**List of Examples**

1.1. [Set `exec_query_threshold` parameter](#idp259920)

1.2. [Set `max_db_queries` parameter](#idp249520)

1.3. [Set `timeout` parameter](#idp167232)

1.4. [Set the `use_tls` parameter](#idp5523568)
