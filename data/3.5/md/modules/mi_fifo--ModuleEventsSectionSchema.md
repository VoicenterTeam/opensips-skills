...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp30785696)

2.2. [Most recently active contributors(1) to this module](#idp30888256)

**List of Examples**

1.1. [Set `fifo_name` parameter](#idp25362400)

1.2. [Set `fifo_mode` parameter](#idp25367232)

1.3. [Set `fifo_group` parameter](#idp30712032)

1.4. [Set `fifo_user` parameter](#idp30716960)

1.5. [Set `reply_dir` parameter](#idp30721776)

1.6. [Set `pretty_printing` parameter](#idp30726784)

1.7. [Set `trace_destination` parameter](#idp30733696)

1.8. [Set `trace_destination` parameter](#idp30742400)

1.9. [FIFO request](#idp30747920)
