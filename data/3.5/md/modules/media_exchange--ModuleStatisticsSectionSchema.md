...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5767632)

2.2. [Most recently active contributors(1) to this module](#idp5848912)

**List of Examples**

1.1. [Use `media_fork_to_uri()` function to fork media to a Media Server](#idp173696)

1.2. [Use `media_fork_from_call()` function to fork all media streams of a call](#idp5532784)

1.3. [Use `media_fork_from_call()` function to fork only the first caller's stream](#idp5535056)

1.4. [Use `media_fork_pause()` function to temporarily stop the entire media stream of the call](#idp5544208)

1.5. [Use `media_fork_resume()` function to resume a forking previously stopped](#idp5553424)

1.6. [Use `media_exchange_from_uri()` function to fetch media from a Media Server's call](#idp5566080)

1.7. [Use `media_exchange_to_call()` function to make an announcement](#idp5577200)

1.8. [Use `media_terminate()` function to terminate an announcement](#idp5587136)

1.9. [Use `media_terminate()` function to terminate an announcement](#idp5597408)
