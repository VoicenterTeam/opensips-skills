...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6644848)

3.2. [Most recently active contributors(1) to this module](#idp6750464)

**List of Examples**

1.1. [Set `default_expires` parameter](#idp5646272)

1.2. [Set `min_expires` parameter](#idp5650960)

1.3. [Set `max_expires` parameter](#idp5655568)

1.4. [Set `default_q` parameter](#idp5660272)

1.5. [Set `tcp_persistent_flag` parameter](#idp5665504)

1.6. [Set `realm_prefix` parameter](#idp5670352)

1.7. [Set `case_sensitive` parameter](#idp5675552)

1.8. [Set `received_avp` parameter](#idp5681216)

1.9. [Set `received_param` parameter](#idp5685872)

1.10. [Setting the `expires_max_deviation` parameter](#idp5735360)

1.11. [Set `max_contacts` parameter](#idp5741056)

1.12. [Setting the _max\_username\_len_ module parameter](#idp5746288)

1.13. [Setting the _max\_domain\_len_ module parameter](#idp5751440)

1.14. [Setting the _max\_aor\_len_ module parameter](#idp5756576)

1.15. [Setting the _max\_contact\_len_ module parameter](#idp5761712)

1.16. [Set `retry_after` parameter](#idp5733376)

1.17. [Set `sock_hdr_namer` parameter](#idp5768864)

1.18. [Set `mcontact_avp` parameter](#idp5774208)

1.19. [Set `attr_avp` parameter](#idp5780800)

1.20. [Set `gruu_secret` parameter](#idp125024)

1.21. [Set `gruu_secret` parameter](#idp5799120)

1.22. [Setting the `pn_enable` parameter](#idp5849568)

1.23. [Setting the `pn_providers` parameter](#idp5855216)

1.24. [Setting the `pn_ct_match_params` parameter](#idp5863264)

1.25. [Setting the `pn_pnsreg_interval` parameter](#idp5869408)

1.26. [Setting the `pn_trigger_interval` parameter](#idp5877728)

1.27. [Setting the `pn_skip_pn_interval` parameter](#idp5883392)

1.28. [Setting the `pn_refresh_timeout` parameter](#idp5892496)

1.29. [Setting the `pn_enable_purr` parameter](#idp5900704)

1.30. [`save` usage](#idp5975024)

1.31. [`remove` usage](#idp6012976)

1.32. [`remove_ip_port` usage](#idp6024576)

1.33. [`lookup` usage](#idp6106368)

1.34. [`is_registered` usage](#idp6115552)

1.35. [`is_contact_registered` usage](#idp6126800)

1.36. [`is_ip_registered` usage](#idp6139056)

1.37. [`add_sock_hdr` usage](#idp6146752)

1.38. [`async pn_process_purr()` usage](#idp6204448)
...
*   initial INVITE processing is barely changed, with the _lookup()_ function now additionally returning a value of **2** if the only found contacts were PN-enabled contacts, all which required a Push Notification. This means that PNs have been triggered for each of them and t\_relay() is not required, since they are not reachable until they re-register!
    ...
    Using the event\_routing module, OpenSIPS will transparently fork a new branch from the current INVITE on each re-registration from these contacts within the accepted [pn\_refresh\_timeout](#param_pn_refresh_timeout "1.3.28.�pn_refresh_timeout (integer)")
...
*   _event\_routing_, if [pn\_enable](#param_pn_enable "1.3.22.�pn_enable (boolean)") is set to _true_.
...
**Example�1.12.�Setting the _max\_username\_len_ module parameter**
...
**Example�1.13.�Setting the _max\_domain\_len_ module parameter**
...
**Example�1.14.�Setting the _max\_aor\_len_ module parameter**
...
**Example�1.15.�Setting the _max\_contact\_len_ module parameter**
...
Enable SIP Push Notification support ([_RFC 8599_](https://tools.ietf.org/html/rfc8599)). If enabled, Contact header field URIs which include all [pn\_ct\_match\_params](#param_pn_ct_match_params "1.3.24.�pn_ct_match_params (string)") will be matched against existing bindings using only these parameters. Otherwise, the module will attempt to match them as usual, using the current usrloc [matching\_mode](usrloc#param_matching_mode).
...
**All remaining contributors**: Henning Westerholt ([@henningw](https://github.com/henningw)), Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Andrei Pelinescu-Onciul, Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)), Juha Heinanen ([@juha-h](https://github.com/juha-h)), Nick Altmann ([@nikbyte](https://github.com/nikbyte)), Ancuta Onofrei, Elena-Ramona Modroiu, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Dan Pascu ([@danpascu](https://github.com/danpascu)), Sergio Gutierrez, Carsten Bock, Jeffrey Magder, Kobi Eshun ([@ekobi](https://github.com/ekobi)), Dudu Ben Moshe, Marcus Hunger, Juli�n Moreno Pati�o, Phil D'Amore, Klaus Darilion, Irina-Maria Stanescu, Dmitry Semyonov, Konstantin Bokarius, Andrej Solovjov, Jesus Rodrigues, Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), Ruslan Bukin, Sa�l Ibarra Corretg� ([@saghul](https://github.com/saghul)), [@jalung](https://github.com/jalung), Tolga Tarhan, Edson Gellert Schubert.
