...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5661200)

2.2. [Most recently active contributors(1) to this module](#idp5759920)

**List of Examples**

1.1. [Set `file` parameter](#idp261200)

1.2. [Set `max_groups` parameter](#idp162112)

1.3. [Set `group_max_size` parameter](#idp167280)

1.4. [Set `pcre_caseless` parameter](#idp172608)

1.5. [Set `pcre_multiline` parameter](#idp5516544)

1.6. [Set `pcre_dotall` parameter](#idp5521712)

1.7. [Set `pcre_extended` parameter](#idp5527008)

1.8. [`pcre_match` usage (forcing case insensitive)](#idp5536560)

1.9. [`pcre_match` usage (using "end of line" symbol)](#idp5538688)

1.10. [`pcre_match_group` usage](#idp5559792)

1.11. [regex file](#idp5583280)

1.12. [Using with pua\_usrloc](#idp5586816)

1.13. [Incorrect groups file](#idp5589056)
...
**All remaining contributors**: Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Marius Zbihlei.
