...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp30811088)

2.2. [Most recently active contributors(1) to this module](#idp30913488)

**List of Examples**

1.1. [Setting domain\_suffix module parameter](#idp25339760)

1.2. [Setting tel\_uri\_params module parameter](#idp25350576)

1.3. [Setting i\_enum\_suffix module parameter](#idp25347008)

1.4. [Setting isn\_suffix module parameter](#idp30693712)

1.5. [Setting branchlabel module parameter](#idp30697936)

1.6. [Zone file example](#idp30702592)

1.7. [Zone file example](#idp30705008)

1.8. [Setting the bl\_algorithm module parameter](#idp30707632)

1.9. [`enum_query` usage](#idp30730272)

1.10. [`isn_query` usage](#idp30746336)

1.11. [`is_from_user_enum` usage](#idp30754640)
