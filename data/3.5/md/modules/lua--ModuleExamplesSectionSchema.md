...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5617344)

3.2. [Most recently active contributors(1) to this module](#idp5709344)

**List of Examples**

1.1. [Set luafilename parameter](#idp250400)

1.2. [lua\_exec() usage](#idp174672)
