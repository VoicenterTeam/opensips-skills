...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5594288)

2.2. [Most recently active contributors(1) to this module](#idp5693392)

**List of Examples**

1.1. [Set `enable_long_quoting` parameter](#idp261776)

1.2. [Accessing the $json variable](#idp171968)

1.3. [Iterating through an array using variables](#idp173744)

1.4. [iteration over $json object keys](#idp5522928)

1.5. [iteration over $json object values](#idp5524448)

1.6. [iteration over $json array values](#idp5526096)

1.7. [Appending integers to arrays](#idp5533072)

1.8. [Deleting the last element in an array](#idp5534464)

1.9. [Adding a string value to a json object](#idp5535856)

1.10. [Initializing an array](#idp5538576)

1.11. [Setting a boolean or null value](#idp5539968)

1.12. [Adding a json to another json](#idp5541472)

1.13. [Creating a reference](#idp5554656)

1.14. [\[LOGICAL ERROR\] Creating a circular reference](#idp5557216)
...
**All remaining contributors**: Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)), Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)), Anca Vamanu, Andrei Dragus.
