...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5648960)

3.2. [Most recently active contributors(1) to this module](#idp5706448)

**List of Examples**

1.1. [Set `db_url` parameter](#idp4883552)

1.2. [Set `user_column` parameter](#idp247536)

1.3. [Set `domain_column` parameter](#idp164240)

1.4. [Set `alias_user_column` parameter](#idp169488)

1.5. [Set `alias_domain_column` parameter](#idp5513264)

1.6. [Set `domain_prefix` parameter](#idp5518192)

1.7. [Set `append_branches` parameter](#idp5523136)

1.8. [`alias_db_lookup()` usage](#idp5535824)

1.9. [`alias_db_find()` usage](#idp5550416)
