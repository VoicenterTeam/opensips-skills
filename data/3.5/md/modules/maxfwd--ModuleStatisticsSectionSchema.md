...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5594128)

2.2. [Most recently active contributors(1) to this module](#idp5695440)

**List of Examples**

1.1. [Set `max_limit` parameter](#idp171392)

1.2. [`mx_process_maxfwd_header` usage](#idp108160)

1.3. [`is_maxfwd_lt` usage](#idp5581488)
