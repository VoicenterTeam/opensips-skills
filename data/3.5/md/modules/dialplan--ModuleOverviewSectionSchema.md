...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5874512)

3.2. [Most recently active contributors(1) to this module](#idp5977184)

**List of Examples**

1.1. [Defining the `'pstn'` partition](#idp1588656)

1.2. [Define the 'pstn' partition and make it the 'default' partition, so we avoid loading the 'dialplan' table](#idp3353936)

1.3. [Set `db_url` parameter](#idp4462048)

1.4. [Set `table_name` parameter](#idp3727024)

1.5. [Set `dpid_col` parameter](#idp3888992)

1.6. [Set `pr_col` parameter](#idp5360080)

1.7. [Set `match_op_col` parameter](#idp3061472)

1.8. [Set `match_exp_col` parameter](#idp2417232)

1.9. [Set `match_flags_col` parameter](#idp3448208)

1.10. [Set `subs_exp_col` parameter](#idp3813024)

1.11. [Set `repl_exp_col` parameter](#idp5704336)

1.12. [Set `timerec_col` parameter](#idp4030032)

1.13. [Set `disabled_col` parameter](#idp3733168)

1.14. [Set `attrs_col` parameter](#idp3037536)

1.15. [`dp_translate` usage](#idp3284208)

1.16. [`dp_translate` usage](#idp3553952)

1.17. [`dp_translate` usage](#idp1681536)

1.18. [`dp_translate` usage](#idp4547920)
