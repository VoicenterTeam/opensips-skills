...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5647456)

3.2. [Most recently active contributors(1) to this module](#idp5749136)

**List of Examples**

1.1. [Set `cachedb_url` parameter](#idp3637312)

1.2. [Set `cache_collections` parameter](#idp4665760)

1.3. [Set `cache_clean_period` parameter](#idp2128240)

1.4. [Setting the `cluster_id` parameter](#idp2820048)

1.5. [Set `cluster_persistency` parameter](#idp100064)

1.6. [Set `enable_restart_persistency` parameter](#idp5564448)

1.7. [`cache_remove_chunk` usage](#idp5573632)
