...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5656960)

3.2. [Most recently active contributors(1) to this module](#idp5763680)

**List of Examples**

1.1. [Set `enable` parameter](#idp250368)

1.2. [Set `granularity` parameter](#idp168112)

1.3. [Set `loglevel` parameter](#idp5520128)

1.4. [`bm_start_timer` usage](#idp5526560)

1.5. [`bm_log_timer` usage](#idp5545504)

1.6. [Enabling a timer](#idp5561936)

1.7. [Getting the results via FIFO interface](#idp5576384)

1.8. [benchmark usage](#idp5579232)

2.1. [Using the benchmark module's API from another module](#idp5689696)
