...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5560864)

3.2. [Most recently active contributors(1) to this module](#idp5622864)

**List of Examples**

1.1. [Set `server_address` parameter](#idp1798192)

1.2. [Set `presence_server` parameter](#idp259712)

1.3. [`Notify2Xmpp` usage](#idp162928)

1.4. [`xmpp_send_winfo` usage](#idp171088)
