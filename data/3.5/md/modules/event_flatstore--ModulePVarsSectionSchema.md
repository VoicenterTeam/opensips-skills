...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5596416)

2.2. [Most recently active contributors(1) to this module](#idp5685392)

**List of Examples**

1.1. [Set `max_open_sockets` parameter](#idp165008)

1.2. [Set `delimiter` parameter](#idp170224)

1.3. [Set `file_permissions` parameter](#idp5570992)

1.4. [Set `suppress_event_name` parameter](#idp5575808)
