...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5708448)

2.2. [Most recently active contributors(1) to this module](#idp5782384)

**List of Examples**

1.1. [`db_mode` parameter usage](#idp2467888)

1.2. [`db_url` parameter usage](#idp4748416)

1.3. [`profiles_table` parameter usage](#idp338320)

1.4. [`secrets_table` parameter usage](#idp165728)

1.5. [Set `tag_column` parameter](#idp170736)

1.6. [Set `username_column` parameter](#idp5568128)

1.7. [Set `secret_tag_column` parameter](#idp5572832)

1.8. [set `secret_column` parameter](#idp5577648)

1.9. [set `start_ts` parameter](#idp5582464)

1.10. [set `end_ts` parameter](#idp5587280)

1.11. [set `tag_claim` parameter](#idp5592096)

1.12. [`load_credentials` parameter usage](#idp5599520)

1.13. [`jwt_db_authorize` usage](#idp5611600)

1.14. [`jwt_script_authorize` usage](#idp5623920)

1.15. [`extract_pub_key_from_cert` usage](#idp5634240)
