...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5968704)

3.2. [Most recently active contributors(1) to this module](#idp6032272)

**List of Examples**

1.1. [Instructing the module to work in direct mode](#idp171984)

1.2. [Instructing the module to provide normal voice service](#idp5520848)

1.3. [Setting the OSP servers](#idp5529040)

1.4. [Setting the OSP server weights](#idp5533728)

1.5. [Setting the device IP address](#idp5537152)

1.6. [Instructing the module not to use OSP security features](#idp5540608)

1.7. [Setting the token format](#idp5545824)

1.8. [Set authorization files](#idp5550800)

1.9. [Setting the hardware support](#idp5554944)

1.10. [Setting the ssl lifetime](#idp5558448)

1.11. [Setting the persistence](#idp5561920)

1.12. [Setting the retry delay](#idp5565392)

1.13. [Setting the retry limit](#idp5569040)

1.14. [Setting the timeout](#idp5572496)

1.15. [Setting support non-SIP destination devices](#idp5575824)

1.16. [Setting the number of destination](#idp5579216)

1.17. [Setting report network ID flag](#idp5582800)

1.18. [Instructing the module to validate call id](#idp5586368)

1.19. [Instructing the module to use number portability parameters in Request URI](#idp5589936)

1.20. [Append user=phone parameter](#idp5593488)

1.21. [Append networkid location](#idp5597952)

1.22. [Networkid parameter name](#idp5601312)

1.23. [Append switchid location](#idp5605776)

1.24. [Networkid parameter name](#idp5609136)

1.25. [Append parameter string location](#idp5613600)

1.26. [Parameter string value](#idp5616912)

1.27. [Setting the source device IP AVP](#idp251008)

1.28. [Setting the source network ID AVP](#idp254816)

1.29. [Setting the source switch ID AVP](#idp258704)

1.30. [Setting the custom info AVP](#idp5639936)

1.31. [Setting the CNAM AVP](#idp5643456)

1.32. [Setting the NOTIFY extra headers](#idp5646784)

1.33. [Setting the media address AVPs](#idp5650320)

1.34. [Setting the request date AVP](#idp5653968)

1.35. [Setting the SDP finger print AVP](#idp5657568)

1.36. [Setting the Identity related AVPs](#idp5662784)

1.37. [Setting the source service provider AVP](#idp5666496)

1.38. [Setting the source user group AVP](#idp5669984)

1.39. [Setting the source user ID AVP](#idp5673456)

1.40. [checkospheader usage](#idp5678656)

1.41. [validateospheader usage](#idp5682880)

1.42. [getlocaladress usage](#idp5686928)

1.43. [setrequestdate usage](#idp5690992)

1.44. [requestosprouting usage](#idp5696560)

1.45. [checkosproute usage](#idp5700624)

1.46. [prepareosproute usage](#idp5705136)

1.47. [prepareospresponse usage](#idp5709408)

1.48. [prepareallosproutes usage](#idp5713600)

1.49. [checkcallingtranslation usage](#idp5718032)

1.50. [reportospusage usage](#idp5724800)

1.51. [processsubscribe usage](#idp5731040)
