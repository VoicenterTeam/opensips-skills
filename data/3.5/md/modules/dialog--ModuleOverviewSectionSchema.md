...
4.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp7117680)

4.2. [Most recently active contributors(1) to this module](#idp7252272)

**List of Examples**

1.1. [Set `enable_stats` parameter](#idp4144128)

1.2. [Set `hash_size` parameter](#idp305088)

1.3. [Set `hash_size` parameter](#idp310640)

1.4. [Set `rr_param` parameter](#idp1957936)

1.5. [Set `default_timeout` parameter](#idp5637312)

1.6. [Set `dlf_extra_hdrs` parameter](#idp5642272)

1.7. [Set `dlg_match_mode` parameter](#idp5651920)

1.8. [Set `delete_delay` parameter](#idp5658288)

1.9. [Set `db_url` parameter](#idp5663136)

1.10. [Set `db_mode` parameter](#idp5674080)

1.11. [Set `db_update_period` parameter](#idp5679408)

1.12. [Set `options_ping_interval` parameter](#idp5684368)

1.13. [Set `reinvite_ping_interval` parameter](#idp5691536)

1.14. [Set `table_name` parameter](#idp5696480)

1.15. [Set `call_id_column` parameter](#idp5701296)

1.16. [Set `from_uri_column` parameter](#idp5706112)

1.17. [Set `from_tag_column` parameter](#idp5711040)

1.18. [Set `to_uri_column` parameter](#idp5715856)

1.19. [Set `to_tag_column` parameter](#idp5720816)

1.20. [Set `from_cseq_column` parameter](#idp5725728)

1.21. [Set `to_cseq_column` parameter](#idp5730640)

1.22. [Set `from_route_column` parameter](#idp5735664)

1.23. [Set `to_route_column` parameter](#idp5740688)

1.24. [Set `from_contact_column` parameter](#idp5745680)

1.25. [Set `to_contact_column` parameter](#idp5750688)

1.26. [Set `from_sock_column` parameter](#idp5755728)

1.27. [Set `to_sock_column` parameter](#idp5760768)

1.28. [Set `dlg_id_column` parameter](#idp5765760)

1.29. [Set `state_column` parameter](#idp5770752)

1.30. [Set `start_time_column` parameter](#idp5775760)

1.31. [Set `timeout_column` parameter](#idp5780736)

1.32. [Set `profiles_column` parameter](#idp5785728)

1.33. [Set `vars_column` parameter](#idp5790704)

1.34. [Set `sflags_column` parameter](#idp5795696)

1.35. [Set `mflags_column` parameter](#idp5800688)

1.36. [Set `flags_column` parameter](#idp5805664)

1.37. [Set `profiles_with_value` parameter](#idp5811568)

1.38. [Set `profiles_no_value` parameter](#idp5817520)

1.39. [Set `db_flush_vals_profiles` parameter](#idp5822592)

1.40. [Set `timer_bulk_del_no` parameter](#idp5827632)

1.41. [Set `race_condition_timeout` parameter](#idp5832720)

1.42. [Set `cachedb_url` parameter](#idp5837744)

1.43. [Set `profile_value_prefix` parameter](#idp5842832)

1.44. [Set `profile_no_value_prefix` parameter](#idp5847920)

1.45. [Set `profile_size_prefix` parameter](#idp5853008)

1.46. [Set `profile_timeout` parameter](#idp5858080)

1.47. [Set `dialog_replication_cluster` parameter](#idp5870224)

1.48. [Set `profile_replication_cluster` parameter](#idp5876224)

1.49. [Set `replicate_profiles_buffer` parameter](#idp5881504)

1.50. [Set `replicate_profiles_check` parameter](#idp5886656)

1.51. [Set `replicate_profiles_timer` parameter](#idp5891776)

1.52. [Set `replicate_profiles_expire` parameter](#idp5896960)

1.53. [Set `cluster_auto_sync` parameter](#idp5902624)

1.54. [`create_dialog()` usage](#idp5918096)

1.55. [`match_dialog()` usage](#idp5926864)

1.56. [`validate_dialog()` usage](#idp5939056)

1.57. [`fix_route_dialog()` usage](#idp5944560)

1.58. [`get_dialog_info` usage](#idp5956720)

1.59. [`get_dialog_vals` usage](#idp5967536)

1.60. [`get_dialog_vals` usage](#idp5978384)

1.61. [`get_dialog_vals` usage](#idp5989408)

1.62. [`load_dialog_ctx` usage](#idp5999008)

1.63. [`set_dlg_profile` usage](#idp6013712)

1.64. [`unset_dlg_profile` usage](#idp6022592)

1.65. [`is_in_profile` usage](#idp6031136)

1.66. [`get_profile_size` usage](#idp6040336)

1.67. [`set_dlg_flag` usage](#idp6048032)

1.68. [`test_and_set_dlg_flag` usage](#idp6056240)

1.69. [`reset_dlg_flag` usage](#idp6063600)

1.70. [`is_dlg_flag_set` usage](#idp6070960)

1.71. [`store_dlg_value` usage](#idp6080576)

1.72. [`fetch_dlg_value` usage](#idp6089904)

1.73. [`set_dlg_sharing_tag` usage](#idp6098336)

1.74. [`dlg_on_answer` usage](#idp6105904)

1.75. [`dlg_on_timeout` usage](#idp6114288)

1.76. [`dlg_on_hangup` usage](#idp6122224)

1.77. [`dlg_send_sequential` usage to convert DTMF codes](#idp6133616)
...
**All remaining contributors**: Anca Vamanu, Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Ionut Ionita ([@ionutrazvanionita](https://github.com/ionutrazvanionita)), Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Ionel Cerghit ([@ionel-cerghit](https://github.com/ionel-cerghit)), Andrei Dragus, John Riordan, Hugues Mitonneau, Carsten Bock, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Jerome Martin, Klaus Darilion, Jarrod Baumann ([@jarrodb](https://github.com/jarrodb)), Nick Altmann ([@nikbyte](https://github.com/nikbyte)), Zero King ([@l2dy](https://github.com/l2dy)), Michel Bensoussan, Richard Revels, Elena-Ramona Modroiu, Tavis Paquette, Ryan Bullock, Andrei Datcu ([@andrei-datcu](https://github.com/andrei-datcu)), Jeffrey Magder, Stefan-Cristian Mititelu, Ron Winacott, Andy Pyles, Juli�n Moreno Pati�o, Konstantin Bokarius, sergei lavrov, Alex Massover, Damien Sandras ([@dsandras](https://github.com/dsandras)), Alex Hermann, Alexandra Titoc, Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), Norman Brandinger ([@NormB](https://github.com/NormB)), UnixDev, Eliot Gable, Ryan Bullock ([@rrb3942](https://github.com/rrb3942)), Edson Gellert Schubert.
