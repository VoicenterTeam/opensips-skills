...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp4695152)

2.2. [Most recently active contributors(1) to this module](#idp5594848)

**List of Examples**

1.1. [Setting the `failover_timeout` parameter](#idp5509248)

1.2. [Virtual socket](#idp5513552)
