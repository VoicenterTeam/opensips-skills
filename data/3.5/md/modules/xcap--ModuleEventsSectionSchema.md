...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5598112)

3.2. [Most recently active contributors(1) to this module](#idp5718288)

**List of Examples**

1.1. [Set `db_url` parameter](#idp258784)

1.2. [Set `xcap_table` parameter](#idp173344)

1.3. [Set `integrated_xcap_server` parameter](#idp162560)

2.1. [`xcap_api` structure](#idp4747536)
