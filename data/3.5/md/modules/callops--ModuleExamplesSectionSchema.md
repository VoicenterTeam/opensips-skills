...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5790512)

2.2. [Most recently active contributors(1) to this module](#idp5867424)

**List of Examples**

1.1. [Drop automatically handled NOTIFY refer events](#idp4683008)

1.2. [Set `mode` parameter](#idp5577376)

1.3. [Set `match_param` parameter](#idp5582864)

1.4. [Use `call_blind_replace()` function to match an existing leg.](#idp5592384)

1.5. [Use `call_transfer_notify()` function to handle NOTIFY refer requests.](#idp5598800)

1.6. [Use `call_transfer()` function to do a blind transfer of the caller to a new destination.](#idp5607584)

1.7. [Use `call_transfer()` function to do an attended transfer of the caller to the callee of a different call.](#idp5619744)
