...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp30872064)

2.2. [Most recently active contributors(1) to this module](#idp30971856)

**List of Examples**

1.1. [Setting db\_url for a module](#idp28658096)

1.2. [Set `SSL` parameter](#idp25360416)

1.3. [Set `cap_raw_query` parameter](#idp29877936)

1.4. [Set `cap_replace` parameter](#idp25274384)

1.5. [Set `cap_insert_update` parameter](#idp25279552)

1.6. [Set `cap_last_inserted_id` parameter](#idp30694032)

1.7. [Set `field_delimiter` parameter](#idp30698848)

1.8. [Set `row_delimiter` parameter](#idp30703664)

1.9. [Set `quote_delimiter` parameter](#idp30708608)

1.10. [Set `value_delimiter` parameter](#idp30726320)

1.11. [Set `timeout` parameter](#idp30731232)

1.12. [Set `disable_expect` parameter](#idp30736320)

1.13. [Example query.](#idp30742400)

1.14. [Example query with variables.](#idp30757904)

1.15. [More query examples.](#idp30770560)

1.16. [NULL query example.](#idp30773552)

1.17. [Example Reply.](#idp30779120)

1.18. [Quoting Example.](#idp30783024)
