...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5635824)

2.2. [Most recently active contributors(1) to this module](#idp5739472)

**List of Examples**

1.1. [Set “setvars” parameter](#idp169664)

1.2. [Set “time\_to\_kill” parameter](#idp5572752)

1.3. [`exec` usage](#idp5587744)

1.4. [`async exec` usage](#idp5607968)
