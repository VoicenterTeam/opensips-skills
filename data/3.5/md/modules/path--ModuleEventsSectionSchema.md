...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5596384)

2.2. [Most recently active contributors(1) to this module](#idp5695200)

**List of Examples**

1.1. [Set `use_received` parameter](#idp162512)

1.2. [Set `enable_double_path` parameter](#idp167520)

1.3. [`add_path(user)` usage](#idp5572608)

1.4. [`add_path_received(user)` usage](#idp5579888)
