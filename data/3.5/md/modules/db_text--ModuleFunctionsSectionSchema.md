...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5673088)

3.2. [Most recently active contributors(1) to this module](#idp5737616)

**List of Examples**

1.1. [Sample of a db\_text table](#idp171472)

1.2. [Minimal OpenSIPS location db\_text table definition](#idp5513104)

1.3. [Minimal OpenSIPS subscriber db\_text table example](#idp5514496)

1.4. [Set `db_mode` parameter](#idp5528720)

1.5. [Set `buffer_size` parameter](#idp5533536)

1.6. [Load the db\_text module](#idp5554960)

1.7. [Definition of 'subscriber' table (one line)](#idp5558384)

1.8. [Definition of 'location' and 'aliases' tables (one line)](#idp5560096)

1.9. [Definition of 'version' table and sample records](#idp5561776)

1.10. [Configuration file](#idp5563264)
