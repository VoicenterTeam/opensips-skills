...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5623264)

2.2. [Most recently active contributors(1) to this module](#idp5722656)

**List of Examples**

1.1. [Setting the `db_url` parameter](#idp4875264)

1.2. [Setting the `db_table_routing` parameter](#idp3975680)

1.3. [Setting the `db_table_report` parameter](#idp1576384)

1.4. [Setting the `db_table_provider` parameter](#idp4255216)

1.5. [Setting the `proxy_role` parameter](#idp164512)

1.6. [Setting the `url_vpc` parameter](#idp169760)

1.7. [Setting the `emergency_codes` parameter](#idp5540800)

1.8. [Setting the `timer_interval` parameter](#idp5545904)

1.9. [Setting the `contingency_hostname` parameter](#idp5550864)

1.10. [Setting the `emergency_call_server` parameter](#idp5556176)

1.11. [`emergency_call()` usage](#idp5562640)

1.12. [`failure()` usage](#idp5568288)
