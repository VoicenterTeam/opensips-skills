...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5606064)

3.2. [Most recently active contributors(1) to this module](#idp5708096)

**List of Examples**

1.1. [Set `db_url` parameter](#idp163472)

1.2. [Usage example](#idp165456)

1.3. [Set `db_url` parameter](#idp169440)

1.4. [Set `key_column` parameter](#idp173392)

1.5. [Set `value_column` parameter](#idp5569072)

1.6. [Set `counter_column` parameter](#idp5572736)

1.7. [Set `expires_column` parameter](#idp5576400)

1.8. [Set `cache_clean_period` parameter](#idp5580208)
