...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5637200)

2.2. [Most recently active contributors(1) to this module](#idp5735776)

**List of Examples**

1.1. [Set `db_url` parameter](#idp4865936)

1.2. [Set `user_column` parameter](#idp2491248)

1.3. [Set `domain_column` parameter](#idp3604048)

1.4. [Set `sd_user_column` parameter](#idp3794304)

1.5. [Set `sd_domain_column` parameter](#idp4623024)

1.6. [Set `new_uri_column` parameter](#idp5168384)

1.7. [Set `domain_prefix` parameter](#idp3445744)

1.8. [Set `use_domain` parameter](#idp4269712)

1.9. [`sd_lookup` usage](#idp4515200)

1.10. [OpenSIPS config script - sample speeddial usage](#idp107360)
