...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6054336)

2.2. [Most recently active contributors(1) to this module](#idp6155376)

**List of Examples**

1.1. [`initial_probability` parameter usage](#idp246496)

1.2. [`hash_file` parameter usage](#idp162304)

1.3. [`shv_hash_size` parameter usage](#idp167024)

1.4. [`shvset` parameter usage](#idp5572992)

1.5. [`varset` parameter usage](#idp5582240)

1.6. [Setting lock\_pool\_size module parameter](#idp5588128)

1.7. [`rand_event()` usage](#idp5595600)

1.8. [`rand_set_prob()` usage](#idp5614256)

1.9. [`rand_reset_prob()` usage](#idp5618640)

1.10. [`rand_get_prob()` usage](#idp5622624)

1.11. [`sleep` usage](#idp5629056)

1.12. [`usleep` usage](#idp5635488)

1.13. [`abort` usage](#idp5640272)

1.14. [`pkg_status` usage](#idp5645216)

1.15. [`shm_status` usage](#idp5650160)

1.16. [`set_count` usage](#idp5655360)

1.17. [`set_select_weight` usage](#idp5660368)

1.18. [`ts_usec_delta` usage](#idp5667840)

1.19. [`check_time_rec` usage](#idp5682784)

1.20. [`get_static_lock` usage](#idp252064)

1.21. [`release_static_lock` usage](#idp5706240)

1.22. [`get_dynamic_lock` usage](#idp5714656)

1.23. [`release_dynamic_lock` usage](#idp5721616)

1.24. [`strings_share_lock` usage](#idp5729952)

1.25. [`get_accurate_time` usage](#idp5739280)

1.26. [`shuffle_avps` usage](#idp5746240)

1.27. [`async sleep` usage](#idp5752736)

1.28. [`async usleep` usage](#idp5758288)

1.29. [`rand_set_prob` usage](#idp5765360)

1.30. [`rand_reset_prob` usage](#idp5769712)

1.31. [`rand_get_prob` usage](#idp5774192)

1.32. [`check_config_hash` usage](#idp5778896)

1.33. [`get_config_hash` usage](#idp5783440)

1.34. [`shv_set` usage](#idp5792880)

1.35. [`shv_get` usage](#idp5798496)

1.36. [`env(name) pseudo-variable` usage](#idp5803328)

1.37. [`RANDOM pseudo-variable` usage](#idp5807136)

1.38. [`ctime(name) pseudo-variable` usage](#idp5821872)

1.39. [`shv(name) pseudo-variable` usage](#idp5826800)
...
*   _name (variable)_ - name of AVP to shuffle.
