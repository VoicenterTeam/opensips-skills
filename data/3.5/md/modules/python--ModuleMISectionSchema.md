...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5557504)

2.2. [Most recently active contributors(1) to this module](#idp5642384)

**List of Examples**

1.1. [Set `script_name` parameter](#idp5515936)

1.2. [Set `mod_init_function` parameter](#idp5520848)

1.3. [Set `child_init_method` parameter](#idp5525664)
