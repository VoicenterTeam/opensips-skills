...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5658000)

2.2. [Most recently active contributors(1) to this module](#idp5759440)

**List of Examples**

1.1. [Set `include_callid` parameter](#idp172256)

1.2. [Set `include_tags` parameter](#idp5528672)

1.3. [Set `include_localremote` parameter](#idp5533552)

1.4. [Set `caller_confirmed` parameter](#idp5538976)

1.5. [Set `publish_on_trying` parameter to 0](#idp5545360)

1.6. [Set `publish_on_trying` parameter to 1](#idp5548704)

1.7. [Set `nopublish_flag` parameter](#idp5554368)

1.8. [Set `presence_server` parameter](#idp5558144)

1.9. [Set `caller_spec_param` parameter](#idp5562784)

1.10. [Set `caller_spec_param` parameter](#idp5566752)

1.11. [Set `osips_ps` parameter](#idp5571936)

1.12. [`dialoginfo_set` usage](#idp5579296)

1.13. [`dialoginfo_set_branch_callee` usage](#idp5586224)

1.14. [`dialoginfo_mute_branch` usage](#idp5592688)
