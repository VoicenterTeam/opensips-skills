...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp4699424)

2.2. [Most recently active contributors(1) to this module](#idp5976416)

**List of Examples**

1.1. [Set `default_domain` parameter](#idp171344)

1.2. [Set `presentity_prefix` parameter](#idp5867520)

1.3. [Set `presence_server` parameter](#idp5871328)

1.4. [`pua_set_publish` usage](#idp5877168)
