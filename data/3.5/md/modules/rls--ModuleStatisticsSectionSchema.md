...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp4124784)

3.2. [Most recently active contributors(1) to this module](#idp1818208)

**List of Examples**

1.1. [Set `rlsubs_table` parameter](#idp1189328)

1.2. [Set `rlpres_table` parameter](#idp4182576)

1.3. [Set `clean_period` parameter](#idp2795664)

1.4. [Set `waitn_time` parameter](#idp4345872)

1.5. [Set `max_expires` parameter](#idp1604512)

1.6. [Set `hash_size` parameter](#idp2714480)

1.7. [Set `hash_size` parameter](#idp3732000)

1.8. [Set `to_presence_code` parameter](#idp2035264)

1.9. [Set `rls_event` parameter](#idp5512400)

1.10. [Set `presence_server` parameter](#idp4881776)

1.11. [Set `contact_user` parameter](#idp2233824)

1.12. [`rls_handle_subscribe` usage](#idp3127728)

1.13. [`rls_handle_notify` usage](#idp5235520)
...
**All remaining contributors**: Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Stanislaw Pitucha, Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)), Sergio Gutierrez, Konstantin Bokarius, UnixDev, John Riordan, Juli�n Moreno Pati�o, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Edson Gellert Schubert.
