...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp95904)

2.2. [Most recently active contributors(1) to this module](#idp5628144)

**List of Examples**

1.1. [Set `cachedb_url` parameter](#idp3907728)

1.2. [Set `timeout` parameter](#idp4168208)

1.3. [Set `exec_threshold` parameter](#idp3225296)

1.4. [Set `lazy_connect` parameter](#idp2409664)

1.5. [Use CouchBase servers](#idp2833952)
...
**Last edited by:** Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)), Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)), Juli�n Moreno Pati�o, Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)), Ryan Bullock ([@rrb3942](https://github.com/rrb3942)).
