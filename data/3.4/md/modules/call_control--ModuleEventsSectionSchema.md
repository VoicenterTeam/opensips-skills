...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5678112)

2.2. [Most recently active contributors(1) to this module](#idp5779104)

**List of Examples**

1.1. [Setting the `disable` parameter](#idp170512)

1.2. [Setting the `socket_name` parameter](#idp5515712)

1.3. [Setting the `socket_timeout` parameter](#idp5520656)

1.4. [Setting the `signaling_ip_avp` parameter](#idp5526992)

1.5. [Setting the `canonical_uri_avp` parameter](#idp252032)

1.6. [Setting the `diverter_avp` parameter](#idp5547616)

1.7. [Setting the `prepaid_account_flag` parameter](#idp5552896)

1.8. [Setting the `call_limit_avp` parameter](#idp5558096)

1.9. [Setting the `call_token_avp` parameter](#idp5563440)

1.10. [Setting the `init` parameter](#idp5571728)

1.11. [Setting the `start` parameter](#idp5580032)

1.12. [Setting the `stop` parameter](#idp5588336)

1.13. [Using the `call_control` function](#idp5599888)
...
**Last edited by:** Alexey Vasilyev ([@vasilevalex](https://github.com/vasilevalex)), Zero King ([@l2dy](https://github.com/l2dy)), Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)), Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)), Dan Pascu ([@danpascu](https://github.com/danpascu)), Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)), Sa�l Ibarra Corretg� ([@saghul](https://github.com/saghul)), Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)), Irina-Maria Stanescu.
