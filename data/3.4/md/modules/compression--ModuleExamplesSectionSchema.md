...
1.1. [mc\_compress performance test results](#idp3010464)

2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp4756720)

2.2. [Most recently active contributors(1) to this module](#idp1826928)

**List of Examples**

1.1. [Set `mc_level` parameter](#idp5795696)

1.2. [`mc_compress` usage](#idp3111088)

1.3. [`mc_compress` usage](#idp2399712)

1.4. [`mc_compress` usage](#idp5186592)

1.5. [`mc_decompress` usage](#idp4231616)
