...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5828816)

2.2. [Most recently active contributors(1) to this module](#idp5909968)

**List of Examples**

1.1. [Use `media_fork_to_uri()` function to fork media to a Media Server](#idp5581232)

1.2. [Use `media_fork_from_call()` function to fork all media streams of a call](#idp5593840)

1.3. [Use `media_fork_from_call()` function to fork only the first caller's stream](#idp5596112)

1.4. [Use `media_fork_pause()` function to temporarily stop the entire media stream of the call](#idp5605264)

1.5. [Use `media_fork_resume()` function to resume a forking previously stopped](#idp5614480)

1.6. [Use `media_exchange_from_uri()` function to fetch media from a Media Server's call](#idp5627136)

1.7. [Use `media_exchange_to_call()` function to make an announcement](#idp5638256)

1.8. [Use `media_terminate()` function to terminate an announcement](#idp5648192)

1.9. [Use `media_terminate()` function to terminate an announcement](#idp5658464)
