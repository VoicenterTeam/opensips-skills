...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5853680)

2.2. [Most recently active contributors(1) to this module](#idp5930768)

**List of Examples**

1.1. [Setting the `vendors_db_url` parameter](#idp312672)

1.2. [Setting the `vendors_db_table` parameter](#idp318032)

1.3. [Setting the `vendors_hash_size` parameter](#idp174464)

1.4. [Setting the `clients_db_url` parameter](#idp179664)

1.5. [Setting the `clients_db_table` parameter](#idp5575504)

1.6. [Setting the `vendors_hash_size` parameter](#idp5580512)

1.7. [Setting the `rates_db_url` parameter](#idp5585488)

1.8. [Setting the `rates_db_table` parameter](#idp5590496)

1.9. [`get_client_price` usage](#idp5605440)

1.10. [`get_vendor_price` usage](#idp5618432)

1.11. [`cost_based_filtering` usage](#idp5631824)

1.12. [`cost_based_ordering` usage](#idp5645360)
