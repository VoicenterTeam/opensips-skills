...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5641040)

2.2. [Most recently active contributors(1) to this module](#idp5740240)

**List of Examples**

1.1. [Set `enable_long_quoting` parameter](#idp3831248)

1.2. [Accessing the $json variable](#idp167952)

1.3. [Iterating through an array using variables](#idp169664)

1.4. [iteration over $json object keys](#idp5569712)

1.5. [iteration over $json object values](#idp5571232)

1.6. [iteration over $json array values](#idp5572880)

1.7. [Appending integers to arrays](#idp5579936)

1.8. [Deleting the last element in an array](#idp5581328)

1.9. [Adding a string value to a json object](#idp5582720)

1.10. [Initializing an array](#idp5585440)

1.11. [Setting a boolean or null value](#idp5586832)

1.12. [Adding a json to another json](#idp5588336)

1.13. [Creating a reference](#idp5601520)

1.14. [\[LOGICAL ERROR\] Creating a circular reference](#idp5604080)
...
**All remaining contributors**: Anca Vamanu, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Juli�n Moreno Pati�o.
...
**All remaining contributors**: Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)), Anca Vamanu, Andrei Dragus.
