...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5671408)

2.2. [Most recently active contributors(1) to this module](#idp5771200)

**List of Examples**

1.1. [Setting the `db_url` parameter](#idp171152)

1.2. [Setting the `db_table_routing` parameter](#idp176608)

1.3. [Setting the `db_table_report` parameter](#idp5564912)

1.4. [Setting the `db_table_provider` parameter](#idp5569840)

1.5. [Setting the `proxy_role` parameter](#idp5578816)

1.6. [Setting the `url_vpc` parameter](#idp5583776)

1.7. [Setting the `emergency_codes` parameter](#idp5589120)

1.8. [Setting the `timer_interval` parameter](#idp5594224)

1.9. [Setting the `contingency_hostname` parameter](#idp5599184)

1.10. [Setting the `emergency_call_server` parameter](#idp5604496)

1.11. [`emergency_call()` usage](#idp5610960)

1.12. [`failure()` usage](#idp5616608)
...
**All remaining contributors**: Juli�n Moreno Pati�o, Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)).
...
**All remaining contributors**: Ionut Ionita ([@ionutrazvanionita](https://github.com/ionutrazvanionita)), Robison Tesini ([@rtesini](https://github.com/rtesini)).
