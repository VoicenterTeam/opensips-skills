...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5634448)

2.2. [Most recently active contributors(1) to this module](#idp5739888)

**List of Examples**

1.1. [Set `exec_query_threshold` parameter](#idp2803504)

1.2. [Set `timeout_interval` parameter](#idp221312)

1.3. [Set `max_db_queries` parameter](#idp211008)

1.4. [Set `max_db_retries` parameter](#idp5575024)

1.5. [Set `ps_max_col_size` parameter](#idp5580560)

1.6. [Set the `use_tls` parameter](#idp5591088)
