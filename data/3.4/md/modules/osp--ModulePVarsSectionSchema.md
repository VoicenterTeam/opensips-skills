...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5918800)

3.2. [Most recently active contributors(1) to this module](#idp5982368)

**List of Examples**

1.1. [Instructing the module to work in direct mode](#idp124960)

1.2. [Instructing the module to provide normal voice service](#idp5471408)

1.3. [Setting the OSP servers](#idp5479600)

1.4. [Setting the OSP server weights](#idp5484288)

1.5. [Setting the device IP address](#idp5487712)

1.6. [Instructing the module not to use OSP security features](#idp5491168)

1.7. [Setting the token format](#idp5496480)

1.8. [Set authorization files](#idp5501456)

1.9. [Setting the hardware support](#idp5505600)

1.10. [Setting the ssl lifetime](#idp5509104)

1.11. [Setting the persistence](#idp5512576)

1.12. [Setting the retry delay](#idp5516048)

1.13. [Setting the retry limit](#idp5519696)

1.14. [Setting the timeout](#idp5523152)

1.15. [Setting support non-SIP destination devices](#idp5526480)

1.16. [Setting the number of destination](#idp5529872)

1.17. [Setting report network ID flag](#idp5533456)

1.18. [Instructing the module to validate call id](#idp5537024)

1.19. [Instructing the module to use number portability parameters in Request URI](#idp5540592)

1.20. [Append user=phone parameter](#idp5544144)

1.21. [Append networkid location](#idp5548608)

1.22. [Networkid parameter name](#idp5551968)

1.23. [Append switchid location](#idp5556432)

1.24. [Networkid parameter name](#idp5559792)

1.25. [Append parameter string location](#idp5564256)

1.26. [Parameter string value](#idp5567568)

1.27. [Setting the source device IP AVP](#idp203600)

1.28. [Setting the source network ID AVP](#idp207456)

1.29. [Setting the source switch ID AVP](#idp211264)

1.30. [Setting the custom info AVP](#idp5590512)

1.31. [Setting the CNAM AVP](#idp5593952)

1.32. [Setting the NOTIFY extra headers](#idp5597280)

1.33. [Setting the media address AVPs](#idp5600736)

1.34. [Setting the request date AVP](#idp5604384)

1.35. [Setting the SDP finger print AVP](#idp5607904)

1.36. [Setting the Identity related AVPs](#idp5613040)

1.37. [Setting the source service provider AVP](#idp5616752)

1.38. [Setting the source user group AVP](#idp5620160)

1.39. [Setting the source user ID AVP](#idp5623632)

1.40. [checkospheader usage](#idp5628832)

1.41. [validateospheader usage](#idp5633056)

1.42. [getlocaladress usage](#idp5637104)

1.43. [setrequestdate usage](#idp5641168)

1.44. [requestosprouting usage](#idp5646736)

1.45. [checkosproute usage](#idp5650800)

1.46. [prepareosproute usage](#idp5655312)

1.47. [prepareospresponse usage](#idp5659584)

1.48. [prepareallosproutes usage](#idp5663776)

1.49. [checkcallingtranslation usage](#idp5668208)

1.50. [reportospusage usage](#idp5674976)

1.51. [processsubscribe usage](#idp5681216)
