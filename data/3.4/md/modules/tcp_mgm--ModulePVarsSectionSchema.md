...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp98992)

2.2. [Most recently active contributors(1) to this module](#idp5555072)

**List of Examples**

1.1. [Setting the `db_url` parameter](#idp2315248)

1.2. [Setting the `db_table` parameter](#idp2711360)

1.3. [Setting the `[column-name]_col` parameter](#idp259056)
