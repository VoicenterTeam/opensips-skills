...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5661792)

3.2. [Most recently active contributors(1) to this module](#idp5756992)

**List of Examples**

1.1. [Set `listen` variable](#idp163536)

1.2. [Set `wss_port` variable](#idp168944)

1.3. [Set `wss_max_msg_chunks` parameter](#idp174208)

1.4. [Set `wss_resource` parameter](#idp5517616)

1.5. [Set `wss_handshake_timeout` parameter](#idp5522208)

1.6. [Set `cert_check_on_conn_reusage` parameter](#idp5527744)

1.7. [Set `trace_destination` parameter](#idp253296)

1.8. [Set `trace_on` parameter](#idp5561632)

1.9. [Set `trace_filter_route` parameter](#idp5573968)

1.10. [Set `wss_tls_handshake_timeout` variable](#idp5579760)

1.11. [Set `wss_send_timeout` variable](#idp5584656)

1.12. [Set `require_origin` parameter](#idp5588896)
