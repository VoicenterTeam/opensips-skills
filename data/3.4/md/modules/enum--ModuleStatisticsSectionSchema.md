...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5684816)

2.2. [Most recently active contributors(1) to this module](#idp5787216)

**List of Examples**

1.1. [Setting domain\_suffix module parameter](#idp163008)

1.2. [Setting tel\_uri\_params module parameter](#idp167744)

1.3. [Setting i\_enum\_suffix module parameter](#idp172096)

1.4. [Setting isn\_suffix module parameter](#idp5567280)

1.5. [Setting branchlabel module parameter](#idp5571504)

1.6. [Zone file example](#idp5576160)

1.7. [Zone file example](#idp5578576)

1.8. [Setting the bl\_algorithm module parameter](#idp5581200)

1.9. [`enum_query` usage](#idp5603840)

1.10. [`isn_query` usage](#idp5619984)

1.11. [`is_from_user_enum` usage](#idp5628368)
