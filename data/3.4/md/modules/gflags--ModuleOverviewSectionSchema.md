...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp31148560)

2.2. [Most recently active contributors(1) to this module](#idp31249040)

**List of Examples**

1.1. [`initial` parameter usage](#idp25342208)

1.2. [`set_gflag()` usage](#idp25349296)

1.3. [`reset_gflag()` usage](#idp31103728)

1.4. [`is_gflag()` usage](#idp31109152)

1.5. [`set_gflag` usage](#idp31115600)

1.6. [`reset_gflag` usage](#idp31120000)

1.7. [`is_gflag` usage](#idp31125040)

1.8. [`get_gflags` usage](#idp31129408)
