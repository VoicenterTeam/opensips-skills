...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp30918304)

3.2. [Most recently active contributors(1) to this module](#idp31019728)

**List of Examples**

1.1. [Set `hash_size` parameter](#idp30743152)

1.2. [Set `db_url` parameter](#idp30747840)

1.3. [Set `db_table` parameter](#idp30753296)

1.4. [Set `min_expires` parameter](#idp30758688)

1.5. [Set `default_expires` parameter](#idp30763824)

1.6. [Set `update_period` parameter](#idp30769344)

1.7. [Set `cluster_id` parameter](#idp30775648)

1.8. [Set `cluster_sharing_tag` parameter](#idp30782112)

1.9. [`pua_update_contact` usage](#idp30791664)

2.1. [`pua_api` structure](#idp30840016)

2.2. [`pua_is_dialog` usage example](#idp30900432)

2.3. [`register_puacb` usage example](#idp30905952)

2.4. [`add_event` usage example](#idp30913536)
...
**All remaining contributors**: Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)), Juha Heinanen ([@juha-h](https://github.com/juha-h)), Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Denis Bilenko, Vallimamod Abdullah, Alex Hermann, Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Damien Sandras ([@dsandras](https://github.com/dsandras)), Sergio Gutierrez, Konstantin Bokarius, Elena-Ramona Modroiu, John Riordan, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), UnixDev, Zero King ([@l2dy](https://github.com/l2dy)), Stanislaw Pitucha, Dan Pascu ([@danpascu](https://github.com/danpascu)), Julien Blache.
