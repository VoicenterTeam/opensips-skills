...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5806080)

3.2. [Most recently active contributors(1) to this module](#idp5883008)

**List of Examples**

1.1. [Set `hash_size` parameter](#idp5515280)

1.2. [Set `cleanup_interval` parameter](#idp5520224)

1.3. [max\_duration parameter example](#idp5524272)

1.4. [`my_uri` parameter usage](#idp5528928)

1.5. [`advertised_contact` parameter usage](#idp5533568)

1.6. [`relay_uri` parameter usage](#idp5538832)

1.7. [`msrp_ua_answer()` usage](#idp5546880)

2.1. [`struct msrp_ua_handler` structure](#idp5753536)

2.2. [`msrp_ua_notify_cb_f` prototype](#idp5755824)

2.3. [`struct msrp_ua_notify_params` structure](#idp5757824)

2.4. [`enum msrp_ua_event_type`](#idp5760000)

2.5. [`msrp_ua_req_cb_f` prototype](#idp5762048)

2.6. [`msrp_ua_rpl_cb_f` prototype](#idp5763936)

2.7. [`enum msrp_failure_report_type`](#idp5787552)
