...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6131088)

2.2. [Most recently active contributors(1) to this module](#idp6232240)

**List of Examples**

1.1. [Set `db_url` parameter](#idp106976)

1.2. [Set `db_table` parameter](#idp106048)

1.3. [Set `id_column` parameter](#idp187440)

1.4. [Set `carrier_column` parameter](#idp5521744)

1.5. [Set `scan_prefix_column` parameter](#idp5527280)

1.6. [Set `domain_column` parameter](#idp5532320)

1.7. [Set `flags_column` parameter](#idp5537216)

1.8. [Set `mask_column` parameter](#idp5542192)

1.9. [Set `prob_column` parameter](#idp5548240)

1.10. [Set `rewrite_host_column` parameter](#idp5553344)

1.11. [Set `strip_column` parameter](#idp5558320)

1.12. [Set `comment_column` parameter](#idp5563392)

1.13. [Set `carrier_table` parameter](#idp5568432)

1.14. [Set `rewrite_prefix_column` parameter](#idp5573472)

1.15. [Set `rewrite_suffix_column` parameter](#idp5578528)

1.16. [Set `id_col` parameter](#idp5583552)

1.17. [Set `carrier_name_col` parameter](#idp5588544)

1.18. [Set `subscriber_table` parameter](#idp5593520)

1.19. [Set `subscriber_user_col` parameter](#idp5598528)

1.20. [Set `subscriber_domain_col` parameter](#idp5603568)

1.21. [Set `subscriber_carrier_col` parameter](#idp5608608)

1.22. [Set `config_source` parameter](#idp5613680)

1.23. [Set `config_file` parameter](#idp5618576)

1.24. [Set `default_tree` parameter](#idp5623632)

1.25. [Set `use_domain` parameter](#idp5628672)

1.26. [Set `fallback_default` parameter](#idp5633840)

1.27. [Set `db_failure_table` parameter](#idp5638832)

1.28. [Set `failure_id_column` parameter](#idp5643824)

1.29. [Set `failure_carrier_column` parameter](#idp5648800)

1.30. [Set `failure_scan_prefix_column` parameter](#idp5654368)

1.31. [Set `failure_domain_column` parameter](#idp5659520)

1.32. [Set `failure_host_name_column` parameter](#idp5664544)

1.33. [Set `failure_reply_code_column` parameter](#idp5669536)

1.34. [Set `failure_flags_column` parameter](#idp5674448)

1.35. [Set `failure_mask_column` parameter](#idp5679440)

1.36. [Set `failure_next_domain_column` parameter](#idp5684416)

1.37. [Set `failure_comment_column` parameter](#idp5689408)

1.38. [`cr_replace_host` usage](#idp5746896)

1.39. [`cr_deactivate_host` usage](#idp5756544)

1.40. [`cr_activate_host` usage](#idp5764064)

1.41. [`cr_add_host` usage](#idp5777136)

1.42. [`cr_delete_host` usage](#idp5790272)

1.43. [Configuration example - Routing to default tree](#idp5793152)

1.44. [Configuration example - Routing to user tree](#idp5795264)

1.45. [Configuration example - module configuration](#idp5797456)

1.46. [Example database content - carrierroute table](#idp5807040)

1.47. [Example database content - simple carrierfailureroute table](#idp5814208)

1.48. [Example database content - more complex carrierfailureroute table](#idp5818608)

1.49. [Example database content - route\_tree table](#idp5822032)

1.50. [Necessary extensions for the user table](#idp5825008)
