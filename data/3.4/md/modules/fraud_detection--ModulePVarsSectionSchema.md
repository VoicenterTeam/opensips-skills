...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5777168)

2.2. [Most recently active contributors(1) to this module](#idp5866896)

**List of Examples**

1.1. [Set the “db\_url” parameter](#idp249072)

1.2. [Set the “use\_utc\_time” parameter](#idp166160)

1.3. [Set the “table\_name” parameter](#idp171504)

1.4. [Set “rid\_col” parameter](#idp5518288)

1.5. [Set “pid\_col” parameter](#idp5523488)

1.6. [Set “prefix\_col” parameter](#idp5528416)

1.7. [Set “start\_h” parameter](#idp5534288)

1.8. [Set “end\_h” parameter](#idp5540160)

1.9. [Set “days\_col” parameter](#idp5545808)

1.10. [Set “cpm\_thresh\_warn\_col” parameter](#idp5550816)

1.11. [Set “cpm\_thresh\_crit\_col” parameter](#idp5555840)

1.12. [Set “calldur\_thresh\_warn\_col” parameter](#idp5560864)

1.13. [Set “calldur\_thresh\_crit\_col” parameter](#idp5565888)

1.14. [Set “totalc\_thresh\_warn\_col” parameter](#idp5570928)

1.15. [Set “totalc\_thresh\_crit\_col” parameter](#idp5575968)

1.16. [Set “concalls\_thresh\_warn\_col” parameter](#idp5581008)

1.17. [Set “concalls\_thresh\_crit\_col” parameter](#idp5586064)

1.18. [Set “seqcalls\_thresh\_warn\_col” parameter](#idp5591120)

1.19. [Set “seqcalls\_thresh\_crit\_col” parameter](#idp5596176)
