...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5759296)

2.2. [Most recently active contributors(1) to this module](#idp5870816)

**List of Examples**

1.1. [Example H.350 commObject storing SIP account data](#idp4083104)

1.2. [`ldap_session` parameter usage](#idp5517952)

1.3. [`base_dn` parameter usage](#idp5521792)

1.4. [`search_scope` parameter usage](#idp5525568)

1.5. [Example Usage](#idp5546416)

1.6. [Example Usage](#idp5569984)

1.7. [Example H.350 callPreferenceURI simple call forwarding rules](#idp5585232)

1.8. [Example Usage](#idp5608352)

1.9. [Example SIPIdentityServiceLevel values and resulting AVPs](#idp159360)

1.10. [Example Usage](#idp5640864)
...
if (is\_avp\_set("$avp(callee\_pref\_u)"))
{
    # replace R-URI with CFU URI, g will fetch all CFU URIs 
    # --> request can fork
    if (avp\_pushto("$ru", "$avp(callee\_pref\_u)/g"))
    {
            avp\_delete("$avp(callee\_pref\_u)");
    } else
    {
            sl\_send\_reply(500, "Internal server error");
            exit;
...
if (is\_avp\_set("$avp(caller\_sl\_international)"))
{
    t\_relay();
} 
else {
