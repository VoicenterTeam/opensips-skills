...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5719104)

2.2. [Most recently active contributors(1) to this module](#idp5825200)

**List of Examples**

1.1. [Set `trace_on` parameter](#idp337488)

1.2. [Set `trace_local_ip` parameter](#idp100128)

1.3. [Set `trace_id` parameter](#idp5529600)

1.4. [Set `syslog_default_facility` parameter](#idp5535632)

1.5. [Set `syslog_default_level` parameter](#idp5541008)

1.6. [Set `file_mode` parameter](#idp5546448)

1.7. [`trace()` usage](#idp5575968)
...
**All remaining contributors**: Dan Pascu ([@danpascu](https://github.com/danpascu)), Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Dusan Klinec ([@ph4r05](https://github.com/ph4r05)), Zero King ([@l2dy](https://github.com/l2dy)), Andreas Heise, Nick Altmann ([@nikbyte](https://github.com/nikbyte)), Sergio Gutierrez, okhowang, Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)), Konstantin Bokarius, Iouri Kharon, Edson Gellert Schubert, Elena-Ramona Modroiu, Eric Tamme ([@etamme](https://github.com/etamme)).
