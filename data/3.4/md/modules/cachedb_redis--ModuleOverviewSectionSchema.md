...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5587440)

2.2. [Most recently active contributors(1) to this module](#idp5686608)

**List of Examples**

1.1. [Set `cachedb_url` parameter](#idp173488)

1.2. [Use Redis servers](#idp5530128)

1.3. [Set `connect_timeout` parameter](#idp5534848)

1.4. [Set `connect_timeout` parameter](#idp5539904)

1.5. [Set the `shutdown_on_error` parameter](#idp5545056)

1.6. [Set the `use_tls` parameter](#idp5552480)

1.7. [Redis Raw Query Examples](#idp5558032)
...
**All remaining contributors**: Juli�n Moreno Pati�o, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), zhengsh, Jarrod Baumann ([@jarrodb](https://github.com/jarrodb)), Kristian H�gh.
...
**All remaining contributors**: Kristian H�gh, Juli�n Moreno Pati�o, Jarrod Baumann ([@jarrodb](https://github.com/jarrodb)), jalung, Ezequiel Lovelle.
