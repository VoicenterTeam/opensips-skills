...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp599552)

2.2. [Most recently active contributors(1) to this module](#idp5682272)

**List of Examples**

1.1. [Set `hash_size` parameter](#idp2585456)

1.2. [Set `cleanup_interval` parameter](#idp5148864)

1.3. [Set `session_timeout` parameter](#idp5091424)

1.4. [Set `message_timeout` parameter](#idp4309808)

1.5. [`msrp_gw_answer()` usage](#idp1472128)

1.6. [`msg_to_msrp()` usage](#idp4650016)
