...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5725216)

2.2. [Most recently active contributors(1) to this module](#idp5824416)

**List of Examples**

1.1. [`cache_table` parameter usage](#idp5580160)

1.2. [`spec_delimiter` parameter usage](#idp5584848)

1.3. [`pvar_delimiter` parameter usage](#idp5589680)

1.4. [`columns_delimiter` parameter usage](#idp5594848)

1.5. [`sql_fetch_nr_rows` parameter usage](#idp5599392)

1.6. [`full_caching_expire` parameter usage](#idp5603952)

1.7. [`reload_interval` parameter usage](#idp5608480)

1.8. [`sql_cacher_reload` usage](#idp5618976)

1.9. [`sql_cached_value(id{sep}col{sep}key) pseudo-variable` usage](#idp5628736)

1.10. [Example database content - carrierfailureroute table](#idp5634400)

1.11. [Setting the `cache_table` parameter](#idp5637264)

1.12. [Accessing cached values](#idp5640160)
