...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5582512)

2.2. [Most recently active contributors(1) to this module](#idp5686048)

**List of Examples**

1.1. [Set `exec_query_threshold` parameter](#idp3070080)

1.2. [Set `max_db_queries` parameter](#idp288368)

1.3. [Set `timeout` parameter](#idp163168)

1.4. [Set the `use_tls` parameter](#idp173952)
...
**Last edited by:** Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)), Norman Brandinger ([@NormB](https://github.com/NormB)), Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)), Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)), Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Aron Podrigal, Eseanu Marius Cristian ([@eseanucristian](https://github.com/eseanucristian)), Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)), Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)), Daniel-Constantin Mierla ([@miconda](https://github.com/miconda)), Konstantin Bokarius, Edson Gellert Schubert, Henning Westerholt ([@henningw](https://github.com/henningw)), Jan Janak ([@janakj](https://github.com/janakj)).
