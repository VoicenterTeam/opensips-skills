...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5800016)

2.2. [Most recently active contributors(1) to this module](#idp5897312)

**List of Examples**

1.1. [Set `auth_date_freshness` parameter](#idp217216)

1.2. [Set `verify_date_freshness` parameter](#idp1917056)

1.3. [Set `ca_list` parameter](#idp261136)

1.4. [Set `ca_dir` parameter](#idp266704)

1.5. [Set `crl_list` parameter](#idp5578944)

1.6. [Set `crl_dir` parameter](#idp5584048)

1.7. [Set `e164_strict_mode` parameter](#idp5590592)

1.8. [Set `e164_max_length` parameter](#idp5595376)

1.9. [Set `require_date_hdr` parameter](#idp5603216)

1.10. [`stir_shaken_auth()` usage](#idp5634912)

1.11. [`stir_shaken_verify()` usage](#idp5655200)

1.12. [`stir_shaken_check()` usage](#idp5664864)

1.13. [`stir_shaken_check_cert()` usage](#idp5672704)

1.14. [`identity` usage](#idp5686752)
...
...
modparam("identity", "crl\_list", "/stir\_certs/crl\_list.pem")
...
