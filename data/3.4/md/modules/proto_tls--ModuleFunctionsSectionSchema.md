...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5740544)

3.2. [Most recently active contributors(1) to this module](#idp5870592)

**List of Examples**

1.1. [Set `listen` variable](#idp5517392)

1.2. [Set `tls_port` variable](#idp5522352)

1.3. [Set `tls_crlf_pingpong` parameter](#idp5526912)

1.4. [Set `tls_crlf_drop` parameter](#idp5531952)

1.5. [Set `tls_max_msg_chunks` parameter](#idp5536800)

1.6. [Set `cert_check_on_conn_reusage` parameter](#idp5542624)

1.7. [Set `trace_destination` parameter](#idp5549872)

1.8. [Set `trace_on` parameter](#idp5567472)

1.9. [Set `trace_filter_route` parameter](#idp5579648)

1.10. [Set `tls_handshake_timeout` variable](#idp5585440)

1.11. [Set `tls_send_timeout` variable](#idp5590336)

1.12. [Set `tls_async` variable](#idp5594832)

1.13. [Set `tls_async_max_postponed_chunks` parameter](#idp5599408)

1.14. [Set `tls_async_local_connect_timeout` parameter](#idp5604016)

1.15. [Set `tls_async_handshake_timeout` parameter](#idp5608640)
...
**All remaining contributors**: Nick Altmann ([@nikbyte](https://github.com/nikbyte)), Juli�n Moreno Pati�o, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Zero King ([@l2dy](https://github.com/l2dy)).
...
**All remaining contributors**: Juli�n Moreno Pati�o, Eseanu Marius Cristian ([@eseanucristian](https://github.com/eseanucristian)), Bogdan Chifor, Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)).
