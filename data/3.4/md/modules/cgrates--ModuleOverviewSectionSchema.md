...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5812848)

2.2. [Most recently active contributors(1) to this module](#idp5904320)

**List of Examples**

1.1. [Set `cgrates_engine` parameter](#idp5517360)

1.2. [Set `bind_ip` parameter](#idp5522576)

1.3. [Set `max_async_connections` parameter](#idp5527504)

1.4. [Set `retry_timeout` parameter](#idp5532496)

1.5. [Set `compat_mode` parameter](#idp5537424)

1.6. [cgrates\_acc() usage](#idp5574592)

1.7. [cgrates\_auth() usage](#idp5591664)

1.8. [cgrates\_auth() usage with attributes parsing](#idp5593216)

1.9. [cgrates\_cmd() usage](#idp5607200)

1.10. [$cgr(name) simple usage](#idp5616240)

1.11. [$cgr(name) multiple sessions usage](#idp5617968)

1.12. [$cgr\_opt(name) usage](#idp5629216)

1.13. [$cgr\_ret(name) usage](#idp5632720)

1.14. [`async cgrates_auth` usage](#idp5649584)

1.15. [`async cgrates_cmd compat_mode` usage](#idp5663200)

1.16. [`async cgrates_cmd new` usage](#idp5665632)
