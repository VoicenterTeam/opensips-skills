...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp30844016)

3.2. [Most recently active contributors(1) to this module](#idp30915776)

**List of Examples**

1.1. [Sample of a db\_text table](#idp28606656)

1.2. [Minimal OpenSIPS location db\_text table definition](#idp29738064)

1.3. [Minimal OpenSIPS subscriber db\_text table example](#idp30207232)

1.4. [Set `db_mode` parameter](#idp25338704)

1.5. [Load the db\_text module](#idp30737904)

1.6. [Definition of 'subscriber' table (one line)](#idp30741328)

1.7. [Definition of 'location' and 'aliases' tables (one line)](#idp30743040)

1.8. [Definition of 'version' table and sample records](#idp30744640)

1.9. [Configuration file](#idp30746128)
...
**Example�1.5.�Load the db\_text module**
