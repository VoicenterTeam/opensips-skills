...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5589920)

2.2. [Most recently active contributors(1) to this module](#idp5689600)

**List of Examples**

1.1. [Set `db_url` parameter](#idp98016)

1.2. [Set `rooms_table` parameter](#idp1780048)

1.3. [Set `members_table` parameter](#idp96704)

1.4. [Set `hash_size` parameter](#idp161312)

1.5. [Set `imc_cmd_start_char` parameter](#idp5516592)

1.6. [Set `outbound_proxy` parameter](#idp5521312)

1.7. [Usage of `imc_manager()` function](#idp5527168)

1.8. [List of commands](#idp5545312)
