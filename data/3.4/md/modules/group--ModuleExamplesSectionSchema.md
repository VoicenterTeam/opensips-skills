...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5676864)

2.2. [Most recently active contributors(1) to this module](#idp5779360)

**List of Examples**

1.1. [Set `db_url` parameter](#idp4701008)

1.2. [Set `table` parameter](#idp106320)

1.3. [Set `user_column` parameter](#idp174640)

1.4. [Set `domain_column` parameter](#idp5515792)

1.5. [Set `group_column` parameter](#idp5520992)

1.6. [Set `use_domain` parameter](#idp5525600)

1.7. [Set `re_table` parameter](#idp5530592)

1.8. [Set `re_exp_column` parameter](#idp5535792)

1.9. [Set `re_gid_column` parameter](#idp5540992)

1.10. [Set `multiple_gid` parameter](#idp5545984)

1.11. [Set `aaa_url` parameter](#idp5549776)

1.12. [`db_is_user_in` usage](#idp5564192)

1.13. [`db_get_user_group` usage](#idp5590144)

1.14. [`aaa_is_user_in` usage](#idp5601856)
...
**All remaining contributors**: Jiri Kuthan ([@jiriatipteldotorg](https://github.com/jiriatipteldotorg)), Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Dan Pascu ([@danpascu](https://github.com/danpascu)), Sergio Gutierrez, Konstantin Bokarius, Norman Brandinger ([@NormB](https://github.com/NormB)), UnixDev, Anca Vamanu.
