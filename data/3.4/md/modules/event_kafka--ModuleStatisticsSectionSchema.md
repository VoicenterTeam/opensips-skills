...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5570048)

2.2. [Most recently active contributors(1) to this module](#idp5647952)

**List of Examples**

1.1. [Set `broker_id` parameter](#idp5527008)

1.2. [`kafka_publish()` function usage](#idp5544640)

1.3. [Kafka socket](#idp5547648)
