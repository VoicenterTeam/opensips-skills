...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6340800)

3.2. [Most recently active contributors(1) to this module](#idp6469888)

**List of Examples**

1.1. [Set `rtpengine_sock` parameter](#idp183008)

1.2. [Set `rtpengine_disable_tout` parameter](#idp5579616)

1.3. [Set `rtpengine_tout` parameter](#idp5584896)

1.4. [Set `rtpengine_retr` parameter](#idp5589824)

1.5. [Set `rtpengine_timer_interval` parameter](#idp5594576)

1.6. [Set `notification_sock` parameter](#idp5600848)

1.7. [Set `extra_id_pv` parameter](#idp5605840)

1.8. [Set `setid_avp` parameter](#idp5610560)

1.9. [Set `error_pv` parameter](#idp5615152)

1.10. [Set `db_url` parameter](#idp5620288)

1.11. [Set `db_table` parameter](#idp5624944)

1.12. [Set `socket_column` parameter](#idp5629456)

1.13. [Set `set_column` parameter](#idp5634048)

1.14. [`rtpengine_use_set` usage](#idp5639968)

1.15. [`rtpengine_offer` usage](#idp5737184)

1.16. [`rtpengine_offer` usage with body replace](#idp5740576)

1.17. [`rtpengine_offer` usage with call recording](#idp5742736)

1.18. [`rtpengine_offer` usage for transcoding](#idp5745248)

1.19. [`rtpengine_answer` usage](#idp5751696)

1.20. [`rtpengine_delete` usage](#idp5757056)

1.21. [`rtpengine_manage` usage](#idp5771616)

1.22. [`rtpengine_start_recording` usage](#idp5780176)

1.23. [`rtpengine_stop_recording` usage](#idp5788736)

1.24. [Ringback tone using `rtpengine_play_media`](#idp5801888)

1.25. [Manage music on hold using `rtpengine_play_media`](#idp5804080)

1.26. [Ringback tone stop using `rtpengine_stop_media`](#idp5810880)

1.27. [Example of `rtpengine_block_media` usage](#idp5816544)

1.28. [Example of `rtpengine_unblock_media` usage](#idp5822112)

1.29. [Example of `rtpengine_block_dtmf` usage](#idp5827680)

1.30. [Example of `rtpengine_unblock_dtmf` usage](#idp5833264)

1.31. [Example of `rtpengine_start_forwarding` usage](#idp5839040)

1.32. [Example of `rtpengine_stop_forwarding` usage](#idp5844176)

1.33. [Example of `rtpengine_play_dtmf` usage](#idp5853408)

1.34. [$rtpstat Usage](#idp5860144)

1.35. [$rtpstat(STAT)](#idp5894064)

1.36. [$rtpquery Usage](#idp5899712)

1.37. [`rtpengine_enable` usage](#idp5910208)

1.38. [`rtpengine_show` usage](#idp5915360)

1.39. [`rtpengine_reload` usage](#idp5922416)

1.40. [`teardown` usage](#idp5929680)
...
*   _enable_ - 1 - enable, 0 - disable the RTP proxy.
...
**All remaining contributors**: Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Zero King ([@l2dy](https://github.com/l2dy)), Rob Gagnon ([@rgagnon24](https://github.com/rgagnon24)), Flavio E. Goncalves, Dan Pascu ([@danpascu](https://github.com/danpascu)), Oliver Severin Mulelid-Tynes ([@olivermt](https://github.com/olivermt)), Peter Kelly, rdondeti.
