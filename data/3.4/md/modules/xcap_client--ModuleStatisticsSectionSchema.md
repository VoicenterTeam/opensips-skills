...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5564016)

3.2. [Most recently active contributors(1) to this module](#idp5667584)

**List of Examples**

1.1. [Set `periodical_query` parameter](#idp163552)

1.2. [Set `query_period` parameter](#idp169312)

2.1. [`xcap_client_api` structure](#idp5524800)
