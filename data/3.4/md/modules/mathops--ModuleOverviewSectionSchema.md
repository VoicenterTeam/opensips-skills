...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5636560)

2.2. [Most recently active contributors(1) to this module](#idp5733632)

**List of Examples**

1.1. [Setting the decimal\_digits module parameter](#idp214272)

1.2. [`math_eval` usage](#idp166016)

1.3. [`math_rpn` usage](#idp5517136)

1.4. [`math_trunc` usage](#idp5525200)

1.5. [`math_floor` usage](#idp5532944)

1.6. [`math_ceil` usage](#idp5540704)

1.7. [`math_round` usage](#idp5550320)

1.8. [`math_round_sf` usage](#idp5563328)

1.9. [`math_compare` usage](#idp5572432)
