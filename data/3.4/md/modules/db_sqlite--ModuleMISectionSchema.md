...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp4758560)

2.2. [Most recently active contributors(1) to this module](#idp5655408)

**List of Examples**

1.1. [Set `alloc_limit` parameter](#idp4180304)

1.2. [Set `db_sqlite_alloc_limit` parameter](#idp275408)
