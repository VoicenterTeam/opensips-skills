...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5768384)

2.2. [Most recently active contributors(1) to this module](#idp5862432)

**List of Examples**

1.1. [Set `db_url` parameter](#idp5551360)

1.2. [Set `smpp_port` variable](#idp5555984)

1.3. [Set `smpp_max_msg_chunks` parameter](#idp5561344)

1.4. [Set `smpp_send_timeout` parameter](#idp5566560)

1.5. [Set `outbound_uri` parameter](#idp5571504)

1.6. [Set `smpp_table` parameter](#idp5576432)

1.7. [Set `name_col` parameter](#idp5581632)

1.8. [Set `ip_col` parameter](#idp5586448)

1.9. [Set `port_col` parameter](#idp5591264)

1.10. [Set `system_id_col` parameter](#idp5596160)

1.11. [Set `password_col` parameter](#idp5601136)

1.12. [Set `system_type_col` parameter](#idp5606112)

1.13. [Set `src_ton_col` parameter](#idp5611008)

1.14. [Set `src_npi_col` parameter](#idp5615984)

1.15. [Set `dst_ton_col` parameter](#idp5620960)

1.16. [Set `dst_npi_col` parameter](#idp5625936)

1.17. [Set `session_type_col` parameter](#idp5630912)

1.18. [`send_smpp_message()` usage](#idp5647872)
