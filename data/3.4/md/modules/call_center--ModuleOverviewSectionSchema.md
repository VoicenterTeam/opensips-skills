...
4.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6166304)

4.2. [Most recently active contributors(1) to this module](#idp6289520)

**List of Examples**

1.1. [Set `db_url` parameter](#idp5532352)

1.2. [Set `acc_db_url` parameter](#idp5537104)

1.3. [Set `rt_db_url` parameter](#idp5541680)

1.4. [Set `wrapup_time` parameter](#idp5547376)

1.5. [Set `queue_pos_param` parameter](#idp5552448)

1.6. [Set `reject_on_no_agents` parameter](#idp5557536)

1.7. [Set `chat_dispatch_policy` parameter](#idp5566944)

1.8. [Set `internal_call_dispatching` parameter](#idp5573360)

1.9. [Set `cc_agents_table` parameter](#idp5578256)

1.10. [Set `cca_agentid_column` parameter](#idp5583152)

1.11. [Set `cca_location_column` parameter](#idp5588160)

1.12. [Set `cca_msrp_location_column` parameter](#idp5593168)

1.13. [Set `cca_msrp_max_sessions_column` parameter](#idp5598144)

1.14. [Set `cca_skills_column` parameter](#idp5603152)

1.15. [Set `cca_logstate_column` parameter](#idp5608160)

1.16. [Set `cca_wrapuptime_column` parameter](#idp5613168)

1.17. [Set `cca_wrapupend_column` parameter](#idp5618192)

1.18. [Set `cc_flows_table` parameter](#idp5623200)

1.19. [Set `ccf_flowid_column` parameter](#idp5628192)

1.20. [Set `ccf_priority_column` parameter](#idp5633168)

1.21. [Set `ccf_skill_column` parameter](#idp5638144)

1.22. [Set `ccf_cid_column` parameter](#idp5643136)

1.23. [Set `ccf_max_wrapup_column` parameter](#idp5648128)

1.24. [Set `ccf_dissuading_hangup_column` parameter](#idp5653136)

1.25. [Set `ccf_dissuading_onhold_th_column` parameter](#idp5658176)

1.26. [Set `ccf_dissuading_ewt_th_column` parameter](#idp5663184)

1.27. [Set `ccf_dissuading_qsize_th_column` parameter](#idp5668208)

1.28. [Set `ccf_m_welcome_column` parameter](#idp5673216)

1.29. [Set `ccf_m_queue_column` parameter](#idp5678224)

1.30. [Set `ccf_m_dissuading_column` parameter](#idp5683232)

1.31. [Set `ccf_m_flow_id_column` parameter](#idp5688256)

1.32. [Set `b2b_logic_ctx_param` parameter](#idp5694800)

1.33. [`cc_handle_call` usage](#idp5712016)

1.34. [`cc_agent_login` usage](#idp5719456)

1.35. [$rtpquery Usage](#idp5837712)
