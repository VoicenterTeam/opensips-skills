...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5815760)

2.2. [Most recently active contributors(1) to this module](#idp5916048)

**List of Examples**

1.1. [Set `hash_size` parameter](#idp165264)

1.2. [Set `timer_interval` parameter](#idp170080)

1.3. [Set `enable_clustering` parameter](#idp5579152)

1.4. [Set “db\_url” parameter](#idp5583968)

1.5. [Set “table\_name” parameter](#idp5588880)

1.6. [Set “registrar\_column” parameter](#idp5593856)

1.7. [Set “proxy\_column” parameter](#idp5599056)

1.8. [Set “aor\_column” parameter](#idp5604160)

1.9. [Set “third\_party\_registrant\_column” parameter](#idp5609392)

1.10. [Set “username\_column” parameter](#idp5614448)

1.11. [Set “password\_column” parameter](#idp5619504)

1.12. [Set “binding\_URI\_column” parameter](#idp5624672)

1.13. [Set “binding\_params\_column” parameter](#idp5633280)

1.14. [Set “expiry\_column” parameter](#idp5638288)

1.15. [Set “forced\_socket\_column” parameter](#idp5643824)

1.16. [Set “cluster\_shtag\_column” parameter](#idp5648896)

1.17. [Set “state\_column” parameter](#idp5654672)
...
**Example�1.4.�Set “db\_url” parameter**
...
**Example�1.5.�Set “table\_name” parameter**
...
**Example�1.6.�Set “registrar\_column” parameter**
...
**Example�1.7.�Set “proxy\_column” parameter**
...
**Example�1.8.�Set “aor\_column” parameter**
...
**Example�1.9.�Set “third\_party\_registrant\_column” parameter**
...
**Example�1.10.�Set “username\_column” parameter**
...
**Example�1.11.�Set “password\_column” parameter**
...
**Example�1.12.�Set “binding\_URI\_column” parameter**
...
**Example�1.13.�Set “binding\_params\_column” parameter**
...
**Example�1.14.�Set “expiry\_column” parameter**
...
**Example�1.15.�Set “forced\_socket\_column” parameter**
...
**Example�1.16.�Set “cluster\_shtag\_column” parameter**
...
**Example�1.17.�Set “state\_column” parameter**
...
**All remaining contributors**: James Stanley, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)).
...
**All remaining contributors**: Nick Altmann ([@nikbyte](https://github.com/nikbyte)), Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)).
