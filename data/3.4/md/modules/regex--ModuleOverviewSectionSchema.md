...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5665792)

2.2. [Most recently active contributors(1) to this module](#idp5762512)

**List of Examples**

1.1. [Set `file` parameter](#idp4183936)

1.2. [Set `max_groups` parameter](#idp3434624)

1.3. [Set `group_max_size` parameter](#idp4631152)

1.4. [Set `pcre_caseless` parameter](#idp2686912)

1.5. [Set `pcre_multiline` parameter](#idp1750400)

1.6. [Set `pcre_dotall` parameter](#idp4556592)

1.7. [Set `pcre_extended` parameter](#idp4748864)

1.8. [`pcre_match` usage (forcing case insensitive)](#idp5502944)

1.9. [`pcre_match` usage (using "end of line" symbol)](#idp4555024)

1.10. [`pcre_match_group` usage](#idp4869936)

1.11. [regex file](#idp3653264)

1.12. [Using with pua\_usrloc](#idp4020288)

1.13. [Incorrect groups file](#idp1523248)
...
**All remaining contributors**: Ken Rice, Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Marius Zbihlei.
...
**All remaining contributors**: I�aki Baz Castillo, Anca Vamanu, Sergio Gutierrez.
...
**Last edited by:** Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)), Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)), Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)), Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)), I�aki Baz Castillo.
