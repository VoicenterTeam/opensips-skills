...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5585184)

2.2. [Most recently active contributors(1) to this module](#idp5678096)

**List of Examples**

1.1. [Set `cachedb_url` parameter](#idp213936)

1.2. [Set `timeout` parameter](#idp100432)

1.3. [Set `exec_threshold` parameter](#idp105856)

1.4. [Set `lazy_connect` parameter](#idp5571728)

1.5. [Use CouchBase servers](#idp5573632)
