...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5657488)

2.2. [Most recently active contributors(1) to this module](#idp5758928)

**List of Examples**

1.1. [Set `include_callid` parameter](#idp173648)

1.2. [Set `include_tags` parameter](#idp5528032)

1.3. [Set `include_localremote` parameter](#idp5532912)

1.4. [Set `caller_confirmed` parameter](#idp5538336)

1.5. [Set `publish_on_trying` parameter to 0](#idp5544720)

1.6. [Set `publish_on_trying` parameter to 1](#idp5548064)

1.7. [Set `nopublish_flag` parameter](#idp5553728)

1.8. [Set `presence_server` parameter](#idp5557504)

1.9. [Set `caller_spec_param` parameter](#idp5562144)

1.10. [Set `caller_spec_param` parameter](#idp5566112)

1.11. [Set `osips_ps` parameter](#idp5571296)

1.12. [`dialoginfo_set` usage](#idp5578656)

1.13. [`dialoginfo_set_branch_callee` usage](#idp5585584)

1.14. [`dialoginfo_mute_branch` usage](#idp5592048)
