...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp4700560)

2.2. [Most recently active contributors(1) to this module](#idp5587040)

**List of Examples**

1.1. [Creating a document](#idp163632)

1.2. [Inserting nodes with indentation](#idp167856)

1.3. [Using script variables in path](#idp169728)
