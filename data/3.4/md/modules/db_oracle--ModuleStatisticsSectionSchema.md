...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp4403984)

2.2. [Most recently active contributors(1) to this module](#idp5603440)

**List of Examples**

1.1. [Set `timeout` parameter](#idp258400)

1.2. [Disable asynchronous mode](#idp260512)

1.3. [Set `reconnect` parameter](#idp249808)
