...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5529440)

2.2. [Most recently active contributors(1) to this module](#idp5592880)

**List of Examples**

1.1. [Set `client_bye_mode` parameter](#idp5513392)

1.2. [Use `b2b_sdp_demux()` to handle an audio SIPREC call](#idp5523872)
