...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6165696)

3.2. [Most recently active contributors(1) to this module](#idp6280256)

**List of Examples**

1.1. [early\_media example](#idp5627488)

1.2. [report\_cancels example](#idp5631360)

1.3. [detect\_direction example](#idp5635808)

1.4. [Setting _extra\_fields_ example:](#idp5640448)

1.5. [Setting _leg\_fields_ example:](#idp5646256)

1.6. [log\_level example](#idp5651104)

1.7. [log\_facility example](#idp5654944)

1.8. [Set `aaa_url` parameter](#idp5659872)

1.9. [service\_type example](#idp5664016)

1.10. [db\_table\_acc example](#idp5668496)

1.11. [db\_table\_missed\_calls example](#idp5672624)

1.12. [db\_url example](#idp5676880)

1.13. [acc\_method\_column example](#idp5681104)

1.14. [acc\_from\_tag\_column example](#idp5685248)

1.15. [acc\_to\_tag\_column example](#idp5689392)

1.16. [acc\_callid\_column example](#idp5693536)

1.17. [acc\_sip\_code\_column example](#idp5697696)

1.18. [acc\_sip\_reason\_column example](#idp5701840)

1.19. [acc\_time\_column example](#idp5706096)

1.20. [do\_accounting usage](#idp5738528)

1.21. [drop\_accounting usage](#idp5755792)

1.22. [acc\_log\_request usage](#idp5763520)

1.23. [acc\_db\_request usage](#idp5772560)

1.24. [acc\_aaa\_request usage](#idp5780608)

1.25. [acc\_evi\_request usage](#idp5789696)

1.26. [acc\_new\_leg usage](#idp5794528)

1.27. [acc\_load\_ctx\_from\_dlg usage](#idp5800816)
