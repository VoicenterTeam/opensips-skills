...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp106032)

2.2. [Most recently active contributors(1) to this module](#idp5655856)

**List of Examples**

1.1. [Setting the `failover_timeout` parameter](#idp165840)

1.2. [Virtual socket](#idp170432)
