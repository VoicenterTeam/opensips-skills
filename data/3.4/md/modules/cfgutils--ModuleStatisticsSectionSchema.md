...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6033184)

2.2. [Most recently active contributors(1) to this module](#idp6134096)

**List of Examples**

1.1. [`initial_probability` parameter usage](#idp5292960)

1.2. [`hash_file` parameter usage](#idp3348976)

1.3. [`shv_hash_size` parameter usage](#idp98864)

1.4. [`shvset` parameter usage](#idp108832)

1.5. [`varset` parameter usage](#idp5575568)

1.6. [Setting lock\_pool\_size module parameter](#idp5581456)

1.7. [`rand_event()` usage](#idp5588848)

1.8. [`rand_set_prob()` usage](#idp5607504)

1.9. [`rand_reset_prob()` usage](#idp5611888)

1.10. [`rand_get_prob()` usage](#idp5615872)

1.11. [`sleep` usage](#idp5622304)

1.12. [`usleep` usage](#idp5628736)

1.13. [`abort` usage](#idp5633520)

1.14. [`pkg_status` usage](#idp5638464)

1.15. [`shm_status` usage](#idp5643408)

1.16. [`set_count` usage](#idp5648608)

1.17. [`set_select_weight` usage](#idp5653616)

1.18. [`ts_usec_delta` usage](#idp5661088)

1.19. [`check_time_rec` usage](#idp5676032)

1.20. [`get_static_lock` usage](#idp166368)

1.21. [`release_static_lock` usage](#idp5699488)

1.22. [`get_dynamic_lock` usage](#idp5707904)

1.23. [`release_dynamic_lock` usage](#idp5714864)

1.24. [`strings_share_lock` usage](#idp5723120)

1.25. [`get_accurate_time` usage](#idp5732448)

1.26. [`async sleep` usage](#idp5738720)

1.27. [`async usleep` usage](#idp5744192)

1.28. [`rand_set_prob` usage](#idp5751264)

1.29. [`rand_reset_prob` usage](#idp5755616)

1.30. [`rand_get_prob` usage](#idp5760096)

1.31. [`check_config_hash` usage](#idp5764800)

1.32. [`get_config_hash` usage](#idp5769344)

1.33. [`shv_set` usage](#idp5778784)

1.34. [`shv_get` usage](#idp5784400)

1.35. [`env(name) pseudo-variable` usage](#idp5789232)

1.36. [`RANDOM pseudo-variable` usage](#idp5793040)

1.37. [`ctime(name) pseudo-variable` usage](#idp5807776)

1.38. [`shv(name) pseudo-variable` usage](#idp5812704)
...
Waits a number of seconds. This function does exactly the same as [sleep()](#func_sleep "1.4.5.� sleep(time)"), but in an asynchronous way. The script execution is suspended until the waiting is done; then OpenSIPS resumes the script execution via the resume route.
...
Waits a number of micro-seconds. This function does exactly the same as [usleep()](#func_usleep "1.4.6.� usleep(time)"), but in an asynchronous way. The script execution is suspended until the waiting is done; then OpenSIPS resumes the script execution via the resume route.
...
**All remaining contributors**: Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)), Sergio Gutierrez, Konstantin Bokarius, Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Edson Gellert Schubert.
...
**All remaining contributors**: Sergio Gutierrez, Henning Westerholt ([@henningw](https://github.com/henningw)), Daniel-Constantin Mierla ([@miconda](https://github.com/miconda)), Elena-Ramona Modroiu, Konstantin Bokarius, Edson Gellert Schubert.
...
**Last edited by:** Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)), Bogdan-Andrei Iancu ([@bogdan-iancu](https://github.com/bogdan-iancu)), Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)), Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)), Anca Vamanu, Sergio Gutierrez, Henning Westerholt ([@henningw](https://github.com/henningw)), Daniel-Constantin Mierla ([@miconda](https://github.com/miconda)), Elena-Ramona Modroiu, Konstantin Bokarius, Edson Gellert Schubert.
