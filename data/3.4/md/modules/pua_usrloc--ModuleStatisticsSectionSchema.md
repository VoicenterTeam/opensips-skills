...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp25786064)

2.2. [Most recently active contributors(1) to this module](#idp30841040)

**List of Examples**

1.1. [Set `default_domain` parameter](#idp25481280)

1.2. [Set `presentity_prefix` parameter](#idp25486672)

1.3. [Set `presence_server` parameter](#idp25341264)

1.4. [`pua_set_publish` usage](#idp25347664)
...
**All remaining contributors**: Elena-Ramona Modroiu, Juha Heinanen ([@juha-h](https://github.com/juha-h)), Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Edson Gellert Schubert, Julien Blache.
...
**All remaining contributors**: Konstantin Bokarius, Edson Gellert Schubert, Juha Heinanen ([@juha-h](https://github.com/juha-h)), Julien Blache, Elena-Ramona Modroiu.
