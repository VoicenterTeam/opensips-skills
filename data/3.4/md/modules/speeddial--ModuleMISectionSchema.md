...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5640992)

2.2. [Most recently active contributors(1) to this module](#idp5736272)

**List of Examples**

1.1. [Set `db_url` parameter](#idp318928)

1.2. [Set `user_column` parameter](#idp307696)

1.3. [Set `domain_column` parameter](#idp167472)

1.4. [Set `sd_user_column` parameter](#idp172768)

1.5. [Set `sd_domain_column` parameter](#idp5570592)

1.6. [Set `new_uri_column` parameter](#idp5575600)

1.7. [Set `domain_prefix` parameter](#idp5580288)

1.8. [Set `use_domain` parameter](#idp5585024)

1.9. [`sd_lookup` usage](#idp5593856)

1.10. [OpenSIPS config script - sample speeddial usage](#idp5597984)
