...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5715280)

2.2. [Most recently active contributors(1) to this module](#idp5792704)

**List of Examples**

1.1. [`db_mode` parameter usage](#idp248304)

1.2. [`db_url` parameter usage](#idp171088)

1.3. [`profiles_table` parameter usage](#idp166240)

1.4. [`secrets_table` parameter usage](#idp5564224)

1.5. [Set `tag_column` parameter](#idp5568800)

1.6. [Set `username_column` parameter](#idp5573616)

1.7. [Set `secret_tag_column` parameter](#idp5578432)

1.8. [set `secret_column` parameter](#idp5583248)

1.9. [set `start_ts` parameter](#idp5588144)

1.10. [set `end_ts` parameter](#idp5593040)

1.11. [set `tag_claim` parameter](#idp5598016)

1.12. [`load_credentials` parameter usage](#idp5605616)

1.13. [`jwt_db_authorize` usage](#idp5617856)

1.14. [`jwt_script_authorize` usage](#idp5630176)

1.15. [`extract_pub_key_from_cert` usage](#idp5640656)
