...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5890928)

2.2. [Most recently active contributors(1) to this module](#idp5995712)

**List of Examples**

1.1. [Set `default_allow_file` parameter](#idp5541072)

1.2. [Set `default_deny_file` parameter](#idp5546112)

1.3. [Set `check_all_branches` parameter](#idp5551680)

1.4. [Set `allow_suffix` parameter](#idp5558736)

1.5. [Set `deny_suffix` parameter](#idp5565776)

1.6. [Set `db_url` parameter](#idp5572992)

1.7. [Set `address_table` parameter](#idp5579072)

1.8. [Set `partition` parameter](#idp5585600)

1.9. [Set `grp_col` parameter](#idp5590784)

1.10. [Set `ip_col` parameter](#idp5595680)

1.11. [Set `mask_col` parameter](#idp5600688)

1.12. [Set `port_col` parameter](#idp5605680)

1.13. [Set `proto_col` parameter](#idp5613776)

1.14. [Set `pattern_col` parameter](#idp5620112)

1.15. [Set `info_col` parameter](#idp5626384)

1.16. [`check_address()` usage](#idp5641648)

1.17. [`check_source_address()` usage](#idp5647952)

1.18. [`get_source_group()` usage](#idp5656144)

1.19. [`allow_routing` usage](#idp5662384)

1.20. [`allow_routing(basename)` usage](#idp5670944)

1.21. [`allow_register(basename)` usage](#idp5679584)

1.22. [`allow_uri(basename, uri)` usage](#idp5689328)
