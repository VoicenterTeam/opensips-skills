...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5618304)

3.2. [Most recently active contributors(1) to this module](#idp5710528)

**List of Examples**

1.1. [Set luafilename parameter](#idp171424)

1.2. [lua\_exec() usage](#idp105344)
