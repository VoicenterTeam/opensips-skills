...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5574768)

3.2. [Most recently active contributors(1) to this module](#idp5681248)

**List of Examples**

1.1. [Setting db\_url parameter](#idp3473616)

1.2. [db\_mode example](#idp2720304)

1.3. [Setting domain\_table parameter](#idp335312)

1.4. [Setting domain\_col parameter](#idp163200)

1.5. [Setting attrs\_col parameter](#idp167008)

1.6. [is\_from\_local usage](#idp172800)

1.7. [is\_uri\_host\_local usage](#idp5517808)

1.8. [is\_domain\_local usage](#idp5526528)
