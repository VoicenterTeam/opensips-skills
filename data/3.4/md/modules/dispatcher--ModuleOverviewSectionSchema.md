...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6328160)

3.2. [Most recently active contributors(1) to this module](#idp6464672)

**List of Examples**

1.1. [Setting the default database URL for dispatcher](#idp203856)

1.2. [Set the 'default' partition's “attrs\_avp” parameter](#idp5519568)

1.3. [Set the 'default' partition's “script\_attrs\_avp” parameter](#idp5525184)

1.4. [Use algo\_route for hashing:](#idp5530640)

1.5. [Use $avp(273) for hashing:](#idp5536288)

1.6. [Use combination of PVs for hashing:](#idp5537760)

1.7. [Set the “setid\_pvar” parameter](#idp5542416)

1.8. [Set the “ds\_ping\_method” parameter](#idp5547520)

1.9. [Set the “ds\_ping\_from” parameter](#idp5552624)

1.10. [Set the “ds\_ping\_interval” parameter](#idp5558096)

1.11. [Set the “ds\_ping\_maxfwd” parameter](#idp5562992)

1.12. [Set the “ds\_probing\_sock” parameter](#idp5568000)

1.13. [Set the “ds\_probing\_threshold” parameter](#idp5573136)

1.14. [Set the “ds\_probing\_mode” parameter](#idp5578320)

1.15. [Set the “ds\_probing\_list” parameter](#idp5583488)

1.16. [Set the 'default' partition's “ds\_define\_blacklist” parameter](#idp5589072)

1.17. [Set the “options\_reply\_codes” parameter](#idp5594256)

1.18. [Set the 'default' partition's “dst\_avp” parameter](#idp5600816)

1.19. [Set the 'default' partition's “grp\_avp” parameter](#idp5606496)

1.20. [Set the 'default' partition's “cnt\_avp” parameter](#idp5612160)

1.21. [Set the 'default' partition's “sock\_avp” parameter](#idp5617840)

1.22. [Set the “pvar\_algo\_pattern” parameter](#idp5624368)

1.23. [Set the `persistent_state` parameter](#idp5629744)

1.24. [Set `cluster_id` parameter](#idp5644656)

1.25. [Set `cluster_sharing_tag` parameter](#idp5652816)

1.26. [Set `cluster_probing_mode` parameter](#idp5666352)

1.27. [Define a new partition called 'voicemail'](#idp5672144)

1.28. [Define the 'trunks' partition and make it the 'default' partition, so we avoid loading the 'dispatcher' table](#idp5673872)

1.29. [Set the default table name](#idp5679248)

1.30. [Set “setid\_col” parameter](#idp5685264)

1.31. [Set “destination\_col” parameter](#idp5690160)

1.32. [Set “state\_col” parameter](#idp5695056)

1.33. [Set “weight\_col” parameter](#idp5699952)

1.34. [Set “priority\_col” parameter](#idp5704944)

1.35. [Set “attrs\_col” parameter](#idp5709952)

1.36. [Set “socket\_col” parameter](#idp5714960)

1.37. [Set “probe\_mode\_col” parameter](#idp5719968)

1.38. [Set the `fetch_freeswitch_load` parameter](#idp5731584)

1.39. [Set the `max_freeswitch_weight` parameter](#idp5738800)

1.40. [`ds_select_dst` usage](#idp5773152)

1.41. [`ds_count` usage](#idp5806272)

1.42. [`ds_is_in_list` usage](#idp5820016)

1.43. [`ds_count` usage](#idp5831424)

1.44. [`ds_count` usage](#idp5841440)

1.45. [OpenSIPS config script - sample dispatcher usage](#idp5909792)
...
Starting with version 2.1, the dispatcher module keeps its destination sets into different partitions. Each partition is described by its own "db\_url", "table\_name", "dst\_avp", "grp\_avp", "cnt\_avp", "sock\_avp", "attr\_avp" and "blacklists" set of attributes. Setting any of these module parameters will only alter the "default" partition's properties.
...
**All remaining contributors**: Carsten Bock, Ionel Cerghit ([@ionel-cerghit](https://github.com/ionel-cerghit)), Elena-Ramona Modroiu, John Burke ([@john08burke](https://github.com/john08burke)), Klaus Darilion, Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Anca Vamanu, Jarrod Baumann ([@jarrodb](https://github.com/jarrodb)), wangdd, Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Nick Altmann ([@nikbyte](https://github.com/nikbyte)), Jan Janak ([@janakj](https://github.com/janakj)), Andrei Pelinescu-Onciul, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Stanislaw Pitucha, Federico Cabiddu, Konstantin Bokarius, Andreas Granig, John Riordan, Aron Podrigal ([@ar45](https://github.com/ar45)), Juli�n Moreno Pati�o, Kevin McAllister, Roman Sevko, UnixDev, David Sanders, Edson Gellert Schubert.
