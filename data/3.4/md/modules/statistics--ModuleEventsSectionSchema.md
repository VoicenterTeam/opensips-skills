...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6032288)

2.2. [Most recently active contributors(1) to this module](#idp6133248)

**List of Examples**

1.1. [variable example](#idp5893184)

1.2. [setting the stat\_groups parameter](#idp5897088)

1.3. [setting the stat\_series\_profile parameter](#idp5914992)

1.4. [`update_stat` usage](#idp5924560)

1.5. [`reset_stat` usage](#idp5931200)

1.6. [`stat_iter_init` usage](#idp5938992)

1.7. [`stat_iter_next` usage](#idp5947792)

1.8. [`update_stat_series` usage](#idp5957888)

1.9. [`$stat` usage](#idp5964048)
...
**All remaining contributors**: Ovidiu Sas ([@ovidiusas](https://github.com/ovidiusas)), Konstantin Bokarius, Juli�n Moreno Pati�o, Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Edson Gellert Schubert.
