...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5754096)

2.2. [Most recently active contributors(1) to this module](#idp5854960)

**List of Examples**

1.1. [Setting the `keepalive_interval` parameter](#idp5526720)

1.2. [Setting the `keepalive_method` parameter](#idp5533472)

1.3. [Setting the `keepalive_from` parameter](#idp5538768)

1.4. [Setting the `keepalive_extra_headers` parameter](#idp5543648)

1.5. [Setting the `keepalive_state_file` parameter](#idp5549872)

1.6. [Set `cluster_id` parameter](#idp5569008)

1.7. [Set `cluster_sharing_tag` parameter](#idp5575600)

1.8. [Using the `client_nat_test` function](#idp5585552)

1.9. [Using the `fix_contact` function](#idp5590544)

1.10. [Using the `nat_keepalive` function](#idp250992)

1.11. [Using `$keepalive.socket` in multi-proxy environments](#idp5622256)

1.12. [Using `$source_uri` to set the received AVP on registrars](#idp5628000)

1.13. [Using `$source_uri` in multi-proxy environments](#idp5630816)
...
**All remaining contributors**: David Sanders, St�phane Alnet ([@shimaore](https://github.com/shimaore)), okhowang, Sergio Gutierrez, Alexey Vasilyev ([@vasilevalex](https://github.com/vasilevalex)).
...
**All remaining contributors**: David Sanders, Vlad Paiu ([@vladpaiu](https://github.com/vladpaiu)), Anca Vamanu, St�phane Alnet ([@shimaore](https://github.com/shimaore)), Sergio Gutierrez.
