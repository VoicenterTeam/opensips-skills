...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5575808)

2.2. [Most recently active contributors(1) to this module](#idp5679584)

**List of Examples**

1.1. [Set “setvars” parameter](#idp163312)

1.2. [Set “time\_to\_kill” parameter](#idp169776)

1.3. [`exec` usage](#idp5527856)

1.4. [`async exec` usage](#idp5548080)
