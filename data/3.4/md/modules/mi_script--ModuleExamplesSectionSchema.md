...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5590432)

2.2. [Most recently active contributors(1) to this module](#idp5660224)

**List of Examples**

1.1. [Set `pretty_printing` parameter](#idp162144)

1.2. [Set `trace_destination` parameter](#idp169616)

1.3. [Set `trace_destination` parameter](#idp5517536)

1.4. [`mi` without params](#idp5536832)

1.5. [`mi` with params in command](#idp5538720)

1.6. [`mi` with return](#idp5540720)

1.7. [`mi` without return but with indexed params](#idp5542608)

1.8. [`mi` with return and named parameters](#idp5544704)

1.9. [`mi` without return, with an array parameter value](#idp5546800)

1.10. [`async mi call` usage](#idp5553024)
