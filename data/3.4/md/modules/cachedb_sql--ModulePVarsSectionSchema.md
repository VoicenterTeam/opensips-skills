...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5603744)

3.2. [Most recently active contributors(1) to this module](#idp5705856)

**List of Examples**

1.1. [Set `db_url` parameter](#idp248096)

1.2. [Usage example](#idp161616)

1.3. [Set `db_url` parameter](#idp165600)

1.4. [Set `key_column` parameter](#idp169600)

1.5. [Set `value_column` parameter](#idp5566224)

1.6. [Set `counter_column` parameter](#idp5569888)

1.7. [Set `expires_column` parameter](#idp5573552)

1.8. [Set `cache_clean_period` parameter](#idp5577360)
