...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5650256)

3.2. [Most recently active contributors(1) to this module](#idp5770048)

**List of Examples**

1.1. [Set `socket_name` parameter](#idp257696)

1.2. [Set `children_count` parameter](#idp247408)

1.3. [Set `unix_socket_mode` parameter](#idp163952)

1.4. [Set `unix_socket_group` parameter](#idp169168)

1.5. [Set `unix_socket_user` parameter](#idp5563248)

1.6. [Set `socket_timeout` parameter](#idp5567696)

1.7. [Set `trace_destination` parameter](#idp5574688)

1.8. [Set `trace_destination` parameter](#idp5583392)

1.9. [Set `pretty_printing` parameter](#idp5588624)

1.10. [DATAGRAM request](#idp5593856)
