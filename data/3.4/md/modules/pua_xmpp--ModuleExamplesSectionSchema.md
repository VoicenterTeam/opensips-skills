...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5569264)

3.2. [Most recently active contributors(1) to this module](#idp5631552)

**List of Examples**

1.1. [Set `server_address` parameter](#idp213712)

1.2. [Set `presence_server` parameter](#idp247328)

1.3. [`Notify2Xmpp` usage](#idp165840)

1.4. [`xmpp_send_winfo` usage](#idp5520912)
...
**All remaining contributors**: Juha Heinanen ([@juha-h](https://github.com/juha-h)), Maksym Sobolyev ([@sobomax](https://github.com/sobomax)), Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Walter Doekes ([@wdoekes](https://github.com/wdoekes)), Edson Gellert Schubert, Stanislaw Pitucha.
...
**All remaining contributors**: Anca Vamanu, Sergio Gutierrez, Daniel-Constantin Mierla ([@miconda](https://github.com/miconda)), Konstantin Bokarius, Edson Gellert Schubert, Juha Heinanen ([@juha-h](https://github.com/juha-h)).
