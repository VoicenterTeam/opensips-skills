...
2.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp6225072)

2.2. [Most recently active contributors(1) to this module](#idp6306304)

**List of Examples**

1.1. [Setting the `db_url` parameter](#idp5925024)

1.2. [Setting the `table_name` parameter](#idp5930080)

1.3. [Setting the `algorithm` parameter](#idp5941408)

1.4. [Setting the `connection_timeout` parameter](#idp5946656)

1.5. [Setting the `connect_poll_interval` parameter](#idp5965424)

1.6. [Setting the `extra_stats` parameter](#idp5980176)

1.7. [Setting the `min_samples_asr` parameter](#idp5985600)

1.8. [Setting the `min_samples_ccr` parameter](#idp5990928)

1.9. [Setting the `min_samples_pdd` parameter](#idp5996256)

1.10. [Setting the `min_samples_ast` parameter](#idp6001584)

1.11. [Setting the `min_samples_acd` parameter](#idp6006912)

1.12. [Setting the `event_bad_dst_threshold` parameter](#idp6012720)

1.13. [Setting the `decimal_digits` parameter](#idp6017936)

1.14. [`qr_set_xstat()` usage](#idp6031504)

1.15. [`qr_disable_dst()` usage](#idp6040848)

1.16. [`qr_enable_dst()` usage](#idp6049168)
