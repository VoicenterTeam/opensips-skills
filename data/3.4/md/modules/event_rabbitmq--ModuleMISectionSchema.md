...
3.1. [Top contributors by DevScore(1), authored commits(2) and lines added/removed(3)](#idp5682704)

3.2. [Most recently active contributors(1) to this module](#idp5807424)

**List of Examples**

1.1. [Set `heartbeat` parameter](#idp5581360)

1.2. [Setting the `connect_timeout` parameter](#idp5586656)

1.3. [Set the `use_tls` parameter](#idp5593824)

1.4. [E\_PIKE\_BLOCKED event](#idp5599040)

1.5. [RabbitMQ socket](#idp5600720)

1.6. [OpenSIPS config script - sample event\_rabbitmq usage](#idp5603968)

2.1. [Event subscription](#idp5694336)

2.2. [Event subscription](#idp5696512)
...
**Example�1.6.�OpenSIPS config script - sample event\_rabbitmq usage**
...
**Last edited by:** Liviu Chircu ([@liviuchircu](https://github.com/liviuchircu)), Razvan Crainea ([@razvancrainea](https://github.com/razvancrainea)), Vlad Patrascu ([@rvlad-patrascu](https://github.com/rvlad-patrascu)), Peter Lemenkov ([@lemenkov](https://github.com/lemenkov)), Ionut Ionita ([@ionutrazvanionita](https://github.com/ionutrazvanionita)).
