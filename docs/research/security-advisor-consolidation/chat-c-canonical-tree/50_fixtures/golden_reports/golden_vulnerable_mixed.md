...
**Rationale.** `auth_jwt` `db_mode=1` (db_url path) on OpenSIPS in the range 3.1.0 through 3.6.3 contains the JWT-validation bypass disclosed as CVE-2026-25554 (AISLE writeup, January 2026). The deployed version 3.6.2 is in-range. The bypass allows unauthenticated SIP requests carrying crafted JWTs to pass `jwt_authorize()` calls.
...
| **Rule** | `OSIPS-SEC-MI_EXPOSURE-001` v1.0 (`mi-http-public-bind`) |
| **Severity** | **Critical** |
| **Confidence** | High |
| **Verification status** | `deterministic_confirmed` |
| **Kind** | vulnerability |
...
| **Rule** | `OSIPS-SEC-INJECTION-001` v1.0 (`sql-inj-avp-db-query`) |
| **Severity** | **High** |
| **Confidence** | High |
| **Verification status** | `deterministic_confirmed` |
| **Kind** | vulnerability |
  ...
  "runs": [
    {
          ...
          "rules": [
            {
              ...
              "properties": {
                ...
                "opensips-advisor/cvss_v4_vector": "CVSS:4.0/AV:N/AC:L/AT:N/PR:N/UI:N/VC:H/VI:H/VA:H/SC:N/SI:N/SA:N",
                "security-severity": "9.3",
                "tags": ["security", "external/cwe/cwe-287", "external/cve/CVE-2026-25554"]
              }
            }
      ...
      "properties": {
        "opensips-advisor/hardening_index": 35,
